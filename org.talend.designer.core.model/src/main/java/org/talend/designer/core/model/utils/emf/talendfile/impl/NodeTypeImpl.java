 ...
 * <copyright> </copyright>
 * 
 * $Id: NodeTypeImpl.java 47814 2010-09-06 09:46:22Z nma $
 */
...
import org.talend.designer.core.model.AbstractNode;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Node Type</b></em>'.
 * 
 * @extend AbstractNode <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.NodeTypeImpl#getElementParameter <em>Element
 * Parameter</em>}</li>
 ...
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.NodeTypeImpl#getComponentName <em>Component Name
 * </em>}</li>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.NodeTypeImpl#getComponentVersion <em>Component
 * Version</em>}</li>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.NodeTypeImpl#getOffsetLabelX <em>Offset Label X
 * </em>}</li>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.NodeTypeImpl#getOffsetLabelY <em>Offset Label Y
 * </em>}</li>
 ...
 * @generated
 */
public class NodeTypeImpl extends AbstractNode implements NodeType {
    ...
    /**
     * The default value of the '{@link #getBinaryData() <em>Binary Data</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getBinaryData()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getBinaryData() <em>Binary Data</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getBinaryData()
     * @generated
    ...
    /**
     * The default value of the '{@link #getStringData() <em>String Data</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getStringData()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getStringData() <em>String Data</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getStringData()
     * @generated
    ...
    /**
     * The default value of the '{@link #getPosX() <em>Pos X</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getPosX()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getPosX() <em>Pos X</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getPosX()
     * @generated
    ...
    /**
     * This is true if the Pos X attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The default value of the '{@link #getPosY() <em>Pos Y</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getPosY()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getPosY() <em>Pos Y</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     * 
     * @see #getPosY()
     * @generated
    ...
    /**
     * This is true if the Pos Y attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The default value of the '{@link #getSizeX() <em>Size X</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSizeX()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getSizeX() <em>Size X</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSizeX()
     * @generated
    ...
    /**
     * This is true if the Size X attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The default value of the '{@link #getSizeY() <em>Size Y</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSizeY()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getSizeY() <em>Size Y</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @see #getSizeY()
     * @generated
    ...
    /**
     * This is true if the Size Y attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     * @ordered
     */
    ...
    /**
     * The cached value of the '{@link #getNodeData() <em>Node Data</em>}' containment reference. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getNodeData()
     * @generated
    ...
    public EList getElementParameter() {
        if (elementParameter == null) {
            elementParameter = new EObjectContainmentEList(ElementParameterType.class, this,
                    TalendFilePackage.NODE_TYPE__ELEMENT_PARAMETER);
        }
    ...
    public void setBinaryData(byte[] newBinaryData) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__BINARY_DATA, oldBinaryData,
                    binaryData));
    }
    ...
    public void setStringData(String newStringData) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__STRING_DATA, oldStringData,
                    stringData));
    }
    ...
    public void setComponentName(String newComponentName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__COMPONENT_NAME, oldComponentName,
                    componentName));
    }
    ...
    public void setComponentVersion(String newComponentVersion) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__COMPONENT_VERSION,
                    oldComponentVersion, componentVersion));
    }
    ...
    public void setOffsetLabelX(int newOffsetLabelX) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__OFFSET_LABEL_X, oldOffsetLabelX,
                    offsetLabelX, !oldOffsetLabelXESet));
    }
    ...
    public void unsetOffsetLabelX() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__OFFSET_LABEL_X, oldOffsetLabelX,
                    OFFSET_LABEL_X_EDEFAULT, oldOffsetLabelXESet));
    }
    ...
    public void setOffsetLabelY(int newOffsetLabelY) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__OFFSET_LABEL_Y, oldOffsetLabelY,
                    offsetLabelY, !oldOffsetLabelYESet));
    }
    ...
    public void unsetOffsetLabelY() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__OFFSET_LABEL_Y, oldOffsetLabelY,
                    OFFSET_LABEL_Y_EDEFAULT, oldOffsetLabelYESet));
    }
    ...
    public void unsetPosX() {
        ...
        posXESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__POS_X, oldPosX, POS_X_EDEFAULT,
                    oldPosXESet));
    }
    ...
    public void unsetPosY() {
        ...
        posYESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__POS_Y, oldPosY, POS_Y_EDEFAULT,
                    oldPosYESet));
    }
    ...
    public void setSizeX(int newSizeX) {
        ...
        sizeXESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__SIZE_X, oldSizeX, sizeX,
                    !oldSizeXESet));
    }
    ...
    public void unsetSizeX() {
        ...
        sizeXESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__SIZE_X, oldSizeX,
                    SIZE_X_EDEFAULT, oldSizeXESet));
    }
    ...
    public void setSizeY(int newSizeY) {
        ...
        sizeYESet = true;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__SIZE_Y, oldSizeY, sizeY,
                    !oldSizeYESet));
    }
    ...
    public void unsetSizeY() {
        ...
        sizeYESet = false;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, TalendFilePackage.NODE_TYPE__SIZE_Y, oldSizeY,
                    SIZE_Y_EDEFAULT, oldSizeYESet));
    }
    ...
    public void setScreenshot(byte[] newScreenshot) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__SCREENSHOT, oldScreenshot,
                    screenshot));
    }
    ...
    public NotificationChain basicSetNodeData(AbstractExternalData newNodeData, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    TalendFilePackage.NODE_TYPE__NODE_DATA, oldNodeData, newNodeData);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setNodeData(AbstractExternalData newNodeData) {
        if (newNodeData != nodeData) {
            ...
            if (nodeData != null)
                msgs = ((InternalEObject) nodeData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - TalendFilePackage.NODE_TYPE__NODE_DATA, null, msgs);
            if (newNodeData != null)
                msgs = ((InternalEObject) newNodeData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                        - TalendFilePackage.NODE_TYPE__NODE_DATA, null, msgs);
            msgs = basicSetNodeData(newNodeData, msgs);
            if (msgs != null)
                msgs.dispatch();
        } else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.NODE_TYPE__NODE_DATA, newNodeData,
                    newNodeData));
    }
    ...
    public boolean eIsSet(int featureID) {
        ...
        case TalendFilePackage.NODE_TYPE__COMPONENT_VERSION:
            return COMPONENT_VERSION_EDEFAULT == null ? componentVersion != null : !COMPONENT_VERSION_EDEFAULT
                    .equals(componentVersion);
        case TalendFilePackage.NODE_TYPE__OFFSET_LABEL_X:
