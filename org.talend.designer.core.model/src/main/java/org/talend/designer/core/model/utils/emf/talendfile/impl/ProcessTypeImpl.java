 ...
 * <copyright> </copyright>
 * 
 * $Id: ProcessTypeImpl.java 45775 2010-07-22 09:10:59Z cli $
 */
...
import org.talend.designer.core.model.AbstractProcess;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Process Type</b></em>'.
 * 
 * @extends AbstractProcess <!-- end-user-doc -->
 * <p>
 ...
 * </em>}</li>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.ProcessTypeImpl#getRoutinesDependencies <em>
 * Routines Dependencies</em>}</li>
 * <li>{@link org.talend.designer.core.model.utils.emf.talendfile.impl.ProcessTypeImpl#getPP <em>PP</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class ProcessTypeImpl extends AbstractProcess implements ProcessType {
    ...
    /**
     * The cached value of the '{@link #getRoutinesDependencies() <em>Routines Dependencies</em>}' containment reference
    ...
    /**
     * The default value of the '{@link #getPP() <em>PP</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getPP()
     * @generated
     * @ordered
    ...
    /**
     * The cached value of the '{@link #getPP() <em>PP</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getPP()
     * @generated
     * @ordered
    ...
    public EList getRoutinesDependencies() {
        if (routinesDependencies == null) {
            routinesDependencies = new EObjectContainmentEList(ItemInforType.class, this,
                    TalendFilePackage.PROCESS_TYPE__ROUTINES_DEPENDENCIES);
        }
    ...
    public void setPP(String newPP) {
        ...
        pp = newPP;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TalendFilePackage.PROCESS_TYPE__PP, oldPP, pp));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case TalendFilePackage.PROCESS_TYPE__PP:
            return getPP();
        }
