 ...
 *
 */
public interface IArchiveService extends javax.xml.rpc.Service {
    ...
    public org.talend.remoteserver.client.example.archive.IArchive getArchive(java.net.URL portAddress) throws javax.xml.rpc.ServiceException;
}
