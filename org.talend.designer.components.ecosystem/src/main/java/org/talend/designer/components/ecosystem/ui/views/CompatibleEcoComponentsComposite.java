 ...
 */
public class CompatibleEcoComponentsComposite extends AbstractEcoComponentsComposite {
    ...
    public void addInstalledExtension(ComponentExtension extension) {
        ...
        for (int i = 0; i < fAvailableExtensions.size(); i++) {
            if (fAvailableExtensions.get(i).getName().equals(extension.getName())) {
    ...
    private void checkInstalledExtensions() {
        ...
        for (ComponentExtension available : fAvailableExtensions) {
            ...
            if (installed == null) {
                ...
                if (installed.getRevisions().size() < available.getRevisions().size()) {
    ...
    public List<ComponentExtension> getSelectedExtensions() {
        return getExtensionsFromTableItems(fTableViewerCreator.getTable().getSelection());
    }
