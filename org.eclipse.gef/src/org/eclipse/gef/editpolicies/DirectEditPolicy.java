...
/**
 * Shows DirectEdit feedback and creates the Command to perform a "direct edit". <I>Direct
 * Edit</I> is when the User is editing a property of an EditPart directly (as opposed to
 * in the Properties View) in the Viewer using a {@link
 * org.eclipse.jface.viewers.CellEditor}. This EditPolicy is typically installed using
 * {@link org.eclipse.gef.EditPolicy#DIRECT_EDIT_ROLE}.
 * @author hudsonr
 * @since 2.0
 */
...
/**
 * If feedback is being shown, this method calls {@link
...
/**
 * Override to show the current direct edit value in the host's Figure. Although the
 * CellEditor will probably cover the figure's display of this value, updating the figure
 * will cause its preferred size to reflect the new value.
 * @param request the DirectEditRequest
 */
protected abstract void showCurrentEditValue(DirectEditRequest request);

/**
 * Called to remember the old value before direct edit feedback begins. After feedback is
 * over, {@link #revertOldEditValue(DirectEditRequest)} is called to undo the changes done
 ...
 * org.eclipse.gef.ui.actions.DirectEditAction} will determine enablement based on whether
