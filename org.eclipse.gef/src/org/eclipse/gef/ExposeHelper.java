...
/**
 * Exposes the specified descendant on the EditPart which returned this helper. This is
 * done by adjusting the EditPart's <i>visuals</i> such that the descendants
 * <i>visuals</i> are exposed.  Expose is performed from the bottom up, meaning that
 * EditParts in the parent-chain between the helper's EditPart and the <i>descendant</i>
 * will already have had a change to expose the descendant.
