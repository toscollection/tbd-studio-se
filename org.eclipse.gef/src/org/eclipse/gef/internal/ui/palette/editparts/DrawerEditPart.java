...
public class DrawerEditPart extends PaletteEditPart implements IPinnableEditPart {
    ...
    /**
     * @return <code>true</code> if the DrawerFigure can be pinned open. This is only true when the drawer is expanded
     * and the auto-collapse strategy is <code>PaletteViewerPreferences.COLLAPSE_AS_NEEDED</code>.
     */
