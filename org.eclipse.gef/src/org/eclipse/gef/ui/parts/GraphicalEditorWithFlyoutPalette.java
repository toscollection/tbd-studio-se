...
/**
 * This class serves as a quick starting point for clients who are new to GEF. It will create an Editor with a flyout
 * palette. The flyout palette will only be visible when the palette view is not open.
 * <p>
 * <EM>IMPORTANT</EM>This class should only be used as a reference for creating your own EditorPart implementation. This
 * class will not suit everyone's needs, and may change in the future. Clients may copy the implementation.
 * 
 * @author Pratik Shah
 * @since 3.0
 */
public abstract class GraphicalEditorWithFlyoutPalette extends GraphicalEditor {
    ...
    protected FlyoutPaletteComposite splitter;

    protected CustomPalettePage page;
    ...
    /**
     * Returns the palette viewer provider that is used to create palettes for the view and the flyout. Creates one if
    ...
    /**
     * A custom PalettePage that helps GraphicalEditorWithFlyoutPalette keep the two PaletteViewers (one displayed in
     * the editor and the other displayed in the PaletteView) in sync when switching from one to the other (i.e., it
     * helps maintain state across the two viewers).
     * 
     * @author Pratik Shah
     * @since 3.0
     */
