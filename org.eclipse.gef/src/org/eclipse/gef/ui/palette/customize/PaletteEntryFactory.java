 ...
 * org.eclipse.gef.palette.PaletteEntry PaletteEntries}.
 * 
 * <p>
 * This class only creates {@link org.eclipse.gef.palette.PaletteEntry PaletteEntries} in
 * {@link org.eclipse.gef.palette.PaletteContainer PaletteContainers} and not directly in
 * the {@link org.eclipse.gef.palette.PaletteRoot root}.  It is recommended that
 * sub-classes not do that either.
 * </p>
 * 
 * <p>
 * To keep palette customization consistent across different types of editors, it is
 * recommended that a new entry be created after the currently selected entry.  If
 * the new entry needs to be created inside the currently selected entry (i.e.,
 * if the currently selected entry is a <code>PaletteContainer</code>), it should be added
 * as the last child. Look at {@link #determineContainerForNewEntry(PaletteEntry)} and
 * {@link #determineIndexForNewEntry(PaletteContainer, PaletteEntry)} in this class and
 * {@link org.eclipse.gef.ui.palette.customize.PaletteContainerFactory} to see what the
 * general guidelines are for creating containers and leaf entries.
 * </p>
 * 
 * @author Pratik Shah
 ...
 * 
 * @param shell	The <code>Shell</code> of the <code>PaletteCustomizerDialog</code>
 * @param selected	The <code>PaletteEntry</code> that was selected in the outline when
 ...
 * 
 * @param shell	The <code>Shell</code> of the <code>PaletteCustomizerDialog</code>;  it
...
/**
 * Given the current selection, this method determines the parent for the new entry
 * to be created.
 * 
 * <p>
...
/**
 * Calculates the index at which the new entry is to be created, given the current
 * selection.
 * 
 * <p>
 * Sub-classes may override this method.
 ...
 * @param selected	The selected entry
 * @return the index at which the new entry should be added in the given container (-1
 * indicates add at the end)
 */
...
/**
 * Sets the <code>ImageDescriptor</code> used to create the image to represent this
 * factory
 * 
...
/**
 * Sets this factory's name.  It will be used to list this factory in the toolbar, context
 * menu, etc.
 * 
