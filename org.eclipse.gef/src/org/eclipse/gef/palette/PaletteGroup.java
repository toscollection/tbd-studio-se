...
/**
 * A PaletteGroup consists of a group of {@link org.eclipse.gef.palette.PaletteEntry}
 * objects that are uncollapsible . The user modification level is set to
 * {@link PaletteEntry#PERMISSION_NO_MODIFICATION}, meaning that the entries cannot be
 * reordered.
 */
