...
public class PaletteDrawer extends PaletteContainer {
     ...
     * <UL>
     * <LI>INITIAL_STATE_OPEN - The drawer is expanded when the palette is created.</LI>
     * <LI>INITIAL_STATE_CLOSED - The drawer is collapsed when the palette is created.</LI>
     * <LI>INITIAL_STATE_PINNED_OPEN - The drawer is pinned open (which would prevent it from being collapsed
     * automatically) when the palette is created.</LI>
     * </UL>
     */
    ...
    /**
     * @return <code>ToolEntry.PALETTE_TYPE_TOOL</code> or <code>PaletteTemplateEntry.PALETTE_TYPE_TEMPLATE</code> or
     * (if the drawer is empty and a drawerType has not been explicitly set) <code>PALETTE_TYPE_UNKNOWN</code>
     * 
    ...
    /**
     * DrawerType indicates whether a drawer will contain ToolEntries of PaletteTemplateEntries. A drawer should not
     * contain entries of both these types. However, there are no checks/restrictions that will prevent you from doing
     * so.
     * 
     * @param obj <code>ToolEntry.PALETTE_TYPE_TOOL</code> or <code>PaletteTemplateEntry.PALETTE_TYPE_TEMPLATE</code>
     */
     ...
     * 
     * @return true if the default icon should be shown if no icon is set; false otherwise
     * @since 3.4
     */
     ...
     * Should the default icon be shown for this drawer if no icon is set?
     * 
     * @param showDefaultIcon true if the default icon should be shown if no icon is set; false otherwise
     * @since 3.4
     */
