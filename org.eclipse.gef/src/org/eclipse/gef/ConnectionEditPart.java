...
/**
 * A specialization of {@link GraphicalEditPart GraphicalEditPart} for representing
 * connections. ConnectionEditParts must join a <I>source</I> and <I>target</I> EditPart.
 * Its Figure is typically a line between two "nodes", with possible decorations on that
 * line.
 * <P>
 * In GEF, ConnectionEditParts are <EM><I>structural features</I></EM> of their source
 ...
 * appropriate connections in the methods {@link
 * org.eclipse.gef.editparts.AbstractGraphicalEditPart#getModelSourceConnections()
 * getModelSourceConnections()} and {@link
 ...
 * happens to "intialize" itself first.  Therefore an end always looks first in the {@link
 * org.eclipse.gef.EditPartViewer#getEditPartRegistry() EditPartRegistry} to see if the
 ...
 * if:
 * <UL>
 * 	<LI>The connection should be selectable by the user independant of its "nodes".
