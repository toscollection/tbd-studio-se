 ...
 * on an EditPartViewer with keys generated by the KeyGenerator.  GEF
 * tools delegate handling of mouse-wheel events to MouseWheelHandlers, if there are no
 * drag trackers active.
 * 
 * @author Pratik Shah
 * @since 3.1
 */
...
/**
 * A utility class used to generate keys from a given stateMask.  A MouseWheelHandler
 * registered with such a key would only be asked to handle mouse-wheel events that
 * have the same stateMask as the one that was used to generate the key.
 * @author Pratik Shah
 * @since 3.1
 */
public class KeyGenerator {
	 ...
	 * the same stateMask.
	 * <p>
	 * Valid stateMasks are SWT.NONE, SWT.CTRL, SWT.COMMAND, SWT.ALT, SWT.SHIFT, SWT.MOD1,
	 * SWT.MOD2, SWT.MOD3, SWT.MOD4, SWT.BUTTON* or any combination thereof.
	 * 
