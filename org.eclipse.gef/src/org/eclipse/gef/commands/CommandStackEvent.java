 ...
 * determined by calling {@link #getDetail()}, and comparing the return value to constants
 * defined by {@link CommandStack}.
 * <P>Warning: this class is not intended to be subclassed.
 * @since 3.1
 */
...
/**
 * Constructs a new event instance.  The stack specifies the source of the event.  If a
 * command is relevant to the event context, one should be specified.  The detail
 * indicates the type of event occurring.
 * @since 3.1
