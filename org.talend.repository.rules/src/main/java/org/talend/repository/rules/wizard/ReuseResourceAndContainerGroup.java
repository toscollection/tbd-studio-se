 ...
 */
public class ReuseResourceAndContainerGroup implements Listener {
     ...
     */
    public ReuseResourceAndContainerGroup(Composite parent, Listener client, String resourceFieldLabel, String resourceType) {
    ...
    protected void createContents(Composite parent, String resourceLabelString, int heightHint) {
        ...
        resourceNameField.setText(this.originalFileName);
    ...
    /**
     * Returns a string that is the name of the chosen resource, or an empty string if no resource has been entered. <br>
     * <br>
    ...
    /**
     * Determines whether the resource extension should be added to the resource name field. <br>
     * <br>
     * 
     * @see ResourceAndContainerGroup#setResourceExtension(String)
     * @return <code>true</code> if the preconditions are met; otherwise, <code>false</code>.
     * @since 3.3
     */
     ...
     * Adds the resource extension to the resource name field when it loses focus (if the preconditions are met).
     * 
     * @see ResourceAndContainerGroup#setResourceExtension(String)
     * @since 3.3
     */
     ...
     * <br>
     * If a resource extension is specified, then it will always be appended with a '.' to the text from the resource
     * name field for validation when the following conditions are met: <br>
     * <br>
     * (1) Resource extension length is greater than 0 <br>
     * (2) Resource name field text length is greater than 0 <br>
     * (3) Resource name field text does not already end with a '.' and the resource extension specified (case
     * sensitive) <br>
     * <br>
     * The resource extension will not be reflected in the actual resource name field until the resource name field
     * loses focus.
     * 
     * @param value The resource extension without the '.' prefix (e.g. 'java', 'xml')
     * @since 3.3
     */
