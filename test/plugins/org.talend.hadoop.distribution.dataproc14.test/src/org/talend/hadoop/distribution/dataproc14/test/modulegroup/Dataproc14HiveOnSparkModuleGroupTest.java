...
public class Dataproc14HiveOnSparkModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(Dataproc14Constant.SPARK_HIVE_MRREQUIRED_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = Dataproc14HiveOnSparkModuleGroup.getModuleGroups();
