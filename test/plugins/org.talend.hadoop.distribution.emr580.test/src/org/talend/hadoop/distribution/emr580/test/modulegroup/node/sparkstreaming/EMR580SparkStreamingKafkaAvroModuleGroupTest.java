...
public class EMR580SparkStreamingKafkaAvroModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                EMR580SparkStreamingKafkaAvroModuleGroup.KAFKA_AVRO_GROUP_NAME,
                "((#LINK@NODE.STORAGE_CONFIGURATION.DISTRIBUTION=='AMAZON_EMR') AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_VERSION=='EMR_5_8_0')) AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_LOCAL_MODE=='false')"); //$NON-NLS-1$

        Set<DistributionModuleGroup> moduleGroups = EMR580SparkStreamingKafkaAvroModuleGroup.getModuleGroups(
