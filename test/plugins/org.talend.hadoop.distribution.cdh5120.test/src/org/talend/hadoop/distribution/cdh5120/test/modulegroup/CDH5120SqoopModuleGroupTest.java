...
public class CDH5120SqoopModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(CDH5120Constant.SQOOP_MODULE_GROUP.getModuleName(), null);
        ...
        results.put(CDH5120Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), null);

        Set<DistributionModuleGroup> moduleGroups = CDH5120SqoopModuleGroup.getModuleGroups();
