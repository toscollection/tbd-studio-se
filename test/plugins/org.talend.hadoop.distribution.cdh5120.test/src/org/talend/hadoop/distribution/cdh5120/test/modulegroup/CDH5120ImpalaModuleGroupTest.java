...
public class CDH5120ImpalaModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(CDH5120Constant.HIVE_MODULE_GROUP.getModuleName(), null);
        ...
        Set<DistributionModuleGroup> moduleGroups = CDH5120ImpalaModuleGroup.getModuleGroups();
