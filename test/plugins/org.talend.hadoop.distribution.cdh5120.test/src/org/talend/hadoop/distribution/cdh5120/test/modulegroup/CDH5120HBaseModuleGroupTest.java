...
public class CDH5120HBaseModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(CDH5120Constant.HBASE_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = CDH5120HBaseModuleGroup.getModuleGroups();
