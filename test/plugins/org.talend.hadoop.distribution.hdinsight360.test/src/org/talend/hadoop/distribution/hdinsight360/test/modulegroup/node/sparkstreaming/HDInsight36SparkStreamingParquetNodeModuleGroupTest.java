...
public class HDInsight36SparkStreamingParquetNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDInsight36Constant.SPARK_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.SPARK_CONFIGURATION.DISTRIBUTION=='MICROSOFT_HD_INSIGHT') AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_VERSION=='MICROSOFT_HD_INSIGHT_3_6')) AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_LOCAL_MODE=='false')"); //$NON-NLS-1$
        results.put(
                HDInsight36Constant.SPARK_STREAMING_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.SPARK_CONFIGURATION.DISTRIBUTION=='MICROSOFT_HD_INSIGHT') AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_VERSION=='MICROSOFT_HD_INSIGHT_3_6')) AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_LOCAL_MODE=='false')"); //$NON-NLS-1$

        Set<DistributionModuleGroup> moduleGroups = HDInsight36SparkStreamingParquetNodeModuleGroup.getModuleGroups(
