...
//
// ============================================================================
package org.talend.hadoop.distribution.hdinsight360.test.modulegroup.node.sparkbatch;
...
public class HDInsight36SparkBatchGraphFramesNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDInsight36Constant.GRAPHFRAMES_MRREQUIRED_MODULE_GROUP.getModuleName(),
        ...
        Set<DistributionModuleGroup> moduleGroups = HDInsight36SparkBatchGraphFramesNodeModuleGroup.getModuleGroups(
