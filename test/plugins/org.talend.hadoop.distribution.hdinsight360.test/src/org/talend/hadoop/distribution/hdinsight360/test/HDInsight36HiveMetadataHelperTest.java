...
public class HDInsight36HiveMetadataHelperTest {
    ...
    protected String getDistribution() {
        return HDInsight36Distribution.DISTRIBUTION_NAME;
    }

    // @Override
    protected String getDistributionVersion() {
        return HDInsight36Distribution.VERSION;
    }

    @Test
    public void testHiveMode_HDInsight36_NotSupport() {
    ...
    @Test
    public void testHiveServer_HDInsight36_NotSupport() {
