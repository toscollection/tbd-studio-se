...
//
// ============================================================================
package org.talend.oozie.scheduler.i18n;
...
/**
 */
public class TOozieTestMessages extends MessagesCore {

    private static final String BUNDLE_NAME = "messages_fragment"; //$NON-NLS-1$
