...
public class MapR520DistributionTest {
    ...
    public void testMapR520Distribution() throws Exception {
        ...
        assertEquals(MapR520Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(MapR520Distribution.VERSION, distribution.getVersion());
        ...
        assertFalse( ((MapROJAIComponent)distribution).doSupportExplicitSorts());
        assertFalse( ((MapROJAIComponent)distribution).doSupportJsonQueries());
        ...
        assertEquals(SparkStreamingKafkaVersion.MAPR_5X0_KAFKA, ((SparkStreamingComponent) distribution).getSparkStreamingKafkaVersion(ESparkVersion.SPARK_1_6));
