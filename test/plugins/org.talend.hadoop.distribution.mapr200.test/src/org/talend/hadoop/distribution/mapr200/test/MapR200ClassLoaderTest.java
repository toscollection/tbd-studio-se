...
public class MapR200ClassLoaderTest extends AbstractTest4ClassLoaderProvider {
    ...
    public void testHive1Standalone() {
        String libsStr = "hadoop-0.20.2-dev-core-mapr2.jar;log4j-1.2.16.jar;hive-exec-0.9.0-mapr2.jar;hive-jdbc-0.9.0-mapr2.jar;hive-metastore-0.9.0-mapr2.jar;hive-service-0.9.0-mapr2.jar;libfb303_new.jar;libthrift.jar;slf4j-api-1.6.1.jar;slf4j-log4j12-1.6.1.jar;commons-logging-1.0.4.jar;commons-logging-api-1.0.4.jar;jdo2-api-2.3-ec.jar;antlr-runtime-3.0.1.jar;datanucleus-connectionpool-2.0.3.jar;datanucleus-enhancer-2.0.3.jar;datanucleus-core-2.0.3.jar;datanucleus-rdbms-2.0.3.jar;derby-10.4.2.0.jar;maprfs-0.1.jar;zookeeper-3.3.2.jar;hive-builtins-0.9.0-mapr2.jar;commons-lang-2.4.jar;jackson-mapper-asl-1.9.14-TALEND.jar;jackson-core-asl-1.9.14-TALEND.jar;commons-dbcp-1.4.jar;commons-pool-1.5.4.jar;guava-r09.jar";
    ...
    public void testMapReduce() {
        String libsStr = "hadoop-0.20.2-dev-core-mapr2.jar;maprfs-0.1.jar;zookeeper-3.3.2.jar;guava-r09.jar;commons-logging-1.1.1.jar;commons-cli-1.2.jar;commons-lang-2.5.jar;commons-codec-1.4.jar;jackson-mapper-asl-1.9.14-TALEND.jar;jackson-core-asl-1.9.14-TALEND.jar;slf4j-api-1.6.1.jar;slf4j-log4j12-1.6.1.jar;log4j-1.2.16.jar";
        doTestClassLoader(EHadoopCategory.MAP_REDUCE.getName(), libsStr);
    }

    @Test
    public void testHDFS() {
        String libsStr = "hadoop-0.20.2-dev-core-mapr2.jar;commons-logging-1.0.4.jar;maprfs-0.1.jar;zookeeper-3.3.2.jar;avro-1.5.4.jar;jackson-mapper-asl-1.9.14-TALEND.jar;jackson-core-asl-1.9.14-TALEND.jar;log4j-1.2.17.jar";
