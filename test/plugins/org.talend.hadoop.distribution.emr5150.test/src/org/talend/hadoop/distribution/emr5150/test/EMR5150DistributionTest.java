...
/**
 * Test class for the {@link EMR580Distribution} distribution.
 *
 */
public class EMR5150DistributionTest {
    ...
    @Test
    public void testEMR5150Distribution() throws Exception {
        HadoopComponent distribution = new EMR5150Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertTrue(distribution.doSupportS3());
        assertEquals(EMR5150Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(EMR5150Distribution.VERSION, distribution.getVersion());
