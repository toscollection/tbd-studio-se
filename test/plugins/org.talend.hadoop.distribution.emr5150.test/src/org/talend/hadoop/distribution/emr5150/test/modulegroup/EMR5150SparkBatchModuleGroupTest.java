...
public class EMR5150SparkBatchModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(EMR5150Constant.SPARK_MODULE_GROUP.getModuleName(), null);
        
        Set<DistributionModuleGroup> moduleGroups = EMR5150SparkBatchModuleGroup.getModuleGroups();
