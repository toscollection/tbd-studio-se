...
public class EMR5150PigOutputModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(EMR5150Constant.PIG_SEQUENCEFILE_MODULE_GROUP.getModuleName(), "(STORE=='SEQUENCEFILESTORAGE')"); //$NON-NLS-1$
        results.put(EMR5150Constant.PIG_HBASE_MODULE_GROUP.getModuleName(), "(STORE=='HBASESTORAGE')"); //$NON-NLS-1$
