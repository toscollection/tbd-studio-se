...
//
// ============================================================================
package org.talend.hadoop.distribution.emr460.test;
...
import org.talend.hadoop.distribution.emr460.EMR460Distribution;
import org.talend.hadoop.distribution.test.AbstractDistributionTest;

/**
 * Test class for the {@link EMR460Distribution} distribution.
 *
 */
public class EMR460DistributionTest extends AbstractDistributionTest {

    public EMR460DistributionTest() {
        super(new EMR460Distribution());
    }
    ...
    @Test
    public void testEMR460Distribution() throws Exception {
        HadoopComponent distribution = new EMR460Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertTrue(distribution.doSupportS3());
        assertEquals(EMR460Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(EMR460Distribution.VERSION, distribution.getVersion());
