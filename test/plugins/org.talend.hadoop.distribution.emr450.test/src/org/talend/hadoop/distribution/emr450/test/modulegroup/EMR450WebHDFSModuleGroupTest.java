...
public class EMR450WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(EMR450WebHDFSModuleGroup.WEBHDFS_MODULE_GROUP_NAME, null);
        
        Set<DistributionModuleGroup> moduleGroups =
                EMR450WebHDFSModuleGroup.getModuleGroups(EMR450Distribution.DISTRIBUTION_NAME,
                        EMR450Distribution.VERSION);
