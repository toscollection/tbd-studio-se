...
/**
 * Test class for the {@link CDH570Distribution} distribution.
 *
 */
public class CDH570DistributionTest extends AbstractDistributionTest {

    public CDH570DistributionTest() {
        super(new CDH570Distribution());
    }
    ...
    @Test
    public void testCDH570Distribution() throws Exception {
        HadoopComponent distribution = new CDH570Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertTrue(distribution.doSupportS3());
        assertEquals(CDH570Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(CDH570Distribution.VERSION, distribution.getVersion());
