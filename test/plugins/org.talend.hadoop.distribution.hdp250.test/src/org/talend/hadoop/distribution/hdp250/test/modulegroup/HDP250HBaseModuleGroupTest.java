 ...
 *
 */
public class HDP250HBaseModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(HDP250Constant.HBASE_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = HDP250HBaseModuleGroup.getModuleGroups();
