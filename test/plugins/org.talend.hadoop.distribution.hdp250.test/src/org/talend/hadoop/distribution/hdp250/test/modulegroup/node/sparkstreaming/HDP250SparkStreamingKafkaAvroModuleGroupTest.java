 ...
 *
 */
public class HDP250SparkStreamingKafkaAvroModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDP250Constant.SPARK_KAFKA_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.STORAGE_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_VERSION=='HDP_2_5')) AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_LOCAL_MODE=='false')");

        Set<DistributionModuleGroup> moduleGroups = HDP250SparkStreamingKafkaAvroModuleGroup.getModuleGroups();
