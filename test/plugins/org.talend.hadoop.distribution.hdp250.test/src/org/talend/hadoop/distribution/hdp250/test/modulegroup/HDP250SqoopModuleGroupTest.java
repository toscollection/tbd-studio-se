 ...
 *
 */
public class HDP250SqoopModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP250Constant.SQOOP_MODULE_GROUP.getModuleName(), null);
...
//        results.put(HDP250Constant.MAPREDUCE_MODULE_GROUP.getModuleName(), null);
        results.put(HDP250Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), null);

        Set<DistributionModuleGroup> moduleGroups = HDP250SqoopModuleGroup.getModuleGroups();
