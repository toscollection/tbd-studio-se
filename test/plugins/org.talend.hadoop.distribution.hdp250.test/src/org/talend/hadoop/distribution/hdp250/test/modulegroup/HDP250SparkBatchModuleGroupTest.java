 ...
 *
 */
public class HDP250SparkBatchModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP250Constant.SPARK_MODULE_GROUP.getModuleName(), "(SPARK_LOCAL_MODE=='false')");
        results.put(HDP250Constant.SPARK_MRREQUIRED_MODULE_GROUP.getModuleName(), "(SPARK_LOCAL_MODE=='false')");
        results.put(HDP250Constant.HDFS_MODULE_GROUP.getModuleName(), "(SPARK_LOCAL_MODE=='false')");
        results.put(HDP250Constant.MAPREDUCE_MODULE_GROUP.getModuleName(), "(SPARK_LOCAL_MODE=='false')");
        results.put(HDP250Constant.ATLAS_HDP_2_5.getModuleName(), null);

        Set<DistributionModuleGroup> moduleGroups = HDP250SparkBatchModuleGroup.getModuleGroups();
