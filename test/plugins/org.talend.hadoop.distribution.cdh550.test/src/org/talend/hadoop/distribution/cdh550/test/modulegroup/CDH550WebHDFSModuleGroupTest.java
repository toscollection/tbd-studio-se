...
public class CDH550WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(CDH550Constant.WEBHDFS_MODULE_GROUP.getModuleName(), null);
        
        Set<DistributionModuleGroup> moduleGroups =
                CDH550WebHDFSModuleGroup.getModuleGroups(CDH550Distribution.DISTRIBUTION_NAME,
                        CDH550Distribution.VERSION);
