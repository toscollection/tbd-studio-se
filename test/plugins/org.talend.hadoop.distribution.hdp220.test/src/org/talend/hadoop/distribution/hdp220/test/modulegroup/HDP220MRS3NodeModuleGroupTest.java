 ...
 *
 */
public class HDP220MRS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(HDP220Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.MR_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.MR_CONFIGURATION.MR_VERSION=='HDP_2_2'))");

        Set<DistributionModuleGroup> moduleGroups = HDP220MRS3NodeModuleGroup.getModuleGroups();
