...
public class SPL300DistributionTest {
    ...
    public void testDatabricksDistribution() throws Exception {
        HadoopComponent distribution = new SPL300Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertTrue(distribution.doSupportS3());
        assertEquals(SPL300Distribution.DISTRIBUTION_NAME, distribution.getDistribution());
        assertEquals(SPL300Distribution.VERSION, distribution.getVersion());
