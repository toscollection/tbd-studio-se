 ...
 *
 */
public class MapR410MRS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(MapR410Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.MR_CONFIGURATION.DISTRIBUTION=='MAPR') AND (#LINK@NODE.MR_CONFIGURATION.MR_VERSION=='MAPR410'))");

        Set<DistributionModuleGroup> moduleGroups = MapR410MRS3NodeModuleGroup.getModuleGroups();
