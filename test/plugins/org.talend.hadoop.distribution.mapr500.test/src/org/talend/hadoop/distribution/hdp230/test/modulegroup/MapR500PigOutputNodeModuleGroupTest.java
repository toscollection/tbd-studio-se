 ...
 *
 */
public class MapR500PigOutputNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(MapR500Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "(#LINK@NODE.ASSOCIATED_PIG_LOAD.DISTRIBUTION=='MAPR') AND (#LINK@NODE.ASSOCIATED_PIG_LOAD.PIG_VERSION=='MAPR500') "
                        + "AND (S3_LOCATION=='true') AND (STORE!='HCATSTORER') AND (STORE!='HBASESTORAGE')");

        Set<DistributionModuleGroup> moduleGroups = MapR500PigOutputNodeModuleGroup.getModuleGroups();
