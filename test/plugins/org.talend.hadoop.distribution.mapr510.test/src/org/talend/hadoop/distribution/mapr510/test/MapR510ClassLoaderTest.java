...
public class MapR510ClassLoaderTest extends AbstractTest4ClassLoaderProvider {
    ...
    public void testHDFS() {
        String libsStr = "commons-collections-3.2.2.jar;commons-configuration-1.6.jar;commons-io-2.4.jar;commons-lang-2.6.jar;commons-logging-1.1.3.jar;guava-14.0.1.jar;hadoop-auth-2.7.0-mapr-1506.jar;hadoop-common-2.7.0-mapr-1506.jar;hadoop-hdfs-2.7.0-mapr-1506.jar;json-20080701.jar;log4j-1.2.17.jar;maprfs-5.1.0-mapr.jar;protobuf-java-2.5.0.jar;slf4j-api-1.7.5.jar;slf4j-log4j12-1.7.5.jar;zookeeper-3.4.5-mapr-1503.jar";//$NON-NLS-1$
