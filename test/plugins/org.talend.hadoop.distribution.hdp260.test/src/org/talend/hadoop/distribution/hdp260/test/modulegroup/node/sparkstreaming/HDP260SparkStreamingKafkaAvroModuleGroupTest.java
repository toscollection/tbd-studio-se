 ...
 *
 */
public class HDP260SparkStreamingKafkaAvroModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(
                HDP260Constant.SPARK_KAFKA_ASSEMBLY_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "(((#LINK@NODE.STORAGE_CONFIGURATION.DISTRIBUTION=='null') AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_VERSION=='null')) AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_LOCAL_MODE=='false') AND (#LINK@NODE.STORAGE_CONFIGURATION.SUPPORTED_SPARK_VERSION=='SPARK_1_6_0'))");
        results.put(
        ...
        results.put(
                HDP260Constant.SPARK_KAFKA_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(),
        ...
        Set<DistributionModuleGroup> moduleGroups = HDP260SparkStreamingKafkaAvroModuleGroup.getModuleGroups(null, null);
