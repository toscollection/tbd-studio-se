 ...
 *
 */
public class HDP260HiveOnSparkModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(HDP260Constant.SPARK_HIVE_MRREQUIRED_MODULE_GROUP.getModuleName(), null);
        results.put(HDP260Constant.SPARK2_HIVE_MRREQUIRED_MODULE_GROUP.getModuleName(), null);
        results.put(HDP260Constant.TEZ_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = HDP260HiveOnSparkModuleGroup.getModuleGroups();
