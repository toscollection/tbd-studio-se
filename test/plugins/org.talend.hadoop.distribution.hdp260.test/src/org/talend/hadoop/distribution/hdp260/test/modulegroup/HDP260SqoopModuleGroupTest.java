 ...
 *
 */
public class HDP260SqoopModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP260Constant.SQOOP_MODULE_GROUP.getModuleName(), null);
...
//        results.put(HDP260Constant.MAPREDUCE_MODULE_GROUP.getModuleName(), null);
        results.put(HDP260Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), null);

        Set<DistributionModuleGroup> moduleGroups = HDP260SqoopModuleGroup.getModuleGroups();
