...
public class HDP260SparkStreamingKinesisNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDP260Constant.SPARK2_KINESIS_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "(((#LINK@NODE.SPARK_CONFIGURATION.DISTRIBUTION=='null') AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_VERSION=='null')) AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_LOCAL_MODE=='false') AND (#LINK@NODE.SPARK_CONFIGURATION.SUPPORTED_SPARK_VERSION=='SPARK_2_1_0'))");
