 ...
 *
 */
public class HDP260HBaseModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(HDP260Constant.HBASE_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = HDP260HBaseModuleGroup.getModuleGroups();
