...
//
// ============================================================================
package org.talend.hadoop.distribution.hdinsight330.test;
...
/**
 * Test class for the {@link HDInsight33Distribution} distribution.
 *
 */
public class HDInsight33DistributionTest {
    ...
    public void testHDInsight32Distribution() throws Exception {
        HadoopComponent distribution = new HDInsight33Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertEquals(EHadoopDistributions.MICROSOFT_HD_INSIGHT.getName(), distribution.getDistribution());
        assertEquals("MICROSOFT_HD_INSIGHT_3_3", distribution.getVersion()); //$NON-NLS-1$
