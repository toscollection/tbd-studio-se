 ...
 *
 */
public class CDH540MRS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(CDH540Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.MR_CONFIGURATION.DISTRIBUTION=='CLOUDERA') AND (#LINK@NODE.MR_CONFIGURATION.MR_VERSION=='Cloudera_CDH5_4'))");

        Set<DistributionModuleGroup> moduleGroups = CDH540MRS3NodeModuleGroup.getModuleGroups();
