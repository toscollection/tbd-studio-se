 ...
 *
 */
public class CDH540HDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(CDH540HDFSModuleGroup.MODULE_GROUP_NAME, null);

        Set<DistributionModuleGroup> moduleGroups = CDH540HDFSModuleGroup.getModuleGroups();
