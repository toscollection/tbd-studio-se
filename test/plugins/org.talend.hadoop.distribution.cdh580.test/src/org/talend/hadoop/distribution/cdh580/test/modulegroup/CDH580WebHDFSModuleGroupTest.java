...
public class CDH580WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(CDH580Constant.WEBHDFS_MODULE_GROUP.getModuleName(), null);
        
        Set<DistributionModuleGroup> moduleGroups =
                CDH580WebHDFSModuleGroup.getModuleGroups(CDH580Distribution.DISTRIBUTION_NAME,
                        CDH580Distribution.VERSION);
