...
public class EMR500SqoopModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(EMR500SqoopModuleGroup.MODULE_GROUP_NAME, null);
        results.put(EMR500MapReduceModuleGroup.MAPREDUCE_GROUP_NAME, null);
        results.put(EMR500HDFSModuleGroup.MODULE_GROUP_NAME, null);
        results.put(EMR500SqoopModuleGroup.SQOOP_PARQUET_MODULE_GROUP_NAME, null);

        Set<DistributionModuleGroup> moduleGroups = EMR500SqoopModuleGroup.getModuleGroups();
