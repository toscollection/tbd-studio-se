...
public class EMR500WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(EMR500WebHDFSModuleGroup.WEBHDFS_MODULE_GROUP_NAME, null);
        
        Set<DistributionModuleGroup> moduleGroups =
                EMR500WebHDFSModuleGroup.getModuleGroups(EMR500Distribution.DISTRIBUTION_NAME,
                        EMR500Distribution.VERSION);
