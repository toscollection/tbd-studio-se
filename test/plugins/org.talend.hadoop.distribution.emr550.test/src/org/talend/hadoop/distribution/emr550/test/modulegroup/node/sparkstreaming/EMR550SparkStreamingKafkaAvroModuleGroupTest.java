...
public class EMR550SparkStreamingKafkaAvroModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(
                EMR550SparkStreamingKafkaAssemblyModuleGroup.KAFKA_ASSEMBLY_GROUP_NAME,
        ...
        results.put(
                EMR550SparkStreamingKafkaAvroModuleGroup.KAFKA_AVRO_GROUP_NAME,
                "((#LINK@NODE.STORAGE_CONFIGURATION.DISTRIBUTION=='AMAZON_EMR') AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_VERSION=='EMR_5_5_0')) AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_LOCAL_MODE=='false')"); //$NON-NLS-1$

        Set<DistributionModuleGroup> moduleGroups = EMR550SparkStreamingKafkaAvroModuleGroup.getModuleGroups(
