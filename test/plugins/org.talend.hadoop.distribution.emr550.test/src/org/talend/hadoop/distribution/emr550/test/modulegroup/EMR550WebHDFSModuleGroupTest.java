...
public class EMR550WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(EMR550WebHDFSModuleGroup.WEBHDFS_MODULE_GROUP_NAME, null);
        
        Set<DistributionModuleGroup> moduleGroups =
                EMR550WebHDFSModuleGroup.getModuleGroups(EMR550Distribution.DISTRIBUTION_NAME,
                        EMR550Distribution.VERSION);
