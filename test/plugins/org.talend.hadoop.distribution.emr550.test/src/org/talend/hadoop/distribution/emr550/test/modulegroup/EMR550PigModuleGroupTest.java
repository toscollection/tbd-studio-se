...
public class EMR550PigModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();
        results.put(EMR550PigModuleGroup.PIG_GROUP_NAME, null);
        results.put(EMR550PigModuleGroup.PIG_HCATALOG_GROUP_NAME, "(LOAD=='HCATLOADER')"); //$NON-NLS-1$
        results.put(EMR550PigModuleGroup.PIG_PARQUET_GROUP_NAME, "(LOAD=='PARQUETLOADER')"); //$NON-NLS-1$
        results.put(EMR550PigModuleGroup.PIG_AVRO_GROUP_NAME, "(LOAD=='AVROSTORAGE')"); //$NON-NLS-1$
        results.put(EMR550PigModuleGroup.PIG_RCFILE_GROUP_NAME, "(LOAD=='RCFILEPIGSTORAGE')"); //$NON-NLS-1$
        results.put(EMR550PigModuleGroup.PIG_SEQUENCEFILE_GROUP_NAME, "(LOAD=='SEQUENCEFILELOADER')"); //$NON-NLS-1$
