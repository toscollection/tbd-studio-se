...
public class HDP240WebHDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<>();

        results.put(HDP240Constant.WEBHDFS_MODULE_GROUP.getModuleName(), null);
        
        Set<DistributionModuleGroup> moduleGroups =
                HDP240WebHDFSModuleGroup.getModuleGroups(HDP240Distribution.DISTRIBUTION_NAME,
                        HDP240Distribution.VERSION);
