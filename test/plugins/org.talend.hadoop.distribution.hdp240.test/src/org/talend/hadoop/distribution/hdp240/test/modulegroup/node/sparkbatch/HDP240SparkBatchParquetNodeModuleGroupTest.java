...
//
// ============================================================================
package org.talend.hadoop.distribution.hdp240.test.modulegroup.node.sparkbatch;
 ...
 *
 */
public class HDP240SparkBatchParquetNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDP240Constant.SPARK_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.SPARK_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_VERSION=='HDP_2_4')) AND (#LINK@NODE.SPARK_CONFIGURATION.SPARK_LOCAL_MODE=='false')");

        Set<DistributionModuleGroup> moduleGroups = HDP240SparkBatchParquetNodeModuleGroup.getModuleGroups();
