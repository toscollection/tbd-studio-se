...
//
// ============================================================================
package org.talend.hadoop.distribution.hdp240.test.modulegroup.node.mr;
 ...
 *
 */
public class HDP240MRS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(HDP240Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.MR_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.MR_CONFIGURATION.MR_VERSION=='HDP_2_4'))");

        Set<DistributionModuleGroup> moduleGroups = HDP240MRS3NodeModuleGroup.getModuleGroups();
