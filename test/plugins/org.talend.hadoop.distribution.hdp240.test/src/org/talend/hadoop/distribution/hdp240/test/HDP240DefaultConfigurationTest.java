 ...
 */
public class HDP240DefaultConfigurationTest extends AbstractTest4DefaultConfiguration {
    ...
    public void testBasic() {
        ...
        doTestExistedProperty("localhost:50300", JOBTRACKER);
        doTestExistedProperty("localhost:8050", RESOURCE_MANAGER);
