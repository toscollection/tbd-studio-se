 ...
 *
 */
public class HDP240SparkStreamingModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP240Constant.SPARK_MODULE_GROUP.getModuleName(), "(SPARK_LOCAL_MODE=='false')");
        ...
        Set<DistributionModuleGroup> moduleGroups = HDP240SparkStreamingModuleGroup.getModuleGroups();
