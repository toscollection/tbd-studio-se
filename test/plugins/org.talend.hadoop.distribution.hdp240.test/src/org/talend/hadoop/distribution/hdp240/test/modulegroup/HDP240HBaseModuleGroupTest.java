 ...
 *
 */
public class HDP240HBaseModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(HDP240Constant.HBASE_MODULE_GROUP.getModuleName(), null);
        Set<DistributionModuleGroup> moduleGroups = HDP240HBaseModuleGroup.getModuleGroups();
