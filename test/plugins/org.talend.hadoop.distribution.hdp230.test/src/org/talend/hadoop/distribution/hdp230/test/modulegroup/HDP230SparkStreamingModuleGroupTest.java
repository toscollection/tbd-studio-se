 ...
 *
 */
public class HDP230SparkStreamingModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP230SparkStreamingModuleGroup.MODULE_GROUP_NAME, "(SPARK_LOCAL_MODE=='false')");

        Set<DistributionModuleGroup> moduleGroups = HDP230SparkStreamingModuleGroup.getModuleGroups();
