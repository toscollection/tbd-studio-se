 ...
 *
 */
public class HDP230PigOutputNodeModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();

        results.put(HDP230Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "(#LINK@NODE.ASSOCIATED_PIG_LOAD.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.ASSOCIATED_PIG_LOAD.PIG_VERSION=='HDP_2_3') "
                        + "AND (S3_LOCATION=='true') AND (STORE!='HCATSTORER') AND (STORE!='HBASESTORAGE')");

        Set<DistributionModuleGroup> moduleGroups = HDP230PigOutputNodeModuleGroup.getModuleGroups();
