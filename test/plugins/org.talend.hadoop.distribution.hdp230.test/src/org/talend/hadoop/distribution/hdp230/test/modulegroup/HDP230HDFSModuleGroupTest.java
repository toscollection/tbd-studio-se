 ...
 *
 */
public class HDP230HDFSModuleGroupTest {

    @Test
    public void testModuleGroups() throws Exception {
        Map<String, String> results = new HashMap<String, String>();
        results.put(HDP230HDFSModuleGroup.MODULE_GROUP_NAME, null);

        Set<DistributionModuleGroup> moduleGroups = HDP230HDFSModuleGroup.getModuleGroups();
