 ...
 *
 */
public class HDP230MRS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(HDP230Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.MR_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.MR_CONFIGURATION.MR_VERSION=='HDP_2_3'))");

        Set<DistributionModuleGroup> moduleGroups = HDP230MRS3NodeModuleGroup.getModuleGroups();
