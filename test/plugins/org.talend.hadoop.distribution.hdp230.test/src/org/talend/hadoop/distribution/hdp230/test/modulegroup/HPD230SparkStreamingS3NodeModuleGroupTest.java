...
import org.talend.hadoop.distribution.hdp230.modulegroup.HDP230SparkStreamingS3NodeModuleGroup;

/**
 * created by pbailly on 16 Feb 2016 Detailled comment
 *
 */
public class HPD230SparkStreamingS3NodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(
                HDP230Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(),
                "((#LINK@NODE.STORAGE_CONFIGURATION.DISTRIBUTION=='HORTONWORKS') AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_VERSION=='HDP_2_3')) AND (#LINK@NODE.STORAGE_CONFIGURATION.SPARK_LOCAL_MODE=='false')");

        Set<DistributionModuleGroup> moduleGroups = HDP230SparkStreamingS3NodeModuleGroup.getModuleGroups();
