...
/**
 * Test class for the {@link HDInsight40Distribution} distribution.
 *
 */
public class HDInsight40DistributionTest extends AbstractDistributionTest {

    public HDInsight40DistributionTest() {
        super(new HDInsight40Distribution());
    }
    ...
    public void testHDInsight40Distribution() throws Exception {
        ...
        assertTrue(((SparkBatchComponent) distribution).getSparkVersions().contains(ESparkVersion.SPARK_2_3));
        ...
        assertTrue(((SparkStreamingComponent) distribution).getSparkVersions().contains(ESparkVersion.SPARK_2_3));
