...
public class HDInsight40SparkStreamingParquetNodeModuleGroupTest {
    ...
    public void testModuleGroups() throws Exception {
        ...
        results.put(HDInsight40Constant.SPARK23_STREAMING_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(), "(SUPPORTED_SPARK_VERSION=='SPARK_2_3_x')");
        results.put(HDInsight40Constant.SPARK24_STREAMING_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(), "(SUPPORTED_SPARK_VERSION=='SPARK_2_4_x')");
