...
public class ExpressionView extends ViewPart {
    ...
    public void createPartControl(Composite parent) {
        ...
        expressionInput = new Text(sashForm, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
        expressionInput.setEditable(true);

        expressionOutput = new Text(sashForm, SWT.MULTI | SWT.V_SCROLL | SWT.H_SCROLL);
    ...
    private void makeActions() {
        ...
        evaluateAction.setImageDescriptor(PerlDebugImages.ACTION_EXPRESSION_EVALUATE);
    }
    ...
    private void evaluateExpression() {
        ...
        if (stackFrame != null) {
            try {
                ...
                if (res != null) {
                    isMatch = mReIsWhitespace.isMatch(res) || mReIsWhitespace.getAllMatches(res).length > 0;
                }
            ...
            MessageDialog
                    .openInformation(this.getViewSite().getShell(), "No stack frame selected",
