...
public class HDFSPackageImpl extends EPackageImpl implements HDFSPackage {
    ...
    public void initializePackageContents() {
        ...
        hdfsConnectionEClass.getESuperTypes().add(theConnectionPackage.getConnection());
        hdfsConnectionItemEClass.getESuperTypes().add(thePropertiesPackage.getConnectionItem());
        ...
        initEAttribute(getHDFSConnection_NameNodeURI(), theEcorePackage.getEString(), "nameNodeURI", null, 0, 1, HDFSConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEAttribute(getHDFSConnection_Principal(), theEcorePackage.getEString(), "principal", null, 0, 1, HDFSConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEAttribute(getHDFSConnection_UserName(), theEcorePackage.getEString(), "userName", null, 0, 1, HDFSConnection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
