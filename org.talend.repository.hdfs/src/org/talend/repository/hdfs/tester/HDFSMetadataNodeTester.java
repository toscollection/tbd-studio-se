...
//
// ============================================================================
package org.talend.repository.hdfs.tester;
 ...
 */
public class HDFSMetadataNodeTester extends CoMetadataNodeTester {

    private static final String IS_HDFS_CONNECTION = "isHDFSConnection"; //$NON-NLS-1$

    protected ERepositoryObjectType findType(String property) {
        if (property != null) {
            if (IS_HDFS_CONNECTION.equals(property)) {
