...
public class OutputMessages {
    ...
    public static final String MSG_OUTPUT_STARTUP = Messages.getString("MSG_output_startup");

    public static final String MSG_OUTPUT_DEPLOYING = Messages.getString("MSG_output_deploying");

    public static final String MSG_OUTPUT_DEPLOY_COMPLETE = Messages.getString("MSG_output_deployment_complete");
