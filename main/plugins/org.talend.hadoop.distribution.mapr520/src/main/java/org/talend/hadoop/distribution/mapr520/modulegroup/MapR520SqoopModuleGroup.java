...
public class MapR520SqoopModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(MapR520Constant.SQOOP_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(MapR520Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), true,
