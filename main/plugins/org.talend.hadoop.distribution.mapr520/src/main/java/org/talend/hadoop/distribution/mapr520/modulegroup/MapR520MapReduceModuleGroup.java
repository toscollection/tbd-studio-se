...
public class MapR520MapReduceModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(MapR520Constant.MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName(), true));
        hs.add(new DistributionModuleGroup(MapR520Constant.MAPREDUCE_AVRO_MODULE_GROUP.getModuleName(), true));
        return hs;
    }
}
