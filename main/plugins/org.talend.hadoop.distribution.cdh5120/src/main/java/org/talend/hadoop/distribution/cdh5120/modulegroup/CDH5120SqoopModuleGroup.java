...
public class CDH5120SqoopModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(CDH5120Constant.SQOOP_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(CDH5120Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), true,
