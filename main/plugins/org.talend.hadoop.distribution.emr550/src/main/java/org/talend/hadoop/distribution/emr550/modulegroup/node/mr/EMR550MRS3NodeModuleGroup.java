...
//
// ============================================================================
package org.talend.hadoop.distribution.emr550.modulegroup.node.mr;
...
public class EMR550MRS3NodeModuleGroup {

    public static final String S3_GROUP_NAME = "S3-LIB-EMR_5_5_0_LATEST"; //$NON-NLS-1$
