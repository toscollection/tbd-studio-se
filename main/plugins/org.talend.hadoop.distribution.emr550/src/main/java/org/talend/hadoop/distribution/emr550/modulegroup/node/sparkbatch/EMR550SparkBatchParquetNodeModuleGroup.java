...
public class EMR550SparkBatchParquetNodeModuleGroup {

    public static final String SPARK_PARQUET_GROUP_NAME = "SPARK-PARQUET-LIB-MRREQUIRED-EMR_5_5_0_LATEST"; //$NON-NLS-1$
