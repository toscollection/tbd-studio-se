...
public class EMR550MapReduceModuleGroup {
    ...
    public static final String MAPREDUCE_PARQUET_MRREQUIRED_GROUP_NAME = "MAPREDUCE-PARQUET-LIB-MRREQUIRED-EMR_5_5_0"; //$NON-NLS-1$

    public static final String MAPREDUCE_AVRO_MRREQUIRED_GROUP_NAME = "MAPREDUCE-AVRO-LIB-MRREQUIRED-EMR_5_5_0"; //$NON-NLS-1$
