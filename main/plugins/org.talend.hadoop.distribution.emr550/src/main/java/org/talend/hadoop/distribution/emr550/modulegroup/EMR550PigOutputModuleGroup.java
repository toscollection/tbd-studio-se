...
//
// ============================================================================
package org.talend.hadoop.distribution.emr550.modulegroup;
...
public class EMR550PigOutputModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(EMR550PigModuleGroup.PIG_HCATALOG_GROUP_NAME, false, hcatStorerCondition));
        hs.add(new DistributionModuleGroup(EMR550PigModuleGroup.PIG_AVRO_GROUP_NAME, false, avroStorerCondition));
        hs.add(new DistributionModuleGroup(EMR550PigModuleGroup.PIG_RCFILE_GROUP_NAME, false, rcfileStorerCondition));
        hs.add(new DistributionModuleGroup(EMR550PigModuleGroup.PIG_SEQUENCEFILE_GROUP_NAME, false, sequencefileStorerCondition));
        hs.add(new DistributionModuleGroup(EMR550HBaseModuleGroup.MODULE_GROUP_NAME, false, hbaseStorerCondition));
        hs.add(new DistributionModuleGroup(EMR550PigModuleGroup.PIG_HBASE_GROUP_NAME, false, hbaseStorerCondition));
        return hs;
    }
