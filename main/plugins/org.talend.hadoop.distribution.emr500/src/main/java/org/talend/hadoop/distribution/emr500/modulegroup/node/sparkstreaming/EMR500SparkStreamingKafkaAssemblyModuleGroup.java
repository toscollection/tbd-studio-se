...
public class EMR500SparkStreamingKafkaAssemblyModuleGroup {

    public static final String KAFKA_ASSEMBLY_GROUP_NAME = "SPARK-KAFKA-ASSEMBLY-LIB-MRREQUIRED-EMR_5_0_0_LATEST"; //$NON-NLS-1$
