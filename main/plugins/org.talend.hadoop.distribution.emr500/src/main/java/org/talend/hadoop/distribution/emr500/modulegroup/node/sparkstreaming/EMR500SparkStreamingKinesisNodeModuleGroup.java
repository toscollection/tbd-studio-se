...
public class EMR500SparkStreamingKinesisNodeModuleGroup {

    public static final String KINESIS_ASSEMBLY_GROUP_NAME = "SPARK-KINESIS-LIB-MRREQUIRED-EMR_5_0_0_LATEST"; //$NON-NLS-1$
