...
public class EMR500SqoopModuleGroup {

    public static final String MODULE_GROUP_NAME = "SQOOP-LIB-EMR_5_0_0_LATEST"; //$NON-NLS-1$

    public static final String SQOOP_PARQUET_MODULE_GROUP_NAME = "SQOOP-PARQUET-LIB-EMR_5_0_0_LATEST"; //$NON-NLS-1$

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(MODULE_GROUP_NAME));
        hs.add(new DistributionModuleGroup(EMR500MapReduceModuleGroup.MAPREDUCE_GROUP_NAME));
        hs.add(new DistributionModuleGroup(EMR500HDFSModuleGroup.MODULE_GROUP_NAME));
