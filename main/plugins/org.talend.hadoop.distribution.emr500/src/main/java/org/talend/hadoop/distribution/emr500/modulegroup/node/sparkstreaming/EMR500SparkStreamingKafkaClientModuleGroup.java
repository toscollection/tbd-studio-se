...
public class EMR500SparkStreamingKafkaClientModuleGroup {

    public static final String KAFKA_CLIENT_GROUP_NAME = "SPARK-KAFKA-CLIENT-LIB-MRREQUIRED-EMR_5_0_0_LATEST"; //$NON-NLS-1$
