...
public class MapR213Distribution extends AbstractMapRDistribution implements HDFSComponent, MRComponent, HBaseComponent,
    ...
    static {
        ...
        customVersionDisplayNames.put(ComponentType.SQOOP, Constant.SQOOP_MAPR213_DISPLAY);
    }
    ...
    public String getVersion() {
        return EHadoopVersion4Drivers.MAPR213.getVersionValue();
    }

    @Override
    public String getVersionName(ComponentType componentType) {
        String customVersionName = customVersionDisplayNames.get(componentType);
        return customVersionName != null ? customVersionName : EHadoopVersion4Drivers.MAPR213.getVersionDisplay();
    }
