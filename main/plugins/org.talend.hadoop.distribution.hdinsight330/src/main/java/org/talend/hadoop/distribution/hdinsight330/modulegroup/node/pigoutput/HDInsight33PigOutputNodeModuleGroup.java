...
//
// ============================================================================
package org.talend.hadoop.distribution.hdinsight330.modulegroup.node.pigoutput;
...
public class HDInsight33PigOutputNodeModuleGroup {
    ...
    private static final ComponentCondition condition = new MultiComponentCondition( //
            ...
            BooleanOperator.AND, //
            new LinkedNodeExpression(PigOutputConstant.PIGSTORE_COMPONENT_LINKEDPARAMETER,
                    ComponentType.PIG.getVersionParameter(), EqualityOperator.EQ, HDInsight33Distribution.VERSION));

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(HDInsight33Constant.PIG_PARQUET_MODULE_GROUP.getModuleName(), false, condition));
        return hs;
    }
