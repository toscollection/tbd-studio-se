...
public class Dataproc14SparkStreamingKafkaAssemblyModuleGroup {

    public static final String KAFKA_ASSEMBLY_GROUP_NAME = "SPARK-KAFKA-ASSEMBLY-LIB-MRREQUIRED-DATAPROC14"; //$NON-NLS-1$
