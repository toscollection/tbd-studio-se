...
public class HDFSSwitch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case HDFSPackage.HDFS_CONNECTION: {
                HDFSConnection hdfsConnection = (HDFSConnection)theEObject;
                T result = caseHDFSConnection(hdfsConnection);
                if (result == null) result = caseHadoopSubConnection(hdfsConnection);
                if (result == null) result = caseConnection(hdfsConnection);
                if (result == null) result = caseAbstractMetadataObject(hdfsConnection);
                if (result == null) result = caseDataProvider(hdfsConnection);
                if (result == null) result = caseDataManager(hdfsConnection);
                if (result == null) result = caseElement(hdfsConnection);
                if (result == null) result = caseDeployedComponent(hdfsConnection);
                if (result == null) result = casePackage(hdfsConnection);
                if (result == null) result = caseNamespace(hdfsConnection);
                if (result == null) result = caseModelElement(hdfsConnection);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case HDFSPackage.HDFS_CONNECTION_ITEM: {
                HDFSConnectionItem hdfsConnectionItem = (HDFSConnectionItem)theEObject;
                T result = caseHDFSConnectionItem(hdfsConnectionItem);
                if (result == null) result = caseHadoopSubConnectionItem(hdfsConnectionItem);
                if (result == null) result = caseConnectionItem(hdfsConnectionItem);
                if (result == null) result = caseItem(hdfsConnectionItem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseHDFSConnection(HDFSConnection object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseHDFSConnectionItem(HDFSConnectionItem object) {
        return null;
    }
