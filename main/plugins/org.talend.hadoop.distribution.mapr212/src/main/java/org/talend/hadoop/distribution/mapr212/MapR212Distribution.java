...
public class MapR212Distribution extends AbstractMapRDistribution implements HDFSComponent, MRComponent, HBaseComponent,
    ...
    static {
        ...
        customVersionDisplayNames.put(ComponentType.SQOOP, Constant.SQOOP_MAPR212_DISPLAY);
    }
    ...
    public String getVersion() {
        return EHadoopVersion4Drivers.MAPR212.getVersionValue();
    }

    @Override
    public String getVersionName(ComponentType componentType) {
        String customVersionName = customVersionDisplayNames.get(componentType);
        return customVersionName != null ? customVersionName : EHadoopVersion4Drivers.MAPR212.getVersionDisplay();
    }
