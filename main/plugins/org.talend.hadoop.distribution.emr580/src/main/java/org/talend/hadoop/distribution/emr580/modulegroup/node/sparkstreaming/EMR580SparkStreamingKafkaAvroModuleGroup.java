...
public class EMR580SparkStreamingKafkaAvroModuleGroup {

    public static final String KAFKA_AVRO_GROUP_NAME = "SPARK-KAFKA-AVRO-LIB-MRREQUIRED-EMR_5_8_0_LATEST"; //$NON-NLS-1$
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        hs.addAll(EMR580SparkStreamingKafkaAssemblyModuleGroup.getModuleGroups(distribution, version));
        return hs;
    }
}