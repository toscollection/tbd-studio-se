...
public class EMR580SparkStreamingKafkaAssemblyModuleGroup {

    public static final String KAFKA_ASSEMBLY_GROUP_NAME = "SPARK-KAFKA-ASSEMBLY-LIB-MRREQUIRED-EMR_5_8_0_LATEST"; //$NON-NLS-1$
