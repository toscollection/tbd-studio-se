...
public class CDH580SqoopModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH580Constant.SQOOP_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(CDH580Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), true,
