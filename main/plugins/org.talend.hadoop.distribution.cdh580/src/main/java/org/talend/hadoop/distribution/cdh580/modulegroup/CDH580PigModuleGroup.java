...
public class CDH580PigModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH580Constant.PIG_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(CDH580Constant.PIG_PARQUET_MODULE_GROUP.getModuleName(), false, parquetLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH580Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroLoaderCondition));
        hs.add(new DistributionModuleGroup(CDH580Constant.PIG_RCFILE_MODULE_GROUP.getModuleName(), false, rcfileLoaderCondition));
        ...
        hs.add(new DistributionModuleGroup(CDH580Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(), true, s3condition));
