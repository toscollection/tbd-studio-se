 ...
 */
public class DynamicCDHSqoopModuleGroupTemplate extends DynamicSqoopModuleGroupTemplate {

    public DynamicCDHSqoopModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
