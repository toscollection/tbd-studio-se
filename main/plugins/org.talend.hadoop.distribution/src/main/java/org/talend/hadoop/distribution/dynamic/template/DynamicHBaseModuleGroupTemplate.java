 ...
 */
public class DynamicHBaseModuleGroupTemplate extends AbstractDynamicModuleGroupTemplate {

    public DynamicHBaseModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
    ...
    public Map<ComponentType, Set<DistributionModuleGroup>> getModuleGroups() throws Exception {
        ...
        moduleGroups.put(ComponentType.HBASE, buildModuleGroups4HBase(getPluginAdapter()));
