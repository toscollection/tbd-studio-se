 ...
 */
public interface IHortonworksDependencyResolver extends IDependencyResolver {

    public static final String DISTRIBUTION = IHortonworksDistribution.DISTRIBUTION_NAME;
