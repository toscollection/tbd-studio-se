 ...
 */
public abstract class AbstractDynamicModuleGroupTemplate implements IDynamicModuleGroupTemplate {

    private DynamicPluginAdapter pluginAdapter;

    public AbstractDynamicModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        this.pluginAdapter = pluginAdapter;
    }

    @Override
    public DynamicPluginAdapter getPluginAdapter() throws Exception {
