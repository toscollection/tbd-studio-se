 ...
 */
public abstract class AbstractDynamicHDPDistributionPreference extends AbstractDynamicDistributionPreference
        implements IDynamicHDPDistributionPreference {

    protected AbstractDynamicHDPDistributionPreference(ScopedPreferenceStore store) {
        super(store);
    }
