 ...
 */
public class DynamicImpalaModuleGroupTemplate extends AbstractDynamicModuleGroupTemplate {

    public DynamicImpalaModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
    ...
    public Map<ComponentType, Set<DistributionModuleGroup>> getModuleGroups() throws Exception {
        ...
        moduleGroups.put(ComponentType.IMPALA, buildModuleGroups4Impala(getPluginAdapter()));
