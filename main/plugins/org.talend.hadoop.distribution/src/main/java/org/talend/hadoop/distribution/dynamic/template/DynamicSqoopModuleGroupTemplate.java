 ...
 */
public class DynamicSqoopModuleGroupTemplate extends AbstractDynamicModuleGroupTemplate {

    public DynamicSqoopModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
    ...
    public Map<ComponentType, Set<DistributionModuleGroup>> getModuleGroups() throws Exception {
        ...
        moduleGroups.put(ComponentType.SQOOP, buildModuleGroups4Sqoop(getPluginAdapter()));
