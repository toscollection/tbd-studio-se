...
public enum DynamicModuleGroupConstant implements IDynamicModuleGroupConstant {
    ...
    HIVE_COMPONENTS_MODULE_GROUP("HIVE-COMPONENTS-LIB-DYNAMIC"), //$NON-NLS-1$
    HIVE_WAREHOUSE_MODULE_GROUP("HIVE-WAREHOUSE-LIB-DYNAMIC"), //$NON-NLS-1$
    KNOX_MODULE_GROUP("KNOX-LIB-MRREQUIRED-DYNAMIC"), //$NON-NLS-1$
