 ...
 */
public class DynamicCDHSparkBatchModuleGroup extends DynamicSparkBatchModuleGroup {

    public DynamicCDHSparkBatchModuleGroup(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
