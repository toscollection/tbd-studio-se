 ...
 */
public abstract class AbstractDynamicCDHDistributionPreference extends AbstractDynamicDistributionPreference
        implements IDynamicCDHDistributionPreference {

    protected AbstractDynamicCDHDistributionPreference(ScopedPreferenceStore store) {
        super(store);
    }
