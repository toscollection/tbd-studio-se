...
public abstract class AbstractDistribution {
    ...
    Set<DistributionModuleGroup> cassandraLookupInputModuleGroups = ModuleGroupsUtils.getModuleGroups(distribution, version, (String) null, ModuleGroupName.CASSANDRA_LOOKUPINPUT.get(this.getVersion()), true );
    ...
    result.put(new NodeComponentTypeBean(ComponentType.SPARKSTREAMING, SparkStreamingConstant.CASSANDRA_LOOKUPINPUT_COMPONENT), cassandraLookupInputModuleGroups);
