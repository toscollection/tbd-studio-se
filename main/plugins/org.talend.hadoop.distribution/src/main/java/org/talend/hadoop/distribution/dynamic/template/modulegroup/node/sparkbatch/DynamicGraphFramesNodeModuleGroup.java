...
public class DynamicGraphFramesNodeModuleGroup extends AbstractNodeModuleGroup {

    public DynamicGraphFramesNodeModuleGroup(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
