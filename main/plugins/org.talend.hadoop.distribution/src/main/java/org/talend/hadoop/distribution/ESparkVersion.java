...
public enum ESparkVersion {
    ...
    SPARK_2_4_X("SPARK_2_4_x", "2.4.x", "SPARK_24x"), //$NON-NLS-1$ //$NON-NLS-2$
    SPARK_3_0("SPARK_3_0_x", "3.0.x", "SPARK_30x"), //$NON-NLS-1$ //$NON-NLS-2$
	SPARK_3_1("SPARK_3_1_x", "3.1.x", "SPARK_31x"); //$NON-NLS-1$ //$NON-NLS-2$
