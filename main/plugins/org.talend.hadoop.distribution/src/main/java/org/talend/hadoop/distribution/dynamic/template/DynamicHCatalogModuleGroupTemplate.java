 ...
 */
public class DynamicHCatalogModuleGroupTemplate extends AbstractDynamicModuleGroupTemplate {

    public DynamicHCatalogModuleGroupTemplate(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
    ...
    public Map<ComponentType, Set<DistributionModuleGroup>> getModuleGroups() throws Exception {
        ...
        moduleGroups.put(ComponentType.HCATALOG, buildModuleGroups4HCatalog(getPluginAdapter()));
