 ...
 */
public class DynamicHDPSparkStreamingKafkaAvroModuleGroup extends DynamicSparkStreamingKafkaAvroModuleGroup {

    public DynamicHDPSparkStreamingKafkaAvroModuleGroup(DynamicPluginAdapter pluginAdapter) {
        super(pluginAdapter);
    }
    ...
    public Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) throws Exception {
        ...
        moduleGroups.addAll(
                new DynamicHDPSparkStreamingKafkaAssemblyModuleGroup(pluginAdapter).getModuleGroups(distribution, version));
        return moduleGroups;
    }
}
