...
public abstract class AbstractDynamicDistributionTemplate extends AbstractDistribution
    ...
    public AbstractDynamicDistributionTemplate(DynamicPluginAdapter pluginAdapter) throws Exception {
        ...
        if 	(("HDP3xxDistributionTemplate".equals(configuration.getTemplateId())
                        && configuration.getVersion().startsWith("3.1")) ||
		("CDH6xDistributionTemplate".equals(configuration.getTemplateId())
                        && configuration.getVersion().startsWith("6.1"))) {
