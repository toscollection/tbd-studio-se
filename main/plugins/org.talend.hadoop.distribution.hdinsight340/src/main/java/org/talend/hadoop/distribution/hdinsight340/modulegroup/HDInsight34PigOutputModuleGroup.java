...
public class HDInsight34PigOutputModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(HDInsight34Constant.PIG_HCATALOG_MODULE_GROUP.getModuleName(), false,
                hcatStorerCondition));
        hs.add(new DistributionModuleGroup(HDInsight34Constant.PIG_AVRO_MODULE_GROUP.getModuleName(), false, avroStorerCondition));
