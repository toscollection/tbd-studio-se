...
public class HDInsight34SparkStreamingS3NodeModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                HDInsight34Constant.SPARK_S3_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
                new SparkStreamingLinkedNodeCondition(EHadoopDistributions.MICROSOFT_HD_INSIGHT.getName(),
                        HDInsight34Distribution.VERSION, SparkStreamingConstant.S3_SPARKCONFIGURATION_LINKEDPARAMETER)
                        .getCondition());
        hs.add(dmg);
        return hs;
    }
