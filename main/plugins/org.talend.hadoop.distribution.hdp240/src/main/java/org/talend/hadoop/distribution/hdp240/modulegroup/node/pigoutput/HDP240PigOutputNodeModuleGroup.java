...
//
// ============================================================================
package org.talend.hadoop.distribution.hdp240.modulegroup.node.pigoutput;
...
public class HDP240PigOutputNodeModuleGroup {
    ...
    private static final ComponentCondition condition = new MultiComponentCondition(
            ...
            new LinkedNodeExpression(PigOutputConstant.PIGSTORE_COMPONENT_LINKEDPARAMETER, ComponentType.PIG
                    .getVersionParameter(), EqualityOperator.EQ, HDP240Distribution.VERSION));
