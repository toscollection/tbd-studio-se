...
//
// ============================================================================
package org.talend.hadoop.distribution.dbr350.modulegroup.node.sparkbatch;
...
public class DBR350SparkBatchAzureNodeModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                DBR350Constant.SPARK_AZURE_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
