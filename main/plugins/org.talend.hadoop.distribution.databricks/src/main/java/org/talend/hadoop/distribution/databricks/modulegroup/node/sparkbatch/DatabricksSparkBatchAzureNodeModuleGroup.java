...
//
// ============================================================================
package org.talend.hadoop.distribution.databricks.modulegroup.node.sparkbatch;
...
public class DatabricksSparkBatchAzureNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        ...
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                DatabricksConstant.SPARK_AZURE_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
