...
//
// ============================================================================
package org.talend.hadoop.distribution.emr440.modulegroup;
...
public class EMR440SparkStreamingModuleGroup {

    private static final String MODULE_GROUP_NAME = "SPARK-LIB-EMR_4_4_0_LATEST"; //$NON-NLS-1$
