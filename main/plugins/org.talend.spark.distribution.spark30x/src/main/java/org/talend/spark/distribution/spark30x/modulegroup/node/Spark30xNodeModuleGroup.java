package org.talend.spark.distribution.spark30x.modulegroup.node;
...
public class Spark30xNodeModuleGroup {
    ...
    static ComponentCondition spark30xCondition(String sparkConfigLinkedParameter, ESparkVersion sparkVersion) {
