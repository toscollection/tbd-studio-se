...
public class MapR510SparkStreamingMapRStreamsAvroModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                MapR510Constant.SPARK_KAFKA_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
        ...
        hs.addAll(MapR510SparkStreamingMapRStreamsAssemblyModuleGroup.getModuleGroups());
        return hs;
    }
}
