...
public class MapR510HiveModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(MapR510Constant.MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(MapR510Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
