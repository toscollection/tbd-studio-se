...
public class MapR601MapRStreamsCreateStreamModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        final ComponentCondition isCurrentDistribution = new NestedComponentCondition(new MultiComponentCondition(
                new SimpleComponentCondition(new LinkedNodeExpression("CONNECTION",
                        ...
                        MapR601Distribution.DISTRIBUTION_NAME)), //
                BooleanOperator.AND, //
                new SimpleComponentCondition(new LinkedNodeExpression("CONNECTION",
                        ComponentType.MAPRSTREAMS.getVersionParameter(), EqualityOperator.EQ, MapR601Distribution.VERSION))));

        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(MapR601Constant.MAPRSTREAMS_CREATE_STREAM_MODULE_GROUP.getModuleName(), false,
