...
public class CassandraRetrieveSchemaForm extends AbstractNoSQLRetrieveSchemaForm {

    public CassandraRetrieveSchemaForm(Composite parent, ConnectionItem connectionItem, String[] existingNames, boolean creation,
