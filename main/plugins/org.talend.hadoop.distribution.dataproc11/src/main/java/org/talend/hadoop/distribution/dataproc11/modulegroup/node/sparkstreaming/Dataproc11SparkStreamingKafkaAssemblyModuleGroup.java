...
public class Dataproc11SparkStreamingKafkaAssemblyModuleGroup {

    public static final String KAFKA_ASSEMBLY_GROUP_NAME = "SPARK-KAFKA-ASSEMBLY-LIB-MRREQUIRED-DATAPROC11"; //$NON-NLS-1$
