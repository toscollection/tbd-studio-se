...
public class Dataproc11SparkBatchParquetNodeModuleGroup {

    public static final String SPARK_PARQUET_GROUP_NAME = "SPARK-PARQUET-LIB-MRREQUIRED-DATAPROC_1_1_LATEST"; //$NON-NLS-1$
