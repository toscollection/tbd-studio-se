...
public class MapR600HiveModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(MapR600Constant.HIVE_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(MapR600Constant.MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(MapR600Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
