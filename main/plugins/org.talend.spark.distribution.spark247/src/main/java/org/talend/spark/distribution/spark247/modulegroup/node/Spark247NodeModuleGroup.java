package org.talend.spark.distribution.spark247.modulegroup.node;
...
public class Spark247NodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroup(String moduleGroupName, String sparkConfigLinkedParameter,
        ...
        DistributionModuleGroup dmg = new DistributionModuleGroup(moduleGroupName, true, spark247Condition(sparkConfigLinkedParameter, sparkVersion));
        hs.add(dmg);
        return hs;
    }

    static ComponentCondition spark247Condition(String sparkConfigLinkedParameter, ESparkVersion sparkVersion) {
