...
public class CDH5xHBaseModuleGroup extends AbstractModuleGroup {
    ...
    public CDH5xHBaseModuleGroup(String id) {
        super(id);
    }

    public Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        DistributionModuleGroup dmg = new DistributionModuleGroup(CDH5xConstant.HBASE_MODULE_GROUP.getModuleName(getId()), true,
                null);
        hs.add(dmg);
        return hs;
    }
