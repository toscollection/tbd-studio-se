...
public class MapR611HiveModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(MapR611Constant.HIVE_MODULE_GROUP.getModuleName()));
        hs.add(new DistributionModuleGroup(MapR611Constant.HDFS_MODULE_GROUP.getModuleName()));
        hs.add(new DistributionModuleGroup(MapR611Constant.MAPREDUCE_MODULE_GROUP.getModuleName()));

        // TODO use parquet only when asked.
        hs.add(new DistributionModuleGroup(MapR611Constant.MAPREDUCE_PARQUET_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(MapR611Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
