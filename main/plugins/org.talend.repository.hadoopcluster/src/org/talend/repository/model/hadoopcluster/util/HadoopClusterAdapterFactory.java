 ...
 * @generated
 */
public class HadoopClusterAdapterFactory extends AdapterFactoryImpl {
    /**
     ...
     * @generated
     */
    public HadoopClusterAdapterFactory() {
     ...
     * @generated
     */
    protected HadoopClusterSwitch<Adapter> modelSwitch =
        new HadoopClusterSwitch<Adapter>() {
            @Override
            public Adapter caseHadoopClusterConnection(HadoopClusterConnection object) {
                return createHadoopClusterConnectionAdapter();
            }
            @Override
            public Adapter caseHadoopClusterConnectionItem(HadoopClusterConnectionItem object) {
                return createHadoopClusterConnectionItemAdapter();
            }
            @Override
            public Adapter caseHadoopAdditionalProperties(Map.Entry<String, String> object) {
                return createHadoopAdditionalPropertiesAdapter();
            }
            @Override
            public Adapter caseHadoopSubConnection(HadoopSubConnection object) {
                return createHadoopSubConnectionAdapter();
            }
            @Override
            public Adapter caseHadoopSubConnectionItem(HadoopSubConnectionItem object) {
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.hadoopcluster.HadoopClusterConnection <em>Connection</em>}'.
     * <!-- begin-user-doc -->
     ...
     * @generated
     */
    public Adapter createHadoopClusterConnectionAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.hadoopcluster.HadoopClusterConnectionItem <em>Connection Item</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createHadoopClusterConnectionItemAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Hadoop Additional Properties</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createHadoopAdditionalPropertiesAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.hadoopcluster.HadoopSubConnection <em>Hadoop Sub Connection</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createHadoopSubConnectionAdapter() {
        return null;
    }

    /**
     * Creates a new adapter for an object of class '{@link org.talend.repository.model.hadoopcluster.HadoopSubConnectionItem <em>Hadoop Sub Connection Item</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
