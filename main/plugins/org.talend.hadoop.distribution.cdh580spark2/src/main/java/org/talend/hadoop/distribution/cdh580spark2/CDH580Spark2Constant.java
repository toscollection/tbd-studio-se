...
public enum CDH580Spark2Constant {
    ...
    PIG_MODULE_GROUP("PIG-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    ...
    PIG_AVRO_MODULE_GROUP("PIG-AVRO-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    PIG_HBASE_MODULE_GROUP("PIG-HBASE-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    PIG_HCATALOG_MODULE_GROUP("PIG-HCATALOG-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    PIG_PARQUET_MODULE_GROUP("PIG-PARQUET-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    PIG_RCFILE_MODULE_GROUP("PIG-RCFILE-LIB-CDH580_SPARK2"), //$NON-NLS-1$
    PIG_SEQUENCEFILE_MODULE_GROUP("PIG-SEQUENCEFILE-LIB-CDH580_SPARK2"), //$NON-NLS-1$
