...
public class CDH580Spark2SparkStreamingKafkaAvroModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version) {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                CDH580Spark2Constant.SPARK_KAFKA_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
        ...
        hs.addAll(CDH580Spark2SparkStreamingKafkaAssemblyModuleGroup.getModuleGroups(distribution, version));
        return hs;
    }
}