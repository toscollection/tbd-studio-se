...
public class CDH580Spark2SparkBatchModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(CDH580Spark2Constant.SPARK_MRREQUIRED_MODULE_GROUP.getModuleName(), true, condition));
        ...
        hs.add(new DistributionModuleGroup(CDH580Spark2Constant.TALEND_CLOUDERA_CDH_5_5_NAVIGATOR.getModuleName(), true,
