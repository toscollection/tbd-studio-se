...
public enum SPL300Constant {
    ...
    SPARK_BATCH_BIGQUERY_MODULE_GROUP("SPARK_BATCH_BIGQUERY_MODULE_GROUP_SPL300"),
    SPARK_BATCH_HIVE_MODULE_GROUP("SPARK_BATCH_HIVE_MODULE_GROUP_SPL300"),
    SPARK_BATCH_DELTALAKE_MODULE_GROUP("SPARK_BATCH_DELTALAKE_MODULE_GROUP_SPL300"),
    SPARK_BATCH_CASSANDRA_MODULE_GROUP("SPARK_BATCH_CASSANDRA_MODULE_GROUP_SPL300"),
