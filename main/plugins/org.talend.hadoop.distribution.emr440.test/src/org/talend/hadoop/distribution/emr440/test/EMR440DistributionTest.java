...
//
// ============================================================================
package org.talend.hadoop.distribution.emr440.test;
...
import org.talend.hadoop.distribution.emr440.EMR440Distribution;

/**
 * Test class for the {@link EMR440Distribution} distribution.
 *
 */
public class EMR440DistributionTest {
    ...
    public void testEMR400Distribution() throws Exception {
        HadoopComponent distribution = new EMR440Distribution();
        assertNotNull(distribution.getDistributionName());
        assertNotNull(distribution.getVersionName(null));
        assertEquals(EHadoopDistributions.AMAZON_EMR.getName(), distribution.getDistribution());
        assertEquals(EHadoopVersion4Drivers.EMR_4_4_0.getVersionValue(), distribution.getVersion());
