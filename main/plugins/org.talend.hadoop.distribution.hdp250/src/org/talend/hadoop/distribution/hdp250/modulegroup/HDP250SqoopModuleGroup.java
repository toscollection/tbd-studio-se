...
public class HDP250SqoopModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(HDP250Constant.SQOOP_MODULE_GROUP.getModuleName()));
...
//        hs.add(new DistributionModuleGroup(HDP250Constant.MAPREDUCE_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(HDP250Constant.SQOOP_PARQUET_MODULE_GROUP.getModuleName(), true,
