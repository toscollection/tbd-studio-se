...
public class EMR450SparkStreamingKinesisNodeModuleGroup {

    public static final String KINESIS_ASSEMBLY_GROUP_NAME = "SPARK-KINESIS-LIB-MRREQUIRED-EMR_4_5_0_LATEST"; //$NON-NLS-1$
