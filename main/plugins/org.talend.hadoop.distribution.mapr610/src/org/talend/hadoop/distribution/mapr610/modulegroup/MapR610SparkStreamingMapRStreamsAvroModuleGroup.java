...
public class MapR610SparkStreamingMapRStreamsAvroModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                MapR610Constant.SPARK_KAFKA_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
        ...
        hs.addAll(MapR610SparkStreamingMapRStreamsAssemblyModuleGroup.getModuleGroups());
        return hs;
    }
}
