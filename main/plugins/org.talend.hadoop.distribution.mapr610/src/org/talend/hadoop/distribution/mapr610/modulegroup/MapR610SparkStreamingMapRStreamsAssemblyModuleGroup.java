...
public class MapR610SparkStreamingMapRStreamsAssemblyModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        DistributionModuleGroup dmg = new DistributionModuleGroup(
                MapR610Constant.SPARK_MAPRSTREAMS_ASSEMBLY_MRREQUIRED_MODULE_GROUP.getModuleName(), true,
        ...
        hs.add(dmg);
        hs.addAll(MapR610SparkStreamingKafkaAssemblyModuleGroup.getModuleGroups());
        return hs;
    }
}
