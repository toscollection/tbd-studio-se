...
public class CDP703HiveModuleGroup {

    public static Set<DistributionModuleGroup> getModuleGroups() {
        Set<DistributionModuleGroup> hs = new HashSet<>();
        hs.add(new DistributionModuleGroup(CDP703Constant.HIVE_MODULE_GROUP.getModuleName()));
        ...
        hs.add(new DistributionModuleGroup(CDP703Constant.HIVE_HBASE_MODULE_GROUP.getModuleName(), false, hbaseLoaderCondition));
