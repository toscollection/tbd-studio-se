...
//
// ============================================================================
package org.talend.hadoop.distribution.emr5290.modulegroup.node.spark;
...
public class EMR5290SparkDynamoDBNodeModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups(String distribution, String version, String condition) {
        return ModuleGroupsUtils.getModuleGroups(distribution, version, condition,
                EMR5290Constant.SPARK_DYNAMODB_MRREQUIRED_MODULE_GROUP.getModuleName(), true);
    }
}
