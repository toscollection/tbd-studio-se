...
public class EMR5290MapReduceModuleGroup {
    ...
    public static Set<DistributionModuleGroup> getModuleGroups() {
        ...
        hs.add(new DistributionModuleGroup(EMR5290Constant.MAPREDUCE_PARQUET_MRREQUIRED_MODULE_GROUP.getModuleName(),
                true, null));
        hs.add(new DistributionModuleGroup(EMR5290Constant.MAPREDUCE_AVRO_MRREQUIRED_MODULE_GROUP.getModuleName(),
                true, null));
        return hs;
    }
}
