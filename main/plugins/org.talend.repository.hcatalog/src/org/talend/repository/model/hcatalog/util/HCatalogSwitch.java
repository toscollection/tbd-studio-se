...
public class HCatalogSwitch<T> {
     ...
     * @generated
     */
    protected static HCatalogPackage modelPackage;
     ...
     * @generated
     */
    public HCatalogSwitch() {
        if (modelPackage == null) {
            modelPackage = HCatalogPackage.eINSTANCE;
        }
    }
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case HCatalogPackage.HCATALOG_CONNECTION: {
                HCatalogConnection hCatalogConnection = (HCatalogConnection)theEObject;
                T result = caseHCatalogConnection(hCatalogConnection);
                if (result == null) result = caseHadoopSubConnection(hCatalogConnection);
                if (result == null) result = caseConnection(hCatalogConnection);
                if (result == null) result = caseAbstractMetadataObject(hCatalogConnection);
                if (result == null) result = caseDataProvider(hCatalogConnection);
                if (result == null) result = caseDataManager(hCatalogConnection);
                if (result == null) result = caseElement(hCatalogConnection);
                if (result == null) result = caseDeployedComponent(hCatalogConnection);
                if (result == null) result = casePackage(hCatalogConnection);
                if (result == null) result = caseNamespace(hCatalogConnection);
                if (result == null) result = caseModelElement(hCatalogConnection);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
            case HCatalogPackage.HCATALOG_CONNECTION_ITEM: {
                HCatalogConnectionItem hCatalogConnectionItem = (HCatalogConnectionItem)theEObject;
                T result = caseHCatalogConnectionItem(hCatalogConnectionItem);
                if (result == null) result = caseHadoopSubConnectionItem(hCatalogConnectionItem);
                if (result == null) result = caseConnectionItem(hCatalogConnectionItem);
                if (result == null) result = caseItem(hCatalogConnectionItem);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseHCatalogConnection(HCatalogConnection object) {
        return null;
    }
     ...
     * @generated
     */
    public T caseHCatalogConnectionItem(HCatalogConnectionItem object) {
        return null;
    }
