...
public enum EHCatalogRepositoryToComponent {
    ...
    WEBHCAT_HOST("WEBHCAT_HOST", "WEBHCAT_HOST"),

    WEBHCAT_PORT("WEBHCAT_PORT", "WEBHCAT_PORT"),

    WEBHCAT_USERNAME("WEBHCAT_USERNAME", "WEBHCAT_USERNAME"),

    STATUSDIR("STATUSDIR", "STATUSDIR"),

    HDINSIGHT_USERNAME("HDINSIGHT_USERNAME", "HDINSIGHT_USERNAME"),

    HDINSIGHT_PASSWORD("HDINSIGHT_PASSWORD", "HDINSIGHT_PASSWORD"),

    WASB_HOST("WASB_HOST", "WASB_HOST"),

    WASB_CONTAINER("WASB_CONTAINER", "WASB_CONTAINER"),

    WASB_USERNAME("WASB_USERNAME", "WASB_USERNAME"),

    WASB_PASSWORD("WASB_PASSWORD", "WASB_PASSWORD"),

    REMOTE_FOLDER("REMOTE_FOLDER", "REMOTE_FOLDER"),

    THRIFT_SERVER("THRIFT_SERVER", "THRIFT_SERVER");
