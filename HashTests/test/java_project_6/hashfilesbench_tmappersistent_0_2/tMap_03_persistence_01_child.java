...
/**
 * Job: tMap_03_persistence_01_child Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class tMap_03_persistence_01_child {
	...
	private static final String jobName = "tMap_03_persistence_01_child";
	...
	private class TalendException extends Exception {
		...
		private tMap_03_persistence_01_child c = null;

		private TalendException(tMap_03_persistence_01_child c, Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public void tFileInputDelimited_8Process() throws TalendException {
		try {
			...
			while (fsi_main.hasNext()) { // G_TM_M_250 loop "main"
				...
				rejectedInnerJoin_tMapPersistent_1_TMAP_IN = rsc_main.is__rejectedInnerJoin;
				...
				{ // start of Var scope
					...
					// # Output table : 'out'
					out_tmp.ID_MAIN = main.ID_MAIN + 1;
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tMap_03_persistence_01_child.class
					.getClassLoader()
					.getResourceAsStream(
							"java_project_8/tmap_03_persistence_01_child_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tMap_03_persistence_01_child.class.getClassLoader()
						.getResourceAsStream(
								"java_project_8/tmap_03_persistence_01_child_0_1/contexts/"
		...
		final tMap_03_persistence_01_child tMap_03_persistence_01_childClass = new tMap_03_persistence_01_child();
		try {
			errorCode = null;
			tMap_03_persistence_01_childClass.tFileInputDelimited_2Process();
			status = "end";
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : tMap_03_persistence_01_child");
		}
...
/*******************************************************************************
 * 87810 characters generated by Talend OpenStudio on the 23 avril 2008 18:24:27
 * CEST
 ******************************************************************************/
