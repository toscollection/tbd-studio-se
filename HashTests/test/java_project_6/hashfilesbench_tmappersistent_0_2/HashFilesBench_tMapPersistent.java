	...
	public void tFileInputDelimited_8Process() throws TalendException {
		try {
			...
			String fileName_tFileOutputDelimited_2 = (new java.io.File(
					"/home/amaumont/hash_benchs/out/result_" + context.nbItems
			...
			// org.talend.designer.components.commons.AdvancedMemoryLookup<lookupStruct>
			// tHash_Lookup_lookup =
			// (org.talend.designer.components.commons.AdvancedMemoryLookup<lookupStruct>)
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main> fsi_main = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main>(
					"/home/amaumont/data/dev/projets/Talend/hashfile/sort/data_main") {
			...
			org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited(
					"/home/amaumont/hash_benchs/in/files/big_file_main_"
			...
			while (fid_tFileInputDelimited_8.nextRecord()) {
				...
				if (main != null) {
					...
					Integer exprKey_lookup__ID_LOOKUP1 = main.ID_MAIN + 0;
	...
	public void tFileInputDelimited_9Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentSortedAdvancedLookup<lookupStruct> tHash_Lookup_lookup = new org.talend.designer.components.persistent.PersistentSortedAdvancedLookup<lookupStruct>(
					...
					"/home/amaumont/data/dev/projets/Talend/hashfile/testData/container/Lookup_lookup_") {
			...
			org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited(
					"/home/amaumont/hash_benchs/in/files/big_file_lookup_"
//							+ context.nbItems + "_id_label.csv", "ISO-8859-15",
							+ context.nbItems + "_id_label.csv", "ISO-8859-15",
					";", "\n", true, 0, 0, -1, -1);
			...
			while (fid_tFileInputDelimited_9.nextRecord() && count < 10000000) {
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = HashFilesBench_tMapPersistent.class
					.getClassLoader()
					.getResourceAsStream(
							"java_project_6/hashfilesbench_tmappersistent_0_2/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = HashFilesBench_tMapPersistent.class
						.getClassLoader().getResourceAsStream(
								"java_project_6/hashfilesbench_tmappersistent_0_2/contexts/"
...
/*******************************************************************************
 * 56800 characters generated by Talend OpenStudio on the 13 avril 2008 21:48:26
 * CEST
 ******************************************************************************/
