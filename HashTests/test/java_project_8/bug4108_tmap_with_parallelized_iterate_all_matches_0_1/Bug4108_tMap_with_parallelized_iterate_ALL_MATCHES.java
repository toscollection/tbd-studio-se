...
// ============================================================================
package java_project_8.bug4108_tmap_with_parallelized_iterate_all_matches_0_1;
...
/**
 * Job: Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES Purpose: <br>
 ...
 * @status
 */
public class Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES {
    ...
    private static final String jobName = "Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES";
    ...
    private class TalendException extends Exception {
        ...
        private Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES c = null;

        private TalendException(Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES c, Exception e) {
            this.e = e;
            this.c = c;
        }
                ...
                class tFileList_2Thread extends Thread {// implements
                    ...
                    class ThreadedMap extends java.util.HashMap<String, Object> {
                        ...
                        public Object put(String key, Object value) {
                            myMap.put(key, value);
                            return Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES.globalMap.put(key, value);
                        }
                    }
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            java.io.InputStream inContext = Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES.class.getClassLoader()
                    .getResourceAsStream(
                            "java_project_8/bug4108_tmap_with_parallelized_iterate_all_matches_0_1/contexts/Default.properties");
            if (inContext != null) {
            ...
            if (contextStr.compareTo("Default") != 0) {
                inContext = Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES.class.getClassLoader().getResourceAsStream(
                        "java_project_8/bug4108_tmap_with_parallelized_iterate_all_matches_0_1/contexts/" + contextStr
                                + ".properties");
                if (inContext != null) {
        ...
        final Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES Bug4108_tMap_with_parallelized_iterate_ALL_MATCHESClass = new Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES();

        try {
            errorCode = null;
            Bug4108_tMap_with_parallelized_iterate_ALL_MATCHESClass.tFileInputDelimited_2Process();
            status = "end";
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory)
                    + " bytes memory increase when running : Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES");
        }
...
/***********************************************************************************************************************
 * 134443 characters generated by Talend OpenStudio on the 10 juin 2008 11:03:02 CEST
 **********************************************************************************************************************/
