...
//
// ============================================================================ 
package java_project_8.tmap_08_persistence_01_n_lookups_mixed_persistent_child_0_1;
...
/**
 * Job: tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD Purpose: <br>
 * Description: All lookup types set with mixed persistent/memory mode. <br>
 * 
 * @author amaumont@talend.com
 * @version 2.2.0.qualifier
 * @status
 */
public class tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD {
    ...
    private static final String jobName = "tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD";
    ...
    private class TalendException extends Exception {
        ...
        private tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD c = null;

        private TalendException(
                tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD c,
                Exception e) {
            this.e = e;
            this.c = c;
        }
        ...
        public void readData(ObjectInputStream dis) {
            ...
            try {
                ...
                if (length == -1) {
                    ...
                    dis.readFully(commonByteArray, 0, length);
                    this.LABEL_LOOKUP_ALL_ROWS = new String(commonByteArray, 0,
                            length);
                }
                ...
                if (length == -1) {
                    ...
                    dis.readFully(commonByteArray, 0, length);
                    this.LABEL_LOOKUP_FIRST_MATCH = new String(commonByteArray,
                            0, length);
                }
                ...
                if (length == -1) {
                    ...
                    dis.readFully(commonByteArray, 0, length);
                    this.LABEL_LOOKUP_LAST_MATCH = new String(commonByteArray,
                            0, length);
                }
                ...
                if (length == -1) {
                    ...
                    dis.readFully(commonByteArray, 0, length);
                    this.LABEL_LOOKUP_ALL_MATCHES = new String(commonByteArray,
                            0, length);
                }
    ...
    public void tFileInputDelimited_8Process() throws TalendException {
        try {
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_ROWSStruct> tHash_Lookup_lookup_ALL_ROWS = (org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_ROWSStruct>) globalMap
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<LOOKUP_LAST_MATCHStruct> tHash_Lookup_LOOKUP_LAST_MATCH = (org.talend.designer.components.commons.AdvancedMemoryLookup<LOOKUP_LAST_MATCHStruct>) globalMap
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_MATCHESStruct> tHash_Lookup_lookup_ALL_MATCHES = (org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_MATCHESStruct>) globalMap
                ...
                public void readData(ObjectInputStream dis) {
                    ...
                    try {
                        ...
                        if (length == -1) {
                            ...
                            dis.readFully(
                                    lookup_ALL_ROWSStruct.commonByteArray, 0,
                                    length);
            ...
            org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS> fsi_main__lookup_ALL_ROWS = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS>(
                    context.data_output_dir + "/" + jobName
                            + "_tMapData_main__lookup_ALL_ROWS", 10000000) {
                ...
                public void readData(ObjectInputStream dis) {
                    ...
                    try {
                        ...
                        if (length == -1) {
                            ...
                            dis.readFully(
                                    LOOKUP_LAST_MATCHStruct.commonByteArray, 0,
                                    length);
                            this.main__LABEL_MAIN = new String(
                                    LOOKUP_LAST_MATCHStruct.commonByteArray, 0,
                                    length);
            ...
            while (fsi_main__lookup_ALL_ROWS.hasNext()) { // G_TM_M_250 loop
                ...
                if (!rejectedInnerJoin_tMap_1_TMAP_IN) { // G 20
                    ...
                    LOOKUP_LAST_MATCHHashKey.ID_LOOKUP_LAST_MATCH = main.ID_MAIN;

                    LOOKUP_LAST_MATCHHashKey.hashCodeDirty = true;
            ...
            while (fsi_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH
                ...
                if (!rejectedInnerJoin_tMap_1_TMAP_IN) { // G 20
                    ...
                    lookup_ALL_MATCHESHashKey.ID_LOOKUP_ALL_MATCHES = main.ID_MAIN;

                    lookup_ALL_MATCHESHashKey.hashCodeDirty = true;
    ...
    public void tFileInputDelimited_4Process() throws TalendException {
        try {
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_MATCHESStruct> tHash_Lookup_lookup_ALL_MATCHES = org.talend.designer.components.commons.AdvancedMemoryLookup
                    .<lookup_ALL_MATCHESStruct> getLookup(matchingModeEnum_lookup_ALL_MATCHES);
            ...
            while (fid_tFileInputDelimited_4.nextRecord()) {
                ...
                if (lookup_ALL_MATCHES != null) {
                    ...
                    lookup_ALL_MATCHESStruct lookup_ALL_MATCHES_HashRow = new lookup_ALL_MATCHESStruct();
    ...
    public void tFileInputDelimited_6Process() throws TalendException {
        try {
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<LOOKUP_LAST_MATCHStruct> tHash_Lookup_LOOKUP_LAST_MATCH = org.talend.designer.components.commons.AdvancedMemoryLookup
                    .<LOOKUP_LAST_MATCHStruct> getLookup(matchingModeEnum_LOOKUP_LAST_MATCH);
            ...
            while (fid_tFileInputDelimited_6.nextRecord()) {
                ...
                if (LOOKUP_LAST_MATCH != null) {
                    ...
                    LOOKUP_LAST_MATCHStruct LOOKUP_LAST_MATCH_HashRow = new LOOKUP_LAST_MATCHStruct();
    ...
    public void tFileInputDelimited_9Process() throws TalendException {
        try {
            ...
            org.talend.designer.components.commons.AdvancedMemoryLookup<lookup_ALL_ROWSStruct> tHash_Lookup_lookup_ALL_ROWS = org.talend.designer.components.commons.AdvancedMemoryLookup
                    .<lookup_ALL_ROWSStruct> getLookup(matchingModeEnum_lookup_ALL_ROWS);
            ...
            while (fid_tFileInputDelimited_9.nextRecord()) {
                ...
                if (lookup_ALL_ROWS != null) {
                    ...
                    lookup_ALL_ROWSStruct lookup_ALL_ROWS_HashRow = new lookup_ALL_ROWSStruct();
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            java.io.InputStream inContext = tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD.class
                    .getClassLoader()
                    .getResourceAsStream(
                            "java_project_8/tmap_08_persistence_01_n_lookups_mixed_persistent_child_0_1/contexts/Default.properties");
            if (inContext != null) {
            ...
            if (contextStr.compareTo("Default") != 0) {
                inContext = tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD.class
                        .getClassLoader()
                        .getResourceAsStream(
                                "java_project_8/tmap_08_persistence_01_n_lookups_mixed_persistent_child_0_1/contexts/"
        ...
        final tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD tMap_08_persistence_01_n_lookups_mixed_persistent_CHILDClass = new tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD();
        try {
            errorCode = null;
            tMap_08_persistence_01_n_lookups_mixed_persistent_CHILDClass
        ...
        if (false) {
            System.out
                    .println((endUsedMemory - startUsedMemory)
                            + " bytes memory increase when running : tMap_08_persistence_01_n_lookups_mixed_persistent_CHILD");
        }
...
/*******************************************************************************
 * 169955 characters generated by Talend OpenStudio on the 13 mai 2008 14:41:54
 * CEST
 ******************************************************************************/
