...
//
// ============================================================================
package java_project_8.bug4108_tmap_with_parallelized_iterate_all_rows_storeondisk_0_1;
...
/**
 * Job: Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk Purpose: <br>
 * Description: Tests the case where an iterate connection with parallel is set before tMap. tMap set with ALL ROWS join
 * and STORE ON DISK. <br>
 * 
 * @author amaumont@talend.com
 * @version 2.2.0.qualifier
 * @status
 */
public class Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk {
    ...
    private static final String jobName = "Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk";
    ...
    private class TalendException extends Exception {
        ...
        private Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk c = null;

        private TalendException(Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk c, Exception e) {
            this.e = e;
            this.c = c;
        }
            ...
            synchronized (commonByteArrayLock) {
                ...
                try {
                    ...
                    if (length == -1) {
                        ...
                        dis.readFully(commonByteArray, 0, length);
                        this.LABEL_LOOKUP1_1 = new String(commonByteArray, 0, length);
                    }
    ...
    public void tFileList_2Process() throws TalendException {
        ...
        try {
                ...
                class tFileList_2Thread extends Thread {// implements
                    ...
                    class ThreadedMap extends java.util.HashMap<String, Object> {
                        ...
                        public Object put(String key, Object value) {
                            myMap.put(key, value);
                            return Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.globalMap.put(key, value);
                        }
                    }
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            synchronized (Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.globalMap) {

                                currentThreadNumber_tMap_4 = (Integer) Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.globalMap
                                ...
                                Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.globalMap.put(
                                        "currentThreadNumber_tMap_4", currentThreadNumber_tMap_4);

                            }

                            org.talend.designer.components.persistent.PersistentLookupManager<lookupStruct> tHash_Lookup_lookup = (org.talend.designer.components.persistent.PersistentLookupManager<lookupStruct>) ((org.talend.designer.components.persistent.PersistentLookupManager<lookupStruct>) globalMap
                            ...
                            org.talend.designer.components.persistent.PersistentLookupManager<lookup2Struct> tHash_Lookup_lookup2 = (org.talend.designer.components.persistent.PersistentLookupManager<lookup2Struct>) ((org.talend.designer.components.persistent.PersistentLookupManager<lookup2Struct>) globalMap
                                        ...
                                        try {
                                            ...
                                            if (length == -1) {
                                                ...
                                                if (length > lookupStruct.commonByteArray.length) {
                                                    if (length < 1024 && lookupStruct.commonByteArray.length == 0) {
                                                        lookupStruct.commonByteArray = new byte[1024];
                                                    } else {
                                                        lookupStruct.commonByteArray = new byte[2 * length];
                                                    }
                                                }
                                                dis.readFully(lookupStruct.commonByteArray, 0, length);
                                                this.main__LABEL_MAIN = new String(lookupStruct.commonByteArray, 0, length);
                                            }
                                            ...
                                            if (length == -1) {
                                                ...
                                                dis.readFully(lookupStruct.commonByteArray, 0, length);
                                                this.lookup__LABEL_LOOKUP1 = new String(lookupStruct.commonByteArray, 0, length);
                                            }
                            ...
                            while (fid_tFileInputDelimited_8.nextRecord()) {
                                ...
                                if (main != null) {
                                    ...
                                    if (!rejectedInnerJoin_tMap_4) { // G_TM_M_020
                                        ...
                                        if (!tHash_Lookup_lookup.hasNext()) { // G_TM_M_090
                                    ...
                                    while (tHash_Lookup_lookup.hasNext() || forceLooplookup) { // G_TM_M_043
                                        ...
                                        } // close loop of lookup 'lookup2' //
                                        // G_TM_M_043

                                    } // close loop of lookup 'lookup' //
                                    // G_TM_M_043
            ...
            globalMap.put("tHash_Lookup_lookup2", null);
    ...
    static class lookup2Struct implements routines.system.IPersistableRow<lookup2Struct> {
    ...
    public void tFileInputDelimited_5Process() throws TalendException {
        ...
        try {
            ...
            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup2 = org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.ALL_ROWS;

            org.talend.designer.components.persistent.PersistentLookupManager<lookup2Struct> tHash_Lookup_lookup2 = new org.talend.designer.components.persistent.PersistentLookupManager<lookup2Struct>(
    ...
    static class lookupStruct implements routines.system.IPersistableRow<lookupStruct> {
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            java.io.InputStream inContext = Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.class
                    .getClassLoader()
                    .getResourceAsStream(
                            "java_project_8/bug4108_tmap_with_parallelized_iterate_all_rows_storeondisk_0_1/contexts/Default.properties");
            if (inContext != null) {
            ...
            if (contextStr.compareTo("Default") != 0) {
                inContext = Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk.class.getClassLoader()
                        .getResourceAsStream(
                                "java_project_8/bug4108_tmap_with_parallelized_iterate_all_rows_storeondisk_0_1/contexts/"
        ...
        final Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDiskClass = new Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk();

        try {
            errorCode = null;
            Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDiskClass.tFileInputDelimited_2Process();
            status = "end";
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory)
                    + " bytes memory increase when running : Bug4108_tMap_with_parallelized_iterate_ALL_ROWS_storeOnDisk");
        }
...
/***********************************************************************************************************************
 * 159301 characters generated by Talend OpenStudio on the 11 juin 2008 12:06:37 CEST
 **********************************************************************************************************************/
