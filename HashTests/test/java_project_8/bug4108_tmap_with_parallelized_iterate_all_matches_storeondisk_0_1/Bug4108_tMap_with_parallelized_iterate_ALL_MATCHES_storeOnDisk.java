...
//
// ============================================================================
package java_project_8.bug4108_tmap_with_parallelized_iterate_all_matches_storeondisk_0_1;
...
/**
 * Job: Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk Purpose: <br>
 * Description: Tests the case where an iterate connection with parallel is set before tMap. tMap set with ALL MATCHES
...
public class Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk {
    ...
    private class TalendException extends Exception {
        ...
        private TalendException(Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk c, Exception e) {
            this.e = e;
            this.c = c;
        }
    ...
    public void tAdvancedHash_row4_error(Exception exception) throws TalendException {
                ...
                class tFileList_2Thread extends Thread {// implements
                    ...
                    class ThreadedMap extends java.util.HashMap<String, Object> {
                        ...
                        public Object put(String key, Object value) {
                            myMap.put(key, value);
                            return Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk.globalMap.put(key, value);
                        }
                    }
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            synchronized (Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk.globalMap) {
                                ...
                                Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk.globalMap.put(
                            ...
                            class SortableRow_main__lookup implements Comparable<SortableRow_main__lookup>,
                                ...
                                public void fillFrom(mainStruct main, lookupStruct lookup, int exprKey_row4__ID_LOOKUP1) {
                                ...
                                public int compareTo(SortableRow_main__lookup other) {
                                    ...
                                    returnValue = checkNullsAndCompare(this.exprKey_row4__ID_LOOKUP1,
                                ...
                                public void readData(ObjectInputStream dis) {
                                    ...
                                    try {
                                        ...
                                        this.exprKey_row4__ID_LOOKUP1 = dis.readInt();
                                ...
                                public void writeData(ObjectOutputStream dos) {
                                    try {
                                        ...
                                        dos.writeInt(this.exprKey_row4__ID_LOOKUP1);
                            ...
                            synchronized (Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk.globalMap) {
                                ...
                                while (fsi_main.hasNext()) { // G_TM_M_250 loop
                                    ...
                                    while (tHash_Lookup_lookup.hasNext() || forceLooplookup) { // G_TM_M_043
                                        ...
                                        rsc_main__lookup.fillFrom(main, lookup, exprKey_row4__ID_LOOKUP1);
                                ...
                                while (fsi_main__lookup.hasNext()) { // G_TM_M_250
                                    ...
                                    if (!rejectedInnerJoin_tMap_4_TMAP_IN) { // G 20
                                        ...
                                        if (hasCasePrimitiveKeyWithNull_tMap_4_TMAP_IN || !tHash_Lookup_row4.hasNext()) { // G
                                            // 090
                                    ...
                                    while (tHash_Lookup_row4.hasNext() || forceLooprow4) { // G_TM_M_043
    ...
    static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public void tFileInputDelimited_5Process() throws TalendException {
        ...
        try {
            ...
            org.talend.designer.components.persistent.PersistentSortedLookupManager<row4Struct> tHash_Lookup_row4 = new org.talend.designer.components.persistent.PersistentSortedLookupManager<row4Struct>(
                    matchingModeEnum_row4, context.data_output_dir + "/" + jobName + "_tMapData_Lookup_row4_",
            ...
            while (fid_tFileInputDelimited_5.nextRecord()) {
                ...
                try {
                    ...
                    if (temp_tFileInputDelimited_5.length() > 0) {
                        row4.ID_LOOKUP1 = ParserUtils.parseTo_int(temp_tFileInputDelimited_5);
                    } else {
                    ...
                    row4.LABEL_LOOKUP1 = fid_tFileInputDelimited_5.get(1).trim();
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            ...
            if (contextStr.compareTo("Default") != 0) {
                inContext = Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDisk.class.getClassLoader()
                        .getResourceAsStream(
        ...
        try {
            errorCode = null;
            Bug4108_tMap_with_parallelized_iterate_ALL_MATCHES_storeOnDiskClass.tFileInputDelimited_2Process();
            status = "end";
...
/***********************************************************************************************************************
 * 169121 characters generated by Talend OpenStudio on the 10 juin 2008 21:55:07 CEST
 **********************************************************************************************************************/
