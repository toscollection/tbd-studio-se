...
//
// ============================================================================
package java_project_8.bug4108_tmap_with_parallelized_iterate_last_match_storeondisk_0_1;
...
/**
 * Job: Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk Purpose: <br>
 * Description: Tests the case where an iterate connection with parallel is set before tMap. tMap set with LAST MATCH
 * join and STORE ON DISK. <br>
 * 
 * @author amaumont@talend.com
 * @version 2.2.0.qualifier
 * @status
 */
public class Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk {
    ...
    private static final String jobName = "Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk";
    ...
    private static final java.util.Map<String, Object> globalMap =
    // Collections.synchronizedMap(new java.util.HashMap<String, Object>());
    ...
    private class TalendException extends Exception {
        ...
        private Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk c = null;

        private TalendException(Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk c, Exception e) {
            this.e = e;
            this.c = c;
        }
            ...
            synchronized (commonByteArrayLock) {
                ...
                try {
                    ...
                    if (length == -1) {
                        ...
                        if (length > myByteArray.length) {
                            if (length < 1024 && myByteArray.length == 0) {
                                myByteArray = new byte[1024];
                            } else {
                                myByteArray = new byte[2 * length];
                            }
                        }
                        dis.readFully(myByteArray, 0, length);
                        this.LABEL_MAIN = new String(myByteArray, 0, length);
                    }
                    ...
                    if (length == -1) {
                        ...
                        dis.readFully(myByteArray, 0, length);
                        this.LABEL_LOOKUP1 = new String(myByteArray, 0, length);
                    }
                    ...
                    if (length == -1) {
                        ...
                        dis.readFully(myByteArray, 0, length);
                        this.LABEL_LOOKUP1_1 = new String(myByteArray, 0, length);
                    }
            ...
            for (int i_tFileList_2 = 0; i_tFileList_2 < list_tFileList_2.size(); i_tFileList_2++) {
                ...
                class tFileList_2Thread extends Thread {// implements
                    ...
                    class ThreadedMap extends java.util.HashMap<String, Object> {
                        ...
                        java.util.Map<String, Object> myMap =
                        // Collections.synchronizedMap(new java.util.HashMap<String, Object>());
                        new java.util.HashMap<String, Object>();
                        ...
                        public synchronized Object put(String key, Object value) {
                            myMap.put(key, value);
                            return Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.globalMap.put(key, value);
                        }
                    }
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            synchronized (Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.globalMap) {

                                currentThreadNumber_tMap_4 = (Integer) Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.globalMap
                                ...
                                Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.globalMap.put(
                                        "currentThreadNumber_tMap_4", currentThreadNumber_tMap_4);
                            ...
                            class SortableRow_main implements Comparable<SortableRow_main>,
                                ...
                                public void fillFrom(mainStruct main, int exprKey_lookup__ID_LOOKUP1) {
                                ...
                                public void readData(ObjectInputStream dis) {
                                    ...
                                    try {
                                        ...
                                        if (length == -1) {
                                            ...
                                            dis.readFully(myByteArray, 0, length);
                                            this.main__LABEL_MAIN = new String(myByteArray, 0, length);
                                        }
                            ...
                            org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main> fsi_main = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main>(
                                    context.data_output_dir + "/" + jobName + "_tMapData_thread" + currentThreadNumber_tMap_4
                                            + "_main", 10000000) {
                            ...
                            class SortableRow_main__lookup implements Comparable<SortableRow_main__lookup>,
                                    routines.system.IPersistableRow<SortableRow_main__lookup> { // G_TM_B_001

                                boolean is__rejectedInnerJoin;

                                int exprKey_lookup2__ID_LOOKUP1;
                                ...
                                public void fillFrom(mainStruct main, lookupStruct lookup, int exprKey_lookup2__ID_LOOKUP1) {

                                    this.main__ID_MAIN = main.ID_MAIN;
                                    this.main__LABEL_MAIN = main.LABEL_MAIN;
                                    this.lookup__ID_LOOKUP1 = lookup.ID_LOOKUP1;
                                    this.lookup__LABEL_LOOKUP1 = lookup.LABEL_LOOKUP1;
                                    this.exprKey_lookup2__ID_LOOKUP1 = exprKey_lookup2__ID_LOOKUP1;
                                ...
                                public int compareTo(SortableRow_main__lookup other) {
                                    ...
                                    returnValue = checkNullsAndCompare(this.exprKey_lookup2__ID_LOOKUP1,
                                            other.exprKey_lookup2__ID_LOOKUP1);
                                    if (returnValue != 0) {
                                        return returnValue;
                                    }
                                ...
                                public void readData(ObjectInputStream dis) {
                                    ...
                                    synchronized (lookupStruct.commonByteArrayLock) {
                                        ...
                                        try {
                                            ...
                                            if (length == -1) {
                                                ...
                                                dis.readFully(myByteArray, 0, length);
                                                this.lookup__LABEL_LOOKUP1 = new String(myByteArray, 0, length);
                                            }

                                            this.exprKey_lookup2__ID_LOOKUP1 = dis.readInt();
                                ...
                                public void writeData(ObjectOutputStream dos) {
                                    try {
                                        ...
                                        if (this.lookup__LABEL_LOOKUP1 == null) {
                                            ...
                                            byte[] byteArray = this.lookup__LABEL_LOOKUP1.getBytes();
                                            dos.writeInt(byteArray.length);
                                            dos.write(byteArray);
                                        }

                                        dos.writeInt(this.exprKey_lookup2__ID_LOOKUP1);
                            ...
                            synchronized (new Object()) {
                                ...
                                while (fsi_main.hasNext()) { // G_TM_M_250 loop
                                    ...
                                    if (!rejectedInnerJoin_tMap_4_TMAP_IN) { // G 20
                                        ...
                                        if (hasCasePrimitiveKeyWithNull_tMap_4_TMAP_IN || !tHash_Lookup_lookup.hasNext()) { // G
                                            // 090
                                    ...
                                    int exprKey_lookup2__ID_LOOKUP1 = 0;

                                    if (!rejectedInnerJoin_tMap_4_TMAP_IN) { // G_TM_M_255

                                        Object exprKeyValue_lookup2__ID_LOOKUP1 = lookup.ID_LOOKUP1;
                                        if (exprKeyValue_lookup2__ID_LOOKUP1 == null) {
                                            hasCasePrimitiveKeyWithNull_tMap_4_TMAP_IN = true;
                                        } else {
                                            exprKey_lookup2__ID_LOOKUP1 = (int) (Integer) exprKeyValue_lookup2__ID_LOOKUP1;
                                        }
                                    ...
                                    rsc_main__lookup.fillFrom(main, lookup, exprKey_lookup2__ID_LOOKUP1);
                            ...
                            System.out.println(fsi_main__lookup.toString());
                            ...
                            synchronized (new Object()) {
                                ...
                                while (fsi_main__lookup.hasNext()) { // G_TM_M_250
                                    ...
                                    rsc_main__lookup = (SortableRow_main__lookup) fsi_main__lookup.next();
                                    ...
                                    if (!rejectedInnerJoin_tMap_4_TMAP_IN) { // G 20
                                        ...
                                        if (exprKeyValue_lookup2__ID_LOOKUP1 == null) {
                                            ...
                                            lookup2HashKey.ID_LOOKUP1 = (int) (Integer) rsc_main__lookup.exprKey_lookup2__ID_LOOKUP1;
                                        }
                                        ...
                                        if (hasCasePrimitiveKeyWithNull_tMap_4_TMAP_IN || !tHash_Lookup_lookup2.hasNext()) { // G
                                            // 090
                                    ...
                                    if (tHash_Lookup_lookup2.hasNext()) { // G 099
                                    ...
                                    // { // Dummy bracket to open block for "main"
                                    // ##(1)##
                                    ...
                                    { // start of Var scope
                                        ...
                                        out_tmp.ID_LOOKUP1_1 = lookup2.ID_LOOKUP1;
                                        out_tmp.LABEL_LOOKUP1_1 = lookup2.LABEL_LOOKUP1;
                                        out = out_tmp;
                                        // ###############################
    ...
    public void tFileInputDelimited_5Process() throws TalendException {
        ...
        try {
            ...
            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup2 = org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.LAST_MATCH;
            ...
            org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited(
                    context.getProperty("data_dir") + context.getProperty("current_job_dir") + "in/lookup_2.csv", "ISO-8859-15",
                    ";", "\n", true, 0, 0, -1, -1, false);
            while (fid_tFileInputDelimited_5.nextRecord()) {
                ...
                try {
                    ...
                    if (temp_tFileInputDelimited_5.length() > 0) {
                        lookup2.ID_LOOKUP1 = ParserUtils.parseTo_int(temp_tFileInputDelimited_5);
                    } else {
                        throw new RuntimeException(
                                "Value is empty for column : 'ID_LOOKUP1' in 'lookup2' connection, value is invalid or this column should be nullable or have a default value.");
                    }
                    lookup2.LABEL_LOOKUP1 = fid_tFileInputDelimited_5.get(1).trim();
                ...
                if (lookup2 != null) {
                    ...
                    lookup2_HashRow.ID_LOOKUP1 = lookup2.ID_LOOKUP1;
                    lookup2_HashRow.LABEL_LOOKUP1 = lookup2.LABEL_LOOKUP1;
    ...
    public void tFileInputDelimited_9Process() throws TalendException {
        ...
        try {
            ...
            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookupStruct> tHash_Lookup_lookup = new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookupStruct>(
                    matchingModeEnum_lookup, context.data_output_dir + "/" + jobName + "_tMapData_Lookup_lookup_",
                    new org.talend.designer.components.persistent.IRowCreator() {
            ...
            org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited(
                    context.getProperty("data_dir") + context.getProperty("current_job_dir") + "in/lookup_1.csv", "ISO-8859-15",
                    ";", "\n", true, 0, 0, -1, -1, false);
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            java.io.InputStream inContext = Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.class
                    .getClassLoader()
                    .getResourceAsStream(
                            "java_project_8/bug4108_tmap_with_parallelized_iterate_last_match_storeondisk_0_1/contexts/Default.properties");
            if (inContext != null) {
            ...
            if (contextStr.compareTo("Default") != 0) {
                inContext = Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk.class.getClassLoader()
                        .getResourceAsStream(
                                "java_project_8/bug4108_tmap_with_parallelized_iterate_last_match_storeondisk_0_1/contexts/"
        ...
        final Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDiskClass = new Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk();

        try {
            errorCode = null;
            Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDiskClass.tFileInputDelimited_2Process();
            status = "end";
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory)
                    + " bytes memory increase when running : Bug4108_tMap_with_parallelized_iterate_LAST_MATCH_storeOnDisk");
        }
...
/***********************************************************************************************************************
 * 169593 characters generated by Talend OpenStudio on the 10 juin 2008 23:04:17 CEST
 **********************************************************************************************************************/
