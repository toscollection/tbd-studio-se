...
//============================================================================ 
package java_project_8.tmap_04_persistence_02_n_lookups_child_0_1;
...
/**
 * Job: tMap_04_persistence_02_n_lookups_CHILD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */                                
public class tMap_04_persistence_02_n_lookups_CHILD {    
    ...
    private static final String jobName = "tMap_04_persistence_02_n_lookups_CHILD";
    ...
    private class TalendException extends Exception {
        ...
        private tMap_04_persistence_02_n_lookups_CHILD c = null;
        private TalendException(tMap_04_persistence_02_n_lookups_CHILD c, Exception e) {
            this.e = e;
            this.c = c;
        }
    ...
    public void tFixedFlowInput_1_error(Exception exception) throws TalendException {
        end_Hash.put("tFixedFlowInput_1", System.currentTimeMillis());
        tJavaFlex_4_onSubJobError(exception);
    }
    public void tBufferOutput_1_error(Exception exception) throws TalendException {
    ...
    public void tFileInputDelimited_6_error(Exception exception) throws TalendException {
        end_Hash.put("tFileInputDelimited_6", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tFileInputDelimited_7_error(Exception exception) throws TalendException {
    ...
    public void tAdvancedHashPersistent_lookup_ALL_MATCHES_error(Exception exception) throws TalendException {
        end_Hash.put("tAdvancedHashPersistent_lookup_ALL_MATCHES", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tAdvancedHashPersistent_lookup_FIRST_MATCH_error(Exception exception) throws TalendException {
        end_Hash.put("tAdvancedHashPersistent_lookup_FIRST_MATCH", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tAdvancedHashPersistent_lookup_LAST_MATCH_error(Exception exception) throws TalendException {
        end_Hash.put("tAdvancedHashPersistent_lookup_LAST_MATCH", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tAdvancedHashPersistent_lookup_UNIQUE_MATCH_error(Exception exception) throws TalendException {
        end_Hash.put("tAdvancedHashPersistent_lookup_UNIQUE_MATCH", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tAdvancedHashPersistent_lookup_ALL_ROWS_error(Exception exception) throws TalendException {
        end_Hash.put("tAdvancedHashPersistent_lookup_ALL_ROWS", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tMapPersistent_1_TMAP_OUT_error(Exception exception) throws TalendException {
        end_Hash.put("tMapPersistent_1_TMAP_OUT", System.currentTimeMillis());
        tFileInputDelimited_8_onSubJobError(exception);
    }
    public void tMapPersistent_1_TMAP_IN_error(Exception exception) throws TalendException {
    ...
    public void tJavaFlex_4_onSubJobError(Exception exception) throws TalendException {
    }


    private class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    ...
    public void tFileInputDelimited_2Process() throws TalendException {             
        try {
            ...
            com.csvreader.CsvReader csvReadertFileInputDelimited_2=new com.csvreader.CsvReader(new java.io.BufferedReader(new java.io.InputStreamReader(
            ...
            if(footer_tFileInputDelimited_2 > 0){
                ...
                csvReadertFileInputDelimited_2=new com.csvreader.CsvReader(new java.io.BufferedReader(new java.io.InputStreamReader(
                        new java.io.FileInputStream(/**
                         * Start field
                         * tFileInputDelimited_2:FILENAME
                         */context.param_file_path/**
...
//              Start of branch "row6"
                if(row6 != null) { 
                    ...
                    if (context.getProperty(key_tContextLoad_1)!=null)
                    {
                        ...
                        if(key_tContextLoad_1!=null && "indexMain".equals(key_tContextLoad_1))
                        {                
                            context.indexMain=value_tContextLoad_1;             
                        }

                        if(key_tContextLoad_1!=null && "indexLookup".equals(key_tContextLoad_1))
                        {                
...
//          loop
//          System.out.println("Testing with files 'main_" + context.indexMain + ".csv'
//          and 'lookup_" + context.indexLookup +".csv' ...");
...
//          end of the component, outside/closing the loop
    ...
    private class after_tFileInputDelimited_8Struct implements routines.system.IPersistableRow<after_tFileInputDelimited_8Struct> {
    ...
    public void tFileInputDelimited_8Process() throws TalendException {             
        try {
            ...
            start_Hash.put("tMapPersistent_1_TMAP_OUT", System.currentTimeMillis());
...
//          # Lookup's keys initialization
            ...
            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct> tHash_Lookup_lookup_FIRST_MATCH = (org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct>) globalMap.get( "tHash_Lookup_lookup_FIRST_MATCH" );
            ...
            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_LAST_MATCHStruct> tHash_Lookup_lookup_LAST_MATCH = (org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_LAST_MATCHStruct>) globalMap.get( "tHash_Lookup_lookup_LAST_MATCH" );
            ...
            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MATCHStruct> tHash_Lookup_lookup_UNIQUE_MATCH = (org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MATCHStruct>) globalMap.get( "tHash_Lookup_lookup_UNIQUE_MATCH" );


            lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCHHashKey = new lookup_UNIQUE_MATCHStruct();
            lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCHDefault = new lookup_UNIQUE_MATCHStruct();

            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct> tHash_Lookup_lookup_ALL_MATCHES = (org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct>) globalMap.get( "tHash_Lookup_lookup_ALL_MATCHES" );
            ...
            org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct> tHash_Lookup_lookup_ALL_ROWS = (org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct>) globalMap.get( "tHash_Lookup_lookup_ALL_ROWS" );
...
//          ###############################
            ...
            class SortableRow_main implements Comparable<SortableRow_main>, routines.system.IPersistableRow<SortableRow_main> { // G_TM_B_001
                ...
                // main
                Integer main__ID_MAIN;String main__LABEL_MAIN;



                public void fillFrom( mainStruct main,  Integer exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH) {
                ...
                public int compareTo(SortableRow_main other) {
                    ...
                    returnValue = checkNullsAndCompare(this.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH, other.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH);
                    if (returnValue != 0) {
                        return returnValue;
                    }
                ...
                public void loadData(byte[] data) {
                    ...
                    try {
                        ...
                        if (length == -1) {
                            ...
                            this.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH = dis.readInt();
                        }
                ...
                public byte[] toData() {
                    ...
                    try {
                        ...
                        if(this.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH == null) {
                            ...
                            dos.writeByte(0);
                            dos.writeInt(this.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH);
                        }
            ...
            org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main> fsi_main = 
                new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main>(
                        "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/tMapData_main") {
                ...
                class SortableRow_main__lookup_FIRST_MATCH implements Comparable<SortableRow_main__lookup_FIRST_MATCH>, routines.system.IPersistableRow<SortableRow_main__lookup_FIRST_MATCH> { // G_TM_B_001
                    ...
                    // lookup_FIRST_MATCH
                    Integer main__ID_MAIN;String main__LABEL_MAIN;Integer lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH;String lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH;



                    public void fillFrom( mainStruct main,  lookup_FIRST_MATCHStruct lookup_FIRST_MATCH,  Integer exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH) {
                    ...
                    public void copyDataTo(mainStruct main, lookup_FIRST_MATCHStruct lookup_FIRST_MATCH) {
                    ...
                    public String toString() {
                        ...
                        sb.append("=");
                        sb.append(String.valueOf(this.lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH));

                        sb.append(", ");

                        sb.append("lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH");
                        sb.append("=");
                        sb.append(String.valueOf(this.lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH));
                    ...
                    public int compareTo(SortableRow_main__lookup_FIRST_MATCH other) {

                        int returnValue = 0;


                        returnValue = checkNullsAndCompare(this.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH, other.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH);
                        if (returnValue != 0) {
                            return returnValue;
                        }
                    ...
                    public void loadData(byte[] data) {
                        ...
                        try {
                            ...
                            if (length == -1) {
                                ...
                                this.lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH = dis.readInt();
                            }
                            ...
                            if (length == -1) {
                                ...
                                byteArray = new byte[length];
                                dis.read(byteArray);
                                this.lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH = new String(byteArray);
                            }
                            ...
                            if (length == -1) {
                                ...
                                this.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH = dis.readInt();
                            }
                    ...
                    public byte[] toData() {
                        ...
                        try {
                            ...
                            if(this.lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH == null) {
                                ...
                                dos.writeByte(0);
                                dos.writeInt(this.lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH);
                            }

                            if(this.lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH == null) {
                                dos.writeInt(-1);
                            } else {
                                byteArray = this.lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH.getBytes();
                                dos.writeInt(byteArray.length);
                                dos.write(byteArray);
                            }
                            ...
                            if(this.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH == null) {
                                ...
                                dos.writeByte(0);
                                dos.writeInt(this.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH);
                            }
                ...
                org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH> fsi_main__lookup_FIRST_MATCH = 
                    new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH>(
                            "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/tMapData_main__lookup_FIRST_MATCH") {
                        public SortableRow_main__lookup_FIRST_MATCH createRowInstance() {
                            return new SortableRow_main__lookup_FIRST_MATCH();
                        }
                    };

                    fsi_main__lookup_FIRST_MATCH.initPut();




                    class SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH implements Comparable<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH>, routines.system.IPersistableRow<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH> { // G_TM_B_001

                        boolean is__rejectedInnerJoin;

                        Integer exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;

                        // lookup_LAST_MATCH
                        Integer main__ID_MAIN;String main__LABEL_MAIN;Integer lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH;String lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH;Integer lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH;String lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH;



                        public void fillFrom( mainStruct main,  lookup_FIRST_MATCHStruct lookup_FIRST_MATCH,  lookup_LAST_MATCHStruct lookup_LAST_MATCH,  Integer exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH) {
                            ...
                            this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;

                        }

                        public void copyDataTo(mainStruct main, lookup_FIRST_MATCHStruct lookup_FIRST_MATCH, lookup_LAST_MATCHStruct lookup_LAST_MATCH) {
                        ...
                        public String toString() {
                            ...
                            sb.append("=");
                            sb.append(String.valueOf(this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH));

                            sb.append(", ");

                            sb.append("lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH");
                            sb.append("=");
                            sb.append(String.valueOf(this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH));
                        ...
                        public int compareTo(SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH other) {

                            int returnValue = 0;


                            returnValue = checkNullsAndCompare(this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH, other.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH);
                            if (returnValue != 0) {
                                return returnValue;
                            }
                        ...
                        public void loadData(byte[] data) {
                            ...
                            try {
                                ...
                                if (length == -1) {
                                    ...
                                    this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH = dis.readInt();
                                }
                                ...
                                if (length == -1) {
                                    ...
                                    byteArray = new byte[length];
                                    dis.read(byteArray);
                                    this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH = new String(byteArray);
                                }

                                length = dis.readByte();
                                if (length == -1) {
                                    this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = null;
                                } else {
                                    this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = dis.readInt();
                                }
                        ...
                        public byte[] toData() {
                            ...
                            try {
                                ...
                                if(this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH == null) {
                                    ...
                                    dos.writeByte(0);
                                    dos.writeInt(this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH);
                                }

                                if(this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH == null) {
                                    dos.writeInt(-1);
                                } else {
                                    byteArray = this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH.getBytes();
                                    dos.writeInt(byteArray.length);
                                    dos.write(byteArray);
                                }

                                if(this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH == null) {
                                    dos.writeByte(-1);
                                } else {
                                    dos.writeByte(0);
                                    dos.writeInt(this.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH);
                                }
                    ...
                    org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH> fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH = 
                        new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH>(
                                "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/tMapData_main__lookup_FIRST_MATCH__lookup_LAST_MATCH") {
                            public SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH createRowInstance() {
                                return new SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH();
                            }
                        };

                        fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.initPut();




                        class SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH implements Comparable<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH>, routines.system.IPersistableRow<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH> { // G_TM_B_001
                            ...
                            // lookup_UNIQUE_MATCH
                            Integer main__ID_MAIN;String main__LABEL_MAIN;Integer lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH;String lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH;Integer lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH;String lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH;Integer lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;String lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH;



                            public void fillFrom( mainStruct main,  lookup_FIRST_MATCHStruct lookup_FIRST_MATCH,  lookup_LAST_MATCHStruct lookup_LAST_MATCH,  lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH,  Integer exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES) {
                                ...
                                this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH = lookup_LAST_MATCH.ID_LOOKUP_LAST_MATCH;
                                this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH = lookup_LAST_MATCH.LABEL_LOOKUP_LAST_MATCH;
                                this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH;
                                this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.LABEL_LOOKUP_UNIQUE_MATCH;
                                this.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES = exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES;

                            }

                            public void copyDataTo(mainStruct main, lookup_FIRST_MATCHStruct lookup_FIRST_MATCH, lookup_LAST_MATCHStruct lookup_LAST_MATCH, lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH) {
                                ...
                                lookup_LAST_MATCH.ID_LOOKUP_LAST_MATCH = this.lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH;
                                lookup_LAST_MATCH.LABEL_LOOKUP_LAST_MATCH = this.lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH;
                                lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH = this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;
                                lookup_UNIQUE_MATCH.LABEL_LOOKUP_UNIQUE_MATCH = this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH;
                            ...
                            public String toString() {
                                ...
                                sb.append("lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH");
                                sb.append("=");
                                sb.append(String.valueOf(this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH));

                                sb.append(", ");

                                sb.append("lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH");
                                sb.append("=");
                                sb.append(String.valueOf(this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH));
                            ...
                            public int compareTo(SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH other) {

                                int returnValue = 0;


                                returnValue = checkNullsAndCompare(this.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES, other.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES);
                                if (returnValue != 0) {
                                    return returnValue;
                                }
                            ...
                            public void loadData(byte[] data) {
                                ...
                                try {
                                    ...
                                    length = dis.readByte();
                                    if (length == -1) {
                                        this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = null;
                                    } else {
                                        this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = dis.readInt();
                                    }

                                    length = dis.readInt();
                                    if (length == -1) {
                                        this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH = null;
                                    } else {
                                        byteArray = new byte[length];
                                        dis.read(byteArray);
                                        this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH = new String(byteArray);
                                    }
                                    ...
                                    if (length == -1) {
                                        ...
                                        this.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES = dis.readInt();
                                    }
                            ...
                            public byte[] toData() {
                                ...
                                try {
                                    ...
                                    if(this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH == null) {
                                        dos.writeByte(-1);
                                    } else {
                                        dos.writeByte(0);
                                        dos.writeInt(this.lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH);
                                    }

                                    if(this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH == null) {
                                        dos.writeInt(-1);
                                    } else {
                                        byteArray = this.lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH.getBytes();
                                        dos.writeInt(byteArray.length);
                                        dos.write(byteArray);
                                    }
                                    ...
                                    if(this.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES == null) {
                                        ...
                                        dos.writeByte(0);
                                        dos.writeInt(this.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES);
                                    }
                        ...
                        org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH> fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH = 
                            new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH>(
                                    "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/tMapData_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH") {
                                public SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH createRowInstance() {
                                    return new SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH();
                                }
                            };

                            fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.initPut();




                            class SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES implements Comparable<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES>, routines.system.IPersistableRow<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES> { // G_TM_B_001

                                boolean is__rejectedInnerJoin;


                                // lookup_ALL_MATCHES
                                Integer main__ID_MAIN;String main__LABEL_MAIN;Integer lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH;String lookup_FIRST_MATCH__LABEL_LOOKUP_FIRST_MATCH;Integer lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH;String lookup_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH;Integer lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;String lookup_UNIQUE_MATCH__LABEL_LOOKUP_UNIQUE_MATCH;Integer lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES;String lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES;



                                public void fillFrom( mainStruct main,  lookup_FIRST_MATCHStruct lookup_FIRST_MATCH,  lookup_LAST_MATCHStruct lookup_LAST_MATCH,  lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH,  lookup_ALL_MATCHESStruct lookup_ALL_MATCHES) {
                                ...
                                public void copyDataTo(mainStruct main, lookup_FIRST_MATCHStruct lookup_FIRST_MATCH, lookup_LAST_MATCHStruct lookup_LAST_MATCH, lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH, lookup_ALL_MATCHESStruct lookup_ALL_MATCHES) {
                                ...
                                public String toString() {
                                    ...
                                    sb.append("=");
                                    sb.append(String.valueOf(this.lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES));

                                    sb.append(", ");

                                    sb.append("lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES");
                                    sb.append("=");
                                    sb.append(String.valueOf(this.lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES));
                                ...
                                public int compareTo(SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES other) {
                                ...
                                public void loadData(byte[] data) {
                                    ...
                                    try {
                                        ...
                                        if (length == -1) {
                                            ...
                                            this.lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES = dis.readInt();
                                        }
                                        ...
                                        if (length == -1) {
                                            ...
                                            byteArray = new byte[length];
                                            dis.read(byteArray);
                                            this.lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES = new String(byteArray);
                                        }
                                ...
                                public byte[] toData() {
                                    ...
                                    try {
                                        ...
                                        if(this.lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES == null) {
                                            ...
                                            dos.writeByte(0);
                                            dos.writeInt(this.lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES);
                                        }

                                        if(this.lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES == null) {
                                            dos.writeInt(-1);
                                        } else {
                                            byteArray = this.lookup_ALL_MATCHES__LABEL_LOOKUP_ALL_MATCHES.getBytes();
                                            dos.writeInt(byteArray.length);
                                            dos.write(byteArray);
                                        }
                            ...
                            org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES> fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES = 
                                new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES>(
                                        "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/tMapData_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES") {
                                    public SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES createRowInstance() {
                                        return new SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES();
                                    }
                                };

                                fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES.initPut();
                                ...
                                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_8 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/main_" + context.indexMain +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                                while (fid_tFileInputDelimited_8.nextRecord()) {
                                    ...
                                    try {
                                        ...
                                        if(temp_tFileInputDelimited_8.length() > 0) {main.ID_MAIN = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_8);} else {                        main.ID_MAIN = null;}
...
//                                  Start of branch "main"
                                    if(main != null) { 
                                        ...
                                        Integer exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH = main.ID_MAIN ;


                                        SortableRow_main rsc_main = fsi_main.getNextFreeRow();

                                        rsc_main.fillFrom(main, exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH);
...
//                              ###############################
                                ...
                                String fileName_tFileOutputDelimited_2 = (new java.io.File(context.data_output_dir + context.current_job_dir + "out_main_" + context.indexMain +"__lookup_" + context.indexLookup +".csv")).getAbsolutePath().replace("\\","/");
                                ...
                                start_Hash.put("tMapPersistent_1_TMAP_IN", System.currentTimeMillis());
...
//                              ###############################
                                ...
                                while (fsi_main.hasNext()) { // G_TM_M_250 loop "main"
                                    ...
                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G 20
                                        ...
                                        lookup_FIRST_MATCHHashKey. ID_LOOKUP_FIRST_MATCH = rsc_main.exprKey_lookup_FIRST_MATCH__ID_LOOKUP_FIRST_MATCH;




                                        tHash_Lookup_lookup_FIRST_MATCH.lookup( lookup_FIRST_MATCHHashKey );

                                        if(!tHash_Lookup_lookup_FIRST_MATCH.hasNext()) { // G
                                            // 090
                                    ...
                                    if (tHash_Lookup_lookup_FIRST_MATCH.hasNext()) { // G
                                        ...
                                        fromLookup_lookup_FIRST_MATCH = tHash_Lookup_lookup_FIRST_MATCH.next();
                                    ...
                                    SortableRow_main__lookup_FIRST_MATCH rsc_main__lookup_FIRST_MATCH = new SortableRow_main__lookup_FIRST_MATCH();

                                    rsc_main__lookup_FIRST_MATCH.fillFrom( main,  lookup_FIRST_MATCH,  exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH);

                                    rsc_main__lookup_FIRST_MATCH.is__rejectedInnerJoin = rejectedInnerJoin_tMapPersistent_1_TMAP_IN;

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = false;

                                    // Sort and store in KeyFile(s) and DataFile(s)
                                    fsi_main__lookup_FIRST_MATCH.put(rsc_main__lookup_FIRST_MATCH);
                                ...
                                fsi_main__lookup_FIRST_MATCH.endPut();
                                ...
                                SortableRow_main__lookup_FIRST_MATCH rsc_main__lookup_FIRST_MATCH;


                                tHash_Lookup_lookup_LAST_MATCH.initGet();

                                fsi_main__lookup_FIRST_MATCH.initGet();
                                ...
                                while (fsi_main__lookup_FIRST_MATCH.hasNext()) { // G_TM_M_250
                                    // loop
                                    // "main__lookup_FIRST_MATCH"
                                    ...
                                    rsc_main__lookup_FIRST_MATCH = (SortableRow_main__lookup_FIRST_MATCH) fsi_main__lookup_FIRST_MATCH.next();
                                    rsc_main__lookup_FIRST_MATCH.copyDataTo( main,  lookup_FIRST_MATCH);

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = rsc_main__lookup_FIRST_MATCH.is__rejectedInnerJoin;
                                    ...
                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G 20
                                        ...
                                        lookup_LAST_MATCHHashKey. ID_LOOKUP_LAST_MATCH = rsc_main__lookup_FIRST_MATCH.exprKey_lookup_LAST_MATCH__ID_LOOKUP_LAST_MATCH;




                                        tHash_Lookup_lookup_LAST_MATCH.lookup( lookup_LAST_MATCHHashKey );

                                        if(!tHash_Lookup_lookup_LAST_MATCH.hasNext()) { // G
                                            // 090
                                    ...
                                    if (tHash_Lookup_lookup_LAST_MATCH.hasNext()) { // G
                                        ...
                                        fromLookup_lookup_LAST_MATCH = tHash_Lookup_lookup_LAST_MATCH.next();
                                    ...
                                    Integer exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = 0;


                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G_TM_M_255

                                        exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH = main.ID_MAIN ;

                                    } // G_TM_M_255



                                    SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH = new SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH();

                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.fillFrom( main,  lookup_FIRST_MATCH,  lookup_LAST_MATCH,  exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH);

                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.is__rejectedInnerJoin = rejectedInnerJoin_tMapPersistent_1_TMAP_IN;

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = false;

                                    // Sort and store in KeyFile(s) and DataFile(s)
                                    fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.put(rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH);


                                } // G_TM_M_250 loop "main__lookup_FIRST_MATCH"
                                ...
                                fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.endPut();



                                // /////////////////////////////////////////////
                                // Starting Lookup Table "lookup_UNIQUE_MATCH"
                                // /////////////////////////////////////////////




                                SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH;


                                tHash_Lookup_lookup_UNIQUE_MATCH.initGet();

                                fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.initGet();
                                ...
                                while (fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.hasNext()) { // G_TM_M_250
                                    // loop
                                    // "main__lookup_FIRST_MATCH__lookup_LAST_MATCH"
                                    ...
                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH = (SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH) fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.next();
                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.copyDataTo( main,  lookup_FIRST_MATCH,  lookup_LAST_MATCH);

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.is__rejectedInnerJoin;



                                    boolean forceLooplookup_UNIQUE_MATCH = false;


                                    lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCHObjectFromLookup = null;

                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G 20


                                        lookup_UNIQUE_MATCHHashKey. ID_LOOKUP_UNIQUE_MATCH = rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH.exprKey_lookup_UNIQUE_MATCH__ID_LOOKUP_UNIQUE_MATCH;




                                        tHash_Lookup_lookup_UNIQUE_MATCH.lookup( lookup_UNIQUE_MATCHHashKey );

                                        if(!tHash_Lookup_lookup_UNIQUE_MATCH.hasNext()) { // G
                                            // 090
                                    ...
                                    lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH = null;



                                    lookup_UNIQUE_MATCHStruct fromLookup_lookup_UNIQUE_MATCH = null;
                                    lookup_UNIQUE_MATCH = lookup_UNIQUE_MATCHDefault;
                                    ...
                                    if (tHash_Lookup_lookup_UNIQUE_MATCH.hasNext()) { // G
                                        ...
                                        fromLookup_lookup_UNIQUE_MATCH = tHash_Lookup_lookup_UNIQUE_MATCH.next();
                                    ...
                                    if(fromLookup_lookup_UNIQUE_MATCH != null) {
                                        lookup_UNIQUE_MATCH = fromLookup_lookup_UNIQUE_MATCH;
                                    }
                                    ...
                                    SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH = new SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH();

                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.fillFrom( main,  lookup_FIRST_MATCH,  lookup_LAST_MATCH,  lookup_UNIQUE_MATCH,  exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES);

                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.is__rejectedInnerJoin = rejectedInnerJoin_tMapPersistent_1_TMAP_IN;

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = false;

                                    // Sort and store in KeyFile(s) and DataFile(s)
                                    fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.put(rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH);
                                ...
                                fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.endPut();
                                ...
                                SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH;


                                tHash_Lookup_lookup_ALL_MATCHES.initGet();

                                fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.initGet();



                                lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH = new lookup_UNIQUE_MATCHStruct();
                                ...
                                while (fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.hasNext()) { // G_TM_M_250
                                    // loop
                                    // "main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH"
                                    ...
                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH = (SortableRow_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH) fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.next();
                                    rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.copyDataTo( main,  lookup_FIRST_MATCH,  lookup_LAST_MATCH,  lookup_UNIQUE_MATCH);

                                    rejectedInnerJoin_tMapPersistent_1_TMAP_IN = rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.is__rejectedInnerJoin;
                                    ...
                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G 20
                                        ...
                                        lookup_ALL_MATCHESHashKey. ID_LOOKUP_ALL_MATCHES = rsc_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH.exprKey_lookup_ALL_MATCHES__ID_LOOKUP_ALL_MATCHES;




                                        tHash_Lookup_lookup_ALL_MATCHES.lookup( lookup_ALL_MATCHESHashKey );

                                        if(!tHash_Lookup_lookup_ALL_MATCHES.hasNext()) { // G
                                            // 090
                                    ...
                                    while (tHash_Lookup_lookup_ALL_MATCHES.hasNext() || forceLooplookup_ALL_MATCHES) { // G_TM_M_043
                                        ...
                                        if(!forceLooplookup_ALL_MATCHES) { // G 46
                                            ...
                                            fromLookup_lookup_ALL_MATCHES = tHash_Lookup_lookup_ALL_MATCHES.next();
                                    ...
                                    fsi_main__lookup_FIRST_MATCH__lookup_LAST_MATCH__lookup_UNIQUE_MATCH__lookup_ALL_MATCHES.endPut();
                                    ...
                                    if(!rejectedInnerJoin_tMapPersistent_1_TMAP_IN) { // G 20
                                        ...
                                        tHash_Lookup_lookup_ALL_ROWS.lookup( lookup_ALL_ROWSHashKey );

                                        if(!tHash_Lookup_lookup_ALL_ROWS.hasNext()) { // G
                                            // 090
                                    ...
                                    while (tHash_Lookup_lookup_ALL_ROWS.hasNext() || forceLooplookup_ALL_ROWS) { // G_TM_M_043
                                        ...
                                        if(!forceLooplookup_ALL_ROWS) { // G 46
                                            ...
                                            fromLookup_lookup_ALL_ROWS = tHash_Lookup_lookup_ALL_ROWS.next();
...
//                                          # Output table : 'out'
                                            ...
                                            out_tmp.ID_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH ;
                                            out_tmp.LABEL_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.LABEL_LOOKUP_UNIQUE_MATCH ;
                                            out = out_tmp;
//                                          ###############################
...
//                                      Start of branch "out"
                                    ...
                                    } // close loop of lookup 'lookup_ALL_ROWS' // G_TM_M_043
...
//                              # Lookup hashes releasing
                                ...
                                tHash_Lookup_lookup_UNIQUE_MATCH.endGet();

                                globalMap.remove( "tHash_Lookup_lookup_UNIQUE_MATCH" );
...
//                              ###############################
    ...
    public void tFileCompare_1Process() throws TalendException {                
        try {
            ...
            if (result_tFileCompare_1)
            {
                ...
                java.io.BufferedReader file_tFileCompare_1 = new java.io.BufferedReader(new java.io.FileReader(context.data_output_dir + context.current_job_dir + "out_main_" + context.indexMain +"__lookup_" + context.indexLookup +".csv"));
                java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(new java.io.FileReader((String)context.getProperty("data_dir") + context.current_job_dir + "ref/out_main_" + context.indexMain +"__lookup_" + context.indexLookup +".csv"));
            ...
            if (result_tFileCompare_1) {
                messagetFileCompare_1 = "[" + jobName + "." + currentComponent + "] 'main_" + context.indexMain + ".csv' and 'lookup_" + context.indexLookup +".csv', OK";

            } else {
                messagetFileCompare_1 = "[" + jobName + "." + currentComponent + "] Files differ: check files 'main_" + context.indexMain + ".csv' and 'lookup_" + context.indexLookup +".csv', DIFFERENT";
            }
    ...
    private class row4Struct implements routines.system.IPersistableRow<row4Struct> {
...
//          loop
            ...
            for (int i_tFixedFlowInput_1 = 0 ; i_tFixedFlowInput_1 < 1 ; i_tFixedFlowInput_1++) {
                ...
                row4.testOk = ((Boolean)globalMap.get("tFileCompare_1_DIFFERENCE"));
...
//          end of the component, outside/closing the loop
    ...
    private class lookup_ALL_MATCHESStruct implements routines.system.IPersistableComparableLookupRow<lookup_ALL_MATCHESStruct> {
        ...
        public int hashCode() {
            if (this.hashCodeDirty) {
                ...
                result = prime * result + ((this.ID_LOOKUP_ALL_MATCHES == null) ? 0 : this.ID_LOOKUP_ALL_MATCHES.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (this.ID_LOOKUP_ALL_MATCHES == null) {
                if (other.ID_LOOKUP_ALL_MATCHES != null) 
                    return false;
            } else if (!this.ID_LOOKUP_ALL_MATCHES.equals(other.ID_LOOKUP_ALL_MATCHES)) 
                return false;
        ...
        public int compareTo(lookup_ALL_MATCHESStruct other) {
            ...
            returnValue = checkNullsAndCompare(this.ID_LOOKUP_ALL_MATCHES, other.ID_LOOKUP_ALL_MATCHES);
            if(returnValue != 0) {
                return returnValue;
            }
    ...
    public void tFileInputDelimited_4Process() throws TalendException {             
        try {
            ...
            start_Hash.put("tAdvancedHashPersistent_lookup_ALL_MATCHES", System.currentTimeMillis());
            currentComponent="tAdvancedHashPersistent_lookup_ALL_MATCHES";


            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup_ALL_MATCHES = 
                org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.ALL_MATCHES;


            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct> tHash_Lookup_lookup_ALL_MATCHES = 
                new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct>(matchingModeEnum_lookup_ALL_MATCHES, "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/Lookup_lookup_ALL_MATCHES_"
                ...
                globalMap.put("tHash_Lookup_lookup_ALL_MATCHES", tHash_Lookup_lookup_ALL_MATCHES);
                ...
                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_4 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/lookup_" + context.indexLookup +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                while (fid_tFileInputDelimited_4.nextRecord()) {
                    ...
                    try {
                        ...
                        if(temp_tFileInputDelimited_4.length() > 0) {lookup_ALL_MATCHES.ID_LOOKUP_ALL_MATCHES = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_4);} else {                        lookup_ALL_MATCHES.ID_LOOKUP_ALL_MATCHES = null;}
                        lookup_ALL_MATCHES.LABEL_LOOKUP_ALL_MATCHES = fid_tFileInputDelimited_4.get(1).trim();
...
//                  Start of branch "lookup_ALL_MATCHES"
                    if(lookup_ALL_MATCHES != null) { 
                        ...
                        lookup_ALL_MATCHESStruct lookup_ALL_MATCHES_HashRow = tHash_Lookup_lookup_ALL_MATCHES.getNextFreeRow();
                        ...
                        tHash_Lookup_lookup_ALL_MATCHES.put(lookup_ALL_MATCHES_HashRow);
    ...
    private class lookup_FIRST_MATCHStruct implements routines.system.IPersistableComparableLookupRow<lookup_FIRST_MATCHStruct> {
        private static final int DEFAULT_HASHCODE = 1;
        private static final int PRIME = 31;
        private int hashCode = DEFAULT_HASHCODE;
        public boolean hashCodeDirty = true;
        ...
        public int hashCode() {
            if (this.hashCodeDirty) {
                ...
                result = prime * result + ((this.ID_LOOKUP_FIRST_MATCH == null) ? 0 : this.ID_LOOKUP_FIRST_MATCH.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (this.ID_LOOKUP_FIRST_MATCH == null) {
                if (other.ID_LOOKUP_FIRST_MATCH != null) 
                    return false;
            } else if (!this.ID_LOOKUP_FIRST_MATCH.equals(other.ID_LOOKUP_FIRST_MATCH)) 
                return false;
        ...
        public int compareTo(lookup_FIRST_MATCHStruct other) {
            ...
            returnValue = checkNullsAndCompare(this.ID_LOOKUP_FIRST_MATCH, other.ID_LOOKUP_FIRST_MATCH);
            if(returnValue != 0) {
                return returnValue;
            }
    ...
    public void tFileInputDelimited_5Process() throws TalendException {             
        try {
            ...
            start_Hash.put("tAdvancedHashPersistent_lookup_FIRST_MATCH", System.currentTimeMillis());
            currentComponent="tAdvancedHashPersistent_lookup_FIRST_MATCH";


            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup_FIRST_MATCH = 
                org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.FIRST_MATCH;


            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct> tHash_Lookup_lookup_FIRST_MATCH = 
                new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct>(matchingModeEnum_lookup_FIRST_MATCH, "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/Lookup_lookup_FIRST_MATCH_"
                        , new org.talend.designer.components.persistent.IRowCreator() {
                ...
                globalMap.put("tHash_Lookup_lookup_FIRST_MATCH", tHash_Lookup_lookup_FIRST_MATCH);
                ...
                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_5 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/lookup_" + context.indexLookup +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                while (fid_tFileInputDelimited_5.nextRecord()) {
                    ...
                    try {
                        ...
                        if(temp_tFileInputDelimited_5.length() > 0) {lookup_FIRST_MATCH.ID_LOOKUP_FIRST_MATCH = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_5);} else {                        lookup_FIRST_MATCH.ID_LOOKUP_FIRST_MATCH = null;}
                        lookup_FIRST_MATCH.LABEL_LOOKUP_FIRST_MATCH = fid_tFileInputDelimited_5.get(1).trim();
...
//                  Start of branch "lookup_FIRST_MATCH"
                    if(lookup_FIRST_MATCH != null) { 
                        ...
                        lookup_FIRST_MATCHStruct lookup_FIRST_MATCH_HashRow = tHash_Lookup_lookup_FIRST_MATCH.getNextFreeRow();
                        ...
                        tHash_Lookup_lookup_FIRST_MATCH.put(lookup_FIRST_MATCH_HashRow);
    ...
    private class lookup_LAST_MATCHStruct implements routines.system.IPersistableComparableLookupRow<lookup_LAST_MATCHStruct> {
        private static final int DEFAULT_HASHCODE = 1;
        private static final int PRIME = 31;
        private int hashCode = DEFAULT_HASHCODE;
        public boolean hashCodeDirty = true;
        ...
        public int hashCode() {
            if (this.hashCodeDirty) {
                ...
                result = prime * result + ((this.ID_LOOKUP_LAST_MATCH == null) ? 0 : this.ID_LOOKUP_LAST_MATCH.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (this.ID_LOOKUP_LAST_MATCH == null) {
                if (other.ID_LOOKUP_LAST_MATCH != null) 
                    return false;
            } else if (!this.ID_LOOKUP_LAST_MATCH.equals(other.ID_LOOKUP_LAST_MATCH)) 
                return false;
        ...
        public int compareTo(lookup_LAST_MATCHStruct other) {
            ...
            returnValue = checkNullsAndCompare(this.ID_LOOKUP_LAST_MATCH, other.ID_LOOKUP_LAST_MATCH);
            if(returnValue != 0) {
                return returnValue;
            }
    ...
    public void tFileInputDelimited_6Process() throws TalendException {             
        try {
            ...
            start_Hash.put("tAdvancedHashPersistent_lookup_LAST_MATCH", System.currentTimeMillis());
            currentComponent="tAdvancedHashPersistent_lookup_LAST_MATCH";


            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup_LAST_MATCH = 
                org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.LAST_MATCH;


            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_LAST_MATCHStruct> tHash_Lookup_lookup_LAST_MATCH = 
                new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_LAST_MATCHStruct>(matchingModeEnum_lookup_LAST_MATCH, "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/Lookup_lookup_LAST_MATCH_"
                        , new org.talend.designer.components.persistent.IRowCreator() {
                ...
                globalMap.put("tHash_Lookup_lookup_LAST_MATCH", tHash_Lookup_lookup_LAST_MATCH);
                ...
                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_6 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/lookup_" + context.indexLookup +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                while (fid_tFileInputDelimited_6.nextRecord()) {
                    ...
                    try {
                        ...
                        temp_tFileInputDelimited_6 = fid_tFileInputDelimited_6.get(0).trim();
                        if(temp_tFileInputDelimited_6.length() > 0) {lookup_LAST_MATCH.ID_LOOKUP_LAST_MATCH = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_6);} else {                      lookup_LAST_MATCH.ID_LOOKUP_LAST_MATCH = null;}
                        lookup_LAST_MATCH.LABEL_LOOKUP_LAST_MATCH = fid_tFileInputDelimited_6.get(1).trim();
...
//                  Start of branch "lookup_LAST_MATCH"
                    if(lookup_LAST_MATCH != null) { 
                        ...
                        lookup_LAST_MATCHStruct lookup_LAST_MATCH_HashRow = tHash_Lookup_lookup_LAST_MATCH.getNextFreeRow();
                        ...
                        tHash_Lookup_lookup_LAST_MATCH.put(lookup_LAST_MATCH_HashRow);
    ...
    private class lookup_UNIQUE_MATCHStruct implements routines.system.IPersistableComparableLookupRow<lookup_UNIQUE_MATCHStruct> {
        private static final int DEFAULT_HASHCODE = 1;
        private static final int PRIME = 31;
        private int hashCode = DEFAULT_HASHCODE;
        public boolean hashCodeDirty = true;
        ...
        public int hashCode() {
            if (this.hashCodeDirty) {
                ...
                result = prime * result + ((this.ID_LOOKUP_UNIQUE_MATCH == null) ? 0 : this.ID_LOOKUP_UNIQUE_MATCH.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (obj == null) return false;
            if (getClass() != obj.getClass()) return false;
            final lookup_UNIQUE_MATCHStruct other = (lookup_UNIQUE_MATCHStruct) obj;

            if (this.ID_LOOKUP_UNIQUE_MATCH == null) {
                if (other.ID_LOOKUP_UNIQUE_MATCH != null) 
                    return false;
            } else if (!this.ID_LOOKUP_UNIQUE_MATCH.equals(other.ID_LOOKUP_UNIQUE_MATCH)) 
                return false;
        ...
        public void copyDataTo(lookup_UNIQUE_MATCHStruct other) {
        ...
        public void copyKeysDataTo(lookup_UNIQUE_MATCHStruct other) {
         ...
         * Compare keys
         */
        public int compareTo(lookup_UNIQUE_MATCHStruct other) {

            int returnValue = -1;

            returnValue = checkNullsAndCompare(this.ID_LOOKUP_UNIQUE_MATCH, other.ID_LOOKUP_UNIQUE_MATCH);
            if(returnValue != 0) {
                return returnValue;
            }
    ...
    public void tFileInputDelimited_7Process() throws TalendException {             
        try {
            ...
            /**
             * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH begin ] start
             */



            ok_Hash.put("tAdvancedHashPersistent_lookup_UNIQUE_MATCH", false);
            start_Hash.put("tAdvancedHashPersistent_lookup_UNIQUE_MATCH", System.currentTimeMillis());
            currentComponent="tAdvancedHashPersistent_lookup_UNIQUE_MATCH";


            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup_UNIQUE_MATCH = 
                org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.UNIQUE_MATCH;


            org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MATCHStruct> tHash_Lookup_lookup_UNIQUE_MATCH = 
                new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MATCHStruct>(matchingModeEnum_lookup_UNIQUE_MATCH, "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/Lookup_lookup_UNIQUE_MATCH_"
                        , new org.talend.designer.components.persistent.IRowCreator() {
                    public lookup_UNIQUE_MATCHStruct createRowInstance() {
                        return new lookup_UNIQUE_MATCHStruct();
                    }
                }); 

                tHash_Lookup_lookup_UNIQUE_MATCH.initPut();

                globalMap.put("tHash_Lookup_lookup_UNIQUE_MATCH", tHash_Lookup_lookup_UNIQUE_MATCH);



                /**
                 * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH begin ] stop
                 */
                ...
                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_7 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/lookup_" + context.indexLookup +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                while (fid_tFileInputDelimited_7.nextRecord()) {
                    lookup_UNIQUE_MATCH = null;         
                    lookup_UNIQUE_MATCH = null;                     
                    boolean whetherReject_tFileInputDelimited_7 = false;
                    lookup_UNIQUE_MATCH = new lookup_UNIQUE_MATCHStruct();
                    try {
                        String temp_tFileInputDelimited_7 = "";
                        temp_tFileInputDelimited_7 = fid_tFileInputDelimited_7.get(0).trim();
                        if(temp_tFileInputDelimited_7.length() > 0) {lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_7);} else {                      lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH = null;}
                        lookup_UNIQUE_MATCH.LABEL_LOOKUP_UNIQUE_MATCH = fid_tFileInputDelimited_7.get(1).trim();
                     ...
                     */
//                  Start of branch "lookup_UNIQUE_MATCH"
                    if(lookup_UNIQUE_MATCH != null) { 

                        /**
                         * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH main ] start
                         */
                        ...
                        lookup_UNIQUE_MATCHStruct lookup_UNIQUE_MATCH_HashRow = tHash_Lookup_lookup_UNIQUE_MATCH.getNextFreeRow();


                        lookup_UNIQUE_MATCH_HashRow.ID_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.ID_LOOKUP_UNIQUE_MATCH;
                        lookup_UNIQUE_MATCH_HashRow.LABEL_LOOKUP_UNIQUE_MATCH = lookup_UNIQUE_MATCH.LABEL_LOOKUP_UNIQUE_MATCH;
                        tHash_Lookup_lookup_UNIQUE_MATCH.put(lookup_UNIQUE_MATCH_HashRow);
                        ...
                        /**
                         * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH main ] stop
                         */

                    } // End of branch "lookup_UNIQUE_MATCH"
                 ...
                 */
                /**
                 * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH end ] start
                 */

                currentComponent="tAdvancedHashPersistent_lookup_UNIQUE_MATCH";


                tHash_Lookup_lookup_UNIQUE_MATCH.endPut();


                ok_Hash.put("tAdvancedHashPersistent_lookup_UNIQUE_MATCH", true);
                end_Hash.put("tAdvancedHashPersistent_lookup_UNIQUE_MATCH", System.currentTimeMillis());

                /**
                 * [tAdvancedHashPersistent_lookup_UNIQUE_MATCH end ] stop
                 */
    ...
    private class lookup_ALL_ROWSStruct implements routines.system.IPersistableRow<lookup_ALL_ROWSStruct> {
    ...
    public void tFileInputDelimited_9Process() throws TalendException {             
        try {
            ...
            start_Hash.put("tAdvancedHashPersistent_lookup_ALL_ROWS", System.currentTimeMillis());
            currentComponent="tAdvancedHashPersistent_lookup_ALL_ROWS";


            org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_lookup_ALL_ROWS = 
                org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.ALL_ROWS;


            org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct> tHash_Lookup_lookup_ALL_ROWS = 
                new org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct>(matchingModeEnum_lookup_ALL_ROWS, "/home/amaumont/data/dev/eclipse/workspaces/runtime-talend.product2" + "/Lookup_lookup_ALL_ROWS_"
                        , new org.talend.designer.components.persistent.IRowCreator() {
                ...
                globalMap.put("tHash_Lookup_lookup_ALL_ROWS", tHash_Lookup_lookup_ALL_ROWS);
                ...
                org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_9 = new org.talend.fileprocess.FileInputDelimited((String)context.getProperty("data_dir") + context.current_job_dir + "in/lookup_" + context.indexLookup +".csv","ISO-8859-15",";","\n",true,0,0,-1,-1);
                while (fid_tFileInputDelimited_9.nextRecord()) {
                    ...
                    try {
                        ...
                        if(temp_tFileInputDelimited_9.length() > 0) {lookup_ALL_ROWS.ID_LOOKUP_ALL_ROWS = ParserUtils.parseTo_Integer(temp_tFileInputDelimited_9);} else {                      lookup_ALL_ROWS.ID_LOOKUP_ALL_ROWS = null;}
                        lookup_ALL_ROWS.LABEL_LOOKUP_ALL_ROWS = fid_tFileInputDelimited_9.get(1).trim();
...
//                  Start of branch "lookup_ALL_ROWS"
                    if(lookup_ALL_ROWS != null) { 
                        ...
                        lookup_ALL_ROWSStruct lookup_ALL_ROWS_HashRow = tHash_Lookup_lookup_ALL_ROWS.getNextFreeRow();
    ...
    public static synchronized int runJobInTOS(String[] args) {
        ...
        try {
            java.io.InputStream inContext = tMap_04_persistence_02_n_lookups_CHILD.class.getClassLoader().getResourceAsStream("java_project_8/tmap_04_persistence_02_n_lookups_child_0_1/contexts/Default.properties");         
            if (inContext!=null) {
            ...
            if (contextStr.compareTo("Default")!=0) {
                inContext = tMap_04_persistence_02_n_lookups_CHILD.class.getClassLoader().getResourceAsStream("java_project_8/tmap_04_persistence_02_n_lookups_child_0_1/contexts/"+contextStr+".properties");
                if (inContext!=null) {
        ...
        final tMap_04_persistence_02_n_lookups_CHILD tMap_04_persistence_02_n_lookups_CHILDClass = new tMap_04_persistence_02_n_lookups_CHILD(); 
        try {
            errorCode = null;tMap_04_persistence_02_n_lookups_CHILDClass.tFileInputDelimited_2Process();
            status = "end";
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tMap_04_persistence_02_n_lookups_CHILD");
        }         
 ...
 * 214006 characters generated by Talend OpenStudio on the 25 avril 2008
 * 17:35:02 CEST
 **************************************************************************/