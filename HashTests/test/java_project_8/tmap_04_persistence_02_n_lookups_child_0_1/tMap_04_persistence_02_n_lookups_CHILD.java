...
public class tMap_04_persistence_02_n_lookups_CHILD {
	...
	private class TalendException extends Exception {
		...
		private TalendException(tMap_04_persistence_02_n_lookups_CHILD c,
				Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public void tFileInputDelimited_8Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main> fsi_main = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main>(
					context.data_output_dir + "/tMapData_main", 10000000) {
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS> fsi_main__lookup_ALL_ROWS = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS>(
					context.data_output_dir + "/tMapData_main__lookup_ALL_ROWS",
					10000000) {
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH> fsi_main__lookup_ALL_ROWS__lookup_FIRST_MATCH = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH>(
					context.data_output_dir
							+ "/tMapData_main__lookup_ALL_ROWS__lookup_FIRST_MATCH",
					10000000) {
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH> fsi_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH>(
					context.data_output_dir
							+ "/tMapData_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH",
					10000000) {
			...
			class SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH__lookup_UNIQUE_MACTH
				...
				Integer LOOKUP_LAST_MATCH__ID_LOOKUP_LAST_MATCH;
				String LOOKUP_LAST_MATCH__LABEL_LOOKUP_LAST_MATCH;
				Integer lookup_UNIQUE_MACTH__ID_LOOKUP_UNIQUE_MATCH;
				...
				public void loadData(byte[] data) {
					...
					try {
						...
						length = dis.readByte();
						if (length == -1) {
							this.lookup_UNIQUE_MACTH__ID_LOOKUP_UNIQUE_MATCH = null;
						} else {
							this.lookup_UNIQUE_MACTH__ID_LOOKUP_UNIQUE_MATCH = dis
									.readInt();
						}
				...
				public byte[] toData() {
					...
					try {
						...
						if (this.lookup_UNIQUE_MACTH__ID_LOOKUP_UNIQUE_MATCH == null) {
							dos.writeByte(-1);
						} else {
							dos.writeByte(0);
							dos
									.writeInt(this.lookup_UNIQUE_MACTH__ID_LOOKUP_UNIQUE_MATCH);
						}

						if (this.lookup_UNIQUE_MACTH__LABEL_LOOKUP_UNIQUE_MATCH == null) {
							dos.writeInt(-1);
						} else {
							byteArray = this.lookup_UNIQUE_MACTH__LABEL_LOOKUP_UNIQUE_MATCH
									.getBytes();
							dos.writeInt(byteArray.length);
							dos.write(byteArray);
						}
			...
			org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH__lookup_UNIQUE_MACTH> fsi_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH__lookup_UNIQUE_MACTH = new org.talend.designer.components.persistent.PersistentRowSorterIterator<SortableRow_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH__lookup_UNIQUE_MACTH>(
					context.data_output_dir
							+ "/tMapData_main__lookup_ALL_ROWS__lookup_FIRST_MATCH__LOOKUP_LAST_MATCH__lookup_UNIQUE_MACTH",
					10000000) {
			...
			while (fid_tFileInputDelimited_8.nextRecord()) {
				...
				if (main != null) {
					...
					if (!rejectedInnerJoin_tMap_1_TMAP_OUT) { // G 20
	...
	public void tFileInputDelimited_4Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct> tHash_Lookup_lookup_ALL_MATCHES = new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_ALL_MATCHESStruct>(
					...
					context.data_output_dir + "/Lookup_lookup_ALL_MATCHES_",
	...
	public void tFileInputDelimited_5Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct> tHash_Lookup_lookup_FIRST_MATCH = new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_FIRST_MATCHStruct>(
					...
					context.data_output_dir + "/Lookup_lookup_FIRST_MATCH_",
					new org.talend.designer.components.persistent.IRowCreator() {
	...
	public void tFileInputDelimited_6Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentSortedLookupManager<LOOKUP_LAST_MATCHStruct> tHash_Lookup_LOOKUP_LAST_MATCH = new org.talend.designer.components.persistent.PersistentSortedLookupManager<LOOKUP_LAST_MATCHStruct>(
					...
					context.data_output_dir + "/Lookup_LOOKUP_LAST_MATCH_",
					new org.talend.designer.components.persistent.IRowCreator() {
	...
	public void tFileInputDelimited_7Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MACTHStruct> tHash_Lookup_lookup_UNIQUE_MACTH = new org.talend.designer.components.persistent.PersistentSortedLookupManager<lookup_UNIQUE_MACTHStruct>(
					...
					context.data_output_dir + "/Lookup_lookup_UNIQUE_MACTH_",
					new org.talend.designer.components.persistent.IRowCreator() {
	...
	public void tFileInputDelimited_9Process() throws TalendException {
		try {
			...
			org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct> tHash_Lookup_lookup_ALL_ROWS = new org.talend.designer.components.persistent.PersistentLookupManager<lookup_ALL_ROWSStruct>(
					...
					context.data_output_dir + "/Lookup_lookup_ALL_ROWS_",
					new org.talend.designer.components.persistent.IRowCreator() {
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tMap_04_persistence_02_n_lookups_CHILD.class
					.getClassLoader()
					.getResourceAsStream(
							"java_project_8/tmap_04_persistence_02_n_lookups_child_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tMap_04_persistence_02_n_lookups_CHILD.class
						.getClassLoader().getResourceAsStream(
								"java_project_8/tmap_04_persistence_02_n_lookups_child_0_1/contexts/"
		...
		try {
			errorCode = null;
			tMap_04_persistence_02_n_lookups_CHILDClass
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : tMap_04_persistence_02_n_lookups_CHILD");
		}
...
/*******************************************************************************
 * 227135 characters generated by Talend OpenStudio on the 6 mai 2008 15:51:28
 * CEST
 ******************************************************************************/
