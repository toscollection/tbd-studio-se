...
//
// ============================================================================ 
package java_project_8.tmap_03_persistence_01_string_child_0_1;
...
/**
 * Job: tMap_03_persistence_01_String_CHILD Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class tMap_03_persistence_01_String_CHILD {
	...
	private static final String jobName = "tMap_03_persistence_01_String_CHILD";
	...
	private class TalendException extends Exception {
		...
		private tMap_03_persistence_01_String_CHILD c = null;

		private TalendException(tMap_03_persistence_01_String_CHILD c,
				Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public void tLogRow_4_error(Exception exception) throws TalendException {
		...
		public void readData(ObjectInputStream dis) {
			...
			try {
				...
				if (length == -1) {
					...
					dis.readFully(commonByteArray, 0, length);
					this.ID_MAIN = new String(commonByteArray, 0, length);
				}
				...
				if (length == -1) {
					...
					dis.readFully(commonByteArray, 0, length);
					this.ID_LOOKUP1 = new String(commonByteArray, 0, length);
				}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.ID_MAIN == null) {
					...
					byte[] byteArray = this.ID_MAIN.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
				...
				if (this.ID_LOOKUP1 == null) {
					...
					byte[] byteArray = this.ID_LOOKUP1.getBytes();
					dos.writeInt(byteArray.length);
					dos.write(byteArray);
				}
	...
	public void tFileInputDelimited_8Process() throws TalendException {
		...
		try {
			...
			class SortableRow_main implements Comparable<SortableRow_main>,
				...
				String exprKey_lookup__ID_LOOKUP1;

				// main
				String main__ID_MAIN;
					...
					try {
						...
						if (length == -1) {
							...
							dis
									.readFully(mainStruct.commonByteArray, 0,
											length);
							this.exprKey_lookup__ID_LOOKUP1 = new String(
									mainStruct.commonByteArray, 0, length);
						}
				...
				public void writeData(ObjectOutputStream dos) {
					try {
						...
						if (this.main__ID_MAIN == null) {
							...
							byte[] byteArray = this.main__ID_MAIN.getBytes();
							dos.writeInt(byteArray.length);
							dos.write(byteArray);
						}
						...
						if (this.exprKey_lookup__ID_LOOKUP1 == null) {
							...
							byte[] byteArray = this.exprKey_lookup__ID_LOOKUP1
									.getBytes();
							dos.writeInt(byteArray.length);
							dos.write(byteArray);
						}
			...
			while (fid_tFileInputDelimited_8.nextRecord()) {
				...
				try {
					...
					main.ID_MAIN = fid_tFileInputDelimited_8.get(0).trim();
				...
				if (main != null) {
					...
					String exprKey_lookup__ID_LOOKUP1 = main.ID_MAIN;
			...
			while (fsi_main.hasNext()) { // G_TM_M_250 loop "main"
				...
				if (out != null) {
					...
					if (row2.ID_MAIN != null) { //              
						...
						strBuffer_tLogRow_4
								.append(String.valueOf(row2.ID_MAIN));
		...
		try {
			...
			while (fid_tFileInputDelimited_9.nextRecord()) {
				...
				try {
					...
					lookup.ID_LOOKUP1 = fid_tFileInputDelimited_9.get(0).trim();
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tMap_03_persistence_01_String_CHILD.class
					.getClassLoader()
					.getResourceAsStream(
							"java_project_8/tmap_03_persistence_01_string_child_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tMap_03_persistence_01_String_CHILD.class
						.getClassLoader().getResourceAsStream(
								"java_project_8/tmap_03_persistence_01_string_child_0_1/contexts/"
		...
		final tMap_03_persistence_01_String_CHILD tMap_03_persistence_01_String_CHILDClass = new tMap_03_persistence_01_String_CHILD();

		try {
			errorCode = null;
			tMap_03_persistence_01_String_CHILDClass
		...
		try {
			errorCode = null;
			tMap_03_persistence_01_String_CHILDClass.tJavaFlex_4Process();
			status = "end";
		} catch (TalendException e_tJavaFlex_4) {
			status = "failure";
			e_tJavaFlex_4.printStackTrace();
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : tMap_03_persistence_01_String_CHILD");
		}
...
/*******************************************************************************
 * 97234 characters generated by Talend OpenStudio on the 6 juin 2008 19:04:03
 * CEST
 ******************************************************************************/
