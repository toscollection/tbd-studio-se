...
//
// ============================================================================ 
package java_project_10.tmap_03_persistence_01_bigdecimal_child_0_1;
...
/**
 * Job: tMap_03_persistence_01_BigDecimal_CHILD Purpose: <br>
 * Description: Last match tested in persistent mode with BigDecimal type as
 * column key <br>
 * 
 ...
 * @status
 */
public class tMap_03_persistence_01_BigDecimal_CHILD {
	...
	private static final String jobName = "tMap_03_persistence_01_BigDecimal_CHILD";
	...
	private class TalendException extends Exception {
		...
		private tMap_03_persistence_01_BigDecimal_CHILD c = null;

		private TalendException(tMap_03_persistence_01_BigDecimal_CHILD c,
	...
	static class outStruct implements
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock) {
				...
				try {
					...
					this.ID_LOOKUP1 = (BigDecimal) dis.readObject();
					...
					if (length == -1) {
						...
						dis.readFully(commonByteArray, 0, length);
						this.LABEL_LOOKUP1 = new String(commonByteArray, 0,
								length);
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.ID_LOOKUP1);
	...
	public void tFileInputDelimited_8Process(
		...
		try {
			...
			class SortableRow_main implements Comparable<SortableRow_main>,
				...
				BigDecimal exprKey_lookup__ID_LOOKUP1;
				...
				public void readData(ObjectInputStream dis) {
					...
					synchronized (mainStruct.commonByteArrayLock) {
						...
						try {
							...
							this.exprKey_lookup__ID_LOOKUP1 = (BigDecimal) dis
									.readObject();
				...
				public void writeData(ObjectOutputStream dos) {
					try {
						...
						dos.writeObject(this.exprKey_lookup__ID_LOOKUP1);
			...
			while (fid_tFileInputDelimited_8.nextRecord()) {
				...
				if (main != null) {
					...
					BigDecimal exprKey_lookup__ID_LOOKUP1 = main.ID_MAIN;
	...
	static class lookupStruct implements
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				System.out.println(this.ID_LOOKUP1  + ":" + result);
		...
		public void writeKeysData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.ID_LOOKUP1);
//				dos.writeObject(new BigDecimal(this.ID_LOOKUP1.intValue()));
//				dos.writeObject(new BigDecimal(this.ID_LOOKUP1.intValue() + 1));
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = tMap_03_persistence_01_BigDecimal_CHILD.class
					.getClassLoader()
					.getResourceAsStream(
							"java_project_10/tmap_03_persistence_01_bigdecimal_child_0_1/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = tMap_03_persistence_01_BigDecimal_CHILD.class
						.getClassLoader().getResourceAsStream(
								"java_project_10/tmap_03_persistence_01_bigdecimal_child_0_1/contexts/"
		...
		final tMap_03_persistence_01_BigDecimal_CHILD tMap_03_persistence_01_BigDecimal_CHILDClass = new tMap_03_persistence_01_BigDecimal_CHILD();

		try {
			errorCode = null;
			tMap_03_persistence_01_BigDecimal_CHILDClass
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : tMap_03_persistence_01_BigDecimal_CHILD");
		}
...
/************************************************************************************************
 * 87822 characters generated by Talend OpenStudio on the 10 février 2009
 * 15:26:02 CET
 ************************************************************************************************/
