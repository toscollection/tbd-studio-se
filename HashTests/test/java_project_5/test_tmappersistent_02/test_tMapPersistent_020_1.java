 ...
 * @status
 */
public class test_tMapPersistent_020_1 {
	...
	private class TalendException extends Exception {
		...
		private test_tMapPersistent_020_1 c = null;

		private TalendException(test_tMapPersistent_020_1 c, Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = test_tMapPersistent_020_1.class
					.getClassLoader()
					.getResourceAsStream(
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = test_tMapPersistent_020_1.class.getClassLoader()
						.getResourceAsStream(
		...
		final test_tMapPersistent_020_1 test_tMapPersistent_02Class = new test_tMapPersistent_020_1();
		try {
			errorCode = null;
