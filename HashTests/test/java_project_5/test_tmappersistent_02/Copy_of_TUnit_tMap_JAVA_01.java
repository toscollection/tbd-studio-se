...
/**
 * Job: Copy_of_TUnit_tMap_JAVA_01 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_TUnit_tMap_JAVA_01 {
	...
	private static final String jobName = "Copy_of_TUnit_tMap_JAVA_01";
	...
	private class TalendException extends Exception {
		...
		private Copy_of_TUnit_tMap_JAVA_01 c = null;

		private TalendException(Copy_of_TUnit_tMap_JAVA_01 c, Exception e) {
			this.e = e;
			this.c = c;
		}
	...
	public void tFileInputDelimited_2Process() throws TalendException {
		try {
			...
			while (fsi_row1.hasNext()) { // G_TM_M_250 loop "row1"
				...
				row1.ID_MAIN != null && row1.ID_MAIN > 1
				...
				if (!rejectedInnerJoin_tMap_1) { // G_TM_M_255

					exprKey_row3__ID_LOOKUP2 = row2.ID_LOOKUP1
							/ row2.ID_LOOKUP1 * row2.ID_LOOKUP1;

				} // G_TM_M_255

				SortableRow_row1__row2 rsc_row1__row2 = new SortableRow_row1__row2();

				rsc_row1__row2.fillFrom(row1, row2, exprKey_row3__ID_LOOKUP2);

				rsc_row1__row2.is__rejectedInnerJoin = rejectedInnerJoin_tMap_1;
			...
			while (fsi_row1__row2.hasNext()) { // G_TM_M_250 loop "row1__row2"
				...
				rejectedInnerJoin_tMap_1 = rsc_row1__row2.is__rejectedInnerJoin;
				...
				{ // Dummy bracket to open block for "row1"
					...
					{ // start of Var scope
						...
						if (!rejectedInnerJoin_tMap_1) {
							...
							row1.ID_MAIN != null && row1.ID_MAIN > 4
	...
	public void tFileInputDelimited_1Process() throws TalendException {
		try {
			...
			org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE matchingModeEnum_row2 = org.talend.designer.components.commons.AdvancedLookup.MATCHING_MODE.LAST_MATCH;
	...
	public static synchronized int runJobInTOS(String[] args) {
		...
		try {
			java.io.InputStream inContext = Copy_of_TUnit_tMap_JAVA_01.class
					.getClassLoader()
					.getResourceAsStream(
							"test/prototype/main/contexts/test1.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = Copy_of_TUnit_tMap_JAVA_01.class.getClassLoader()
						.getResourceAsStream(
								"java_project_6/copy_of_tunit_tmap_java_01_0_1/contexts/"
		...
		final Copy_of_TUnit_tMap_JAVA_01 Copy_of_TUnit_tMap_JAVA_01Class = new Copy_of_TUnit_tMap_JAVA_01();
		try {
			errorCode = null;
			Copy_of_TUnit_tMap_JAVA_01Class.tRunJob_1Process();
			status = "end";
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Copy_of_TUnit_tMap_JAVA_01");
		}
...
/*******************************************************************************
 * 152238 characters generated by Talend OpenStudio on the 12 avril 2008
 * 22:10:34 CEST
 ******************************************************************************/
