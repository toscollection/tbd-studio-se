package org.talend.designer.components.sort.enhancedquicksort;
 ...
 * 
 * Permission to use, copy, modify, and distribute this software and its documentation for NON-COMMERCIAL purposes and
 * without fee is hereby granted provided that this copyright notice appears in all copies. Please refer to the file
 * "copyright.html" for further important copyright and licensing information.
 * 
 * UBC MAKES NO REPRESENTATIONS OR WARRANTIES ABOUT THE SUITABILITY OF THE SOFTWARE, EITHER EXPRESS OR IMPLIED,
 * INCLUDING BUT NOT LIMITED TO THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR
 * NON-INFRINGEMENT. UBC SHALL NOT BE LIABLE FOR ANY DAMAGES SUFFERED BY LICENSEE AS A RESULT OF USING, MODIFYING OR
 ...
 */
/**
 * 19 Feb 1996: Fixed to avoid infinite loop discoved by Paul Haberli. Misbehaviour expressed when the pivot element was
 * not unique. -Jason Harrison
 * 
