package org.talend.designer.components.sort.fastquicksort;
 ...
 * purposes and without fee is hereby granted. Please refer to the file http://www.javasoft.com/copy_trademarks.html for
 * further important copyright and trademark information and to http://www.javasoft.com/licensing.html for further
 * important licensing information for the Java (tm) Technology.
 * 
 ...
 * @version
 * @(#)QSortAlgorithm.java 1.3, 29 Feb 1996 extended with TriMedian and InsertionSort by Denis Ahrens with all the tips
 * from Robert Sedgewick (Algorithms in C++). It uses TriMedian and InsertionSort for lists shorts than 4.
