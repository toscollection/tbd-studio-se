 ...
 * 
 * 
 * 18000 milliseconds for 1000000 objects to STORE using BeanIntrospectionHashFile. 55000 items/s. 13 bytes per item in
 * storage. 20406 milliseconds for 1000000 objects to STORE using IntrospectionHashFile. 49000 items/s. 13 bytes per
 * item in storage. 19485 milliseconds for 1000000 objects to STORE using SimpleHashFile. 51000 items/s. 124 bytes per
 * item in storage. 30609 milliseconds for 1000000 objects to STORE using DoubleHashFile. 32000 items/s.
 * 
 */
class BeanIntrospectionHashFile implements IMapHashFile {
    ...
    public static void main(String[] args) throws IOException, IllegalAccessException, InvocationTargetException,
        ...
        System.out.print(deltaTime + " milliseconds for " + loop
                + " objects to STORE using BeanIntrospectionHashFile. " + (loop / deltaTime * 1000) + " items/s. ");
