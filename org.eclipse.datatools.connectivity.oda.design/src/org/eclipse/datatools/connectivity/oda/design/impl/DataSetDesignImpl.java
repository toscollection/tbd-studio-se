    ...
    implements DataSetDesign, IAdaptable
{
    ...
    public void setName( String newName )
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__NAME, oldName, m_name));
    }
    ...
    public void setOdaExtensionDataSetId( String newOdaExtensionDataSetId )
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__ODA_EXTENSION_DATA_SET_ID, oldOdaExtensionDataSetId, m_odaExtensionDataSetId));
    }
    ...
    public NotificationChain basicSetDataSourceDesign( DataSourceDesign newDataSourceDesign, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__DATA_SOURCE_DESIGN, oldDataSourceDesign, newDataSourceDesign);
    ...
    public void setDataSourceDesign( DataSourceDesign newDataSourceDesign )
    {
        if (newDataSourceDesign != m_dataSourceDesign)
        {
            ...
            if (m_dataSourceDesign != null)
                msgs = ((InternalEObject)m_dataSourceDesign).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__DATA_SOURCE_DESIGN, null, msgs);
            if (newDataSourceDesign != null)
                msgs = ((InternalEObject)newDataSourceDesign).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__DATA_SOURCE_DESIGN, null, msgs);
            msgs = basicSetDataSourceDesign(newDataSourceDesign, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__DATA_SOURCE_DESIGN, newDataSourceDesign, newDataSourceDesign));
    }
    ...
    public NotificationChain basicSetQuery( DataSetQuery newQuery, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__QUERY, oldQuery, newQuery);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setQuery( DataSetQuery newQuery )
    {
        if (newQuery != m_query)
        {
            NotificationChain msgs = null;
            if (m_query != null)
                msgs = ((InternalEObject)m_query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__QUERY, null, msgs);
            if (newQuery != null)
                msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__QUERY, null, msgs);
            msgs = basicSetQuery(newQuery, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__QUERY, newQuery, newQuery));
    }
    ...
    public void setDisplayName( String newDisplayName )
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__DISPLAY_NAME, oldDisplayName, m_displayName));
    }
    ...
    public NotificationChain basicSetPublicProperties( Properties newPublicProperties, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PUBLIC_PROPERTIES, oldPublicProperties, newPublicProperties);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setPublicProperties( Properties newPublicProperties )
    {
        if (newPublicProperties != m_publicProperties)
        {
            ...
            if (m_publicProperties != null)
                msgs = ((InternalEObject)m_publicProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PUBLIC_PROPERTIES, null, msgs);
            if (newPublicProperties != null)
                msgs = ((InternalEObject)newPublicProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PUBLIC_PROPERTIES, null, msgs);
            msgs = basicSetPublicProperties(newPublicProperties, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PUBLIC_PROPERTIES, newPublicProperties, newPublicProperties));
    }
    ...
    public NotificationChain basicSetPrivateProperties( Properties newPrivateProperties, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PRIVATE_PROPERTIES, oldPrivateProperties, newPrivateProperties);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setPrivateProperties( Properties newPrivateProperties )
    {
        if (newPrivateProperties != m_privateProperties)
        {
            ...
            if (m_privateProperties != null)
                msgs = ((InternalEObject)m_privateProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PRIVATE_PROPERTIES, null, msgs);
            if (newPrivateProperties != null)
                msgs = ((InternalEObject)newPrivateProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PRIVATE_PROPERTIES, null, msgs);
            msgs = basicSetPrivateProperties(newPrivateProperties, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PRIVATE_PROPERTIES, newPrivateProperties, newPrivateProperties));
    }
    ...
    public NotificationChain basicSetResultSets( ResultSets newResultSets, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__RESULT_SETS, oldResultSets, newResultSets);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setResultSets( ResultSets newResultSets )
    {
        if (newResultSets != m_resultSets)
        {
            ...
            if (m_resultSets != null)
                msgs = ((InternalEObject)m_resultSets).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__RESULT_SETS, null, msgs);
            if (newResultSets != null)
                msgs = ((InternalEObject)newResultSets).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__RESULT_SETS, null, msgs);
            msgs = basicSetResultSets(newResultSets, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__RESULT_SETS, newResultSets, newResultSets));
    }
    ...
    public void setPrimaryResultSetName( String newPrimaryResultSetName )
    {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PRIMARY_RESULT_SET_NAME, oldPrimaryResultSetName, m_primaryResultSetName));
    }
    ...
    public NotificationChain basicSetParameters( DataSetParameters newParameters, NotificationChain msgs )
    {
        ...
        if (eNotificationRequired())
        {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PARAMETERS, oldParameters, newParameters);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setParameters( DataSetParameters newParameters )
    {
        if (newParameters != m_parameters)
        {
            ...
            if (m_parameters != null)
                msgs = ((InternalEObject)m_parameters).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PARAMETERS, null, msgs);
            if (newParameters != null)
                msgs = ((InternalEObject)newParameters).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DesignPackage.DATA_SET_DESIGN__PARAMETERS, null, msgs);
            msgs = basicSetParameters(newParameters, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, DesignPackage.DATA_SET_DESIGN__PARAMETERS, newParameters, newParameters));
    }
    ...
    public boolean eIsSet( EStructuralFeature eFeature )
    {
        switch (eDerivedStructuralFeatureID(eFeature))
        {
            ...
            case DesignPackage.DATA_SET_DESIGN__ODA_EXTENSION_DATA_SET_ID:
                return ODA_EXTENSION_DATA_SET_ID_EDEFAULT == null ? m_odaExtensionDataSetId != null : !ODA_EXTENSION_DATA_SET_ID_EDEFAULT.equals(m_odaExtensionDataSetId);
            case DesignPackage.DATA_SET_DESIGN__DATA_SOURCE_DESIGN:
            ...
            case DesignPackage.DATA_SET_DESIGN__PRIMARY_RESULT_SET_NAME:
                return PRIMARY_RESULT_SET_NAME_EDEFAULT == null ? m_primaryResultSetName != null : !PRIMARY_RESULT_SET_NAME_EDEFAULT.equals(m_primaryResultSetName);
            case DesignPackage.DATA_SET_DESIGN__PARAMETERS:
