...
public class HCatalogPackageImpl extends EPackageImpl implements HCatalogPackage {
    ...
    public void initializePackageContents() {
        ...
        hCatalogConnectionEClass.getESuperTypes().add(theConnectionPackage.getConnection());
        hCatalogConnectionItemEClass.getESuperTypes().add(thePropertiesPackage.getConnectionItem());
