...
public enum EHCatalogRepositoryToComponent {
    ...
    HADOOP_CUSTOM_JARS("HADOOP_CUSTOM_JARS", "HADOOP_CUSTOM_JARS"),

    JOBTRACKER_PRINCIPAL("JOBTRACKER_PRINCIPAL", "JOBTRACKER_PRINCIPAL"), //$NON-NLS-1$ //$NON-NLS-2PIG_VERSION
    
    HADOOP_ADVANCED_PROPERTIES("HADOOP_ADVANCED_PROPERTIES","HADOOP_ADVANCED_PROPERTIES");
