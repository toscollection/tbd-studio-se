...
{
    my $month_format_abbreviated = [ "ജനു", "ഫെബ്രു", "മാര്‍", "ഏപ്രി", "മേയ്", "ജൂണ്‍", "ജൂലൈ", "ആഗ", "സെപ്റ്റം", "ഒക്ടോ", "നവം", "ഡിസം" ];
...
{
    my $month_stand_alone_narrow = [ "ജ", "ഫെ", "മ", "ഏ", "മേ", "ജൂ", "ജൂ", "ആ", "സെ", "ഒ", "ന", "ഡി" ];
...
{
    my $_format_for_yMMMEd = "yyyy\ MMM\ d\,\ EEE";
