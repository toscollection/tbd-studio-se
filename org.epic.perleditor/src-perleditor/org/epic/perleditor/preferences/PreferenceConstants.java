...
/**
 * Preference constants used in the JDT-UI preference store. Clients should only read the JDT-UI preference store using
...
public class PreferenceConstants {
    ...
    public static void initializeDefaultValues(IPreferenceStore store) {
        ...
        // test any function related to UI to check if we uses command line or not.
        try {
            Display.getCurrent().getSystemFont();
        } catch (Exception e) {
            // running in command line, so skip the preferences.
            return;
        }
