...
import org.epic.perleditor.editors.util.PerlValidatorBase.ParsedErrorLine;

public class TalendPerlValidator extends PerlValidatorBase{
	   private static TalendPerlValidator instance;    
	    
	    private TalendPerlValidator()
	    {
	     ...
	     */
	    public synchronized static TalendPerlValidator instance()
	    {
	        if (instance == null) instance = new TalendPerlValidator();
	        return instance;
	    }
	     ...
	     */
		public boolean validate(IResource resource)
