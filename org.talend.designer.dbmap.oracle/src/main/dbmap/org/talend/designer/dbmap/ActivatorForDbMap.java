 ...
 */
public class ActivatorForDbMap extends AbstractUIPlugin {

    // The plug-in ID
    public static final String PLUGIN_ID = "org.talend.designer.dbmap"; //$NON-NLS-1$

    // The shared instance
    private static ActivatorForDbMap plugin;

    /**
     * The constructor.
     */
    public ActivatorForDbMap() {
        plugin = this;
    }
     ...
     */
    public static ActivatorForDbMap getDefault() {
        return plugin;
    }
