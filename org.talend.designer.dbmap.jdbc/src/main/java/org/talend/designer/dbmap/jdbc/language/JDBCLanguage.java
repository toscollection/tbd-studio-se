...
public class JDBCLanguage extends AbstractDbLanguage {
    ...
    private JDBCOperatorsManager operatorsManager;
    ...
    public JDBCLanguage() {
        super();
        this.operatorsManager = new JDBCOperatorsManager();
    }
