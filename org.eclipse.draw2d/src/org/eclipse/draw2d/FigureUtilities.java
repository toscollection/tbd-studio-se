...
public class FigureUtilities {
    ...
    public static Color darker(Color color) {
        return new Color(null, (int) (color.getRed() * RGB_VALUE_MULTIPLIER), (int) (color.getGreen() * RGB_VALUE_MULTIPLIER),
    ...
    /**
     * Returns the dimensions of the String <i>s</i> using the font <i>f</i>. Tab expansion and carriage return
    ...
    /**
     * Returns the dimensions of the String <i>s</i> using the font <i>f</i>. No tab expansion or carriage return
    ...
    /**
     * Paints a border with an etching effect, having a shadow of Color <i>shadow</i> and highlight of Color
     * <i>highlight</i>.
     * 
     ...
     * @param distanceX Distance between vertical grid lines; if 0 or less, vertical grid lines will not be drawn
     * @param distanceY Distance between horizontal grid lines; if 0 or less, horizontal grid lines will not be drawn
     * 
     * @since 3.0
     */
    public static void paintGrid(Graphics g, IFigure f, org.eclipse.draw2d.geometry.Point origin, int distanceX, int distanceY) {
    ...
    /**
     * Paints a border with an etching effect, having a shadow of a darker version of g's background color, and a
     * highlight a lighter version of g's background color.
     * 
     * @param g the graphics object
     * @param r the bounds of the border
     * @since 2.0
    ...
    /**
     * Returns the figure which is the ancestor of both figures, or <code>null</code>. A figure is an ancestor if it is
     * the parent of another figure, or if it is the ancestor of that figure's parent. If one figure contains the other,
    ...
    /**
     * Returns <code>true</code> if the ancestor contains the descendant, or is the ancestor of the descendant's parent.
     * 
