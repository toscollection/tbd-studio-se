...
public class FigureCanvas extends Canvas {
    ...
    /**
     * The default styles are mixed in when certain constructors are used. This constant is a bitwise OR of the
     * following SWT style constants:
     * <UL>
    ...
    /**
     * Constructor which uses the given styles verbatim. Certain styles must be used with this class. Refer to the class
    ...
    /**
     * Constructs a new FigureCanvas with the given parent and LightweightSystem, using the {@link #DEFAULT_STYLES}.
     * 
     * @param parent the parent
    ...
    /**
     * Scrolls the contents to the new x and y location. If this scroll operation only consists of a vertical or
     * horizontal scroll, a call will be made to {@link #scrollToY(int)} or {@link #scrollToX(int)}, respectively, to
    ...
    /**
     * Sets the horizontal scrollbar visibility. Possible values are {@link #AUTOMATIC}, {@link #ALWAYS}, and
     * {@link #NEVER}.
     * 
    ...
    /**
     * Sets both the horizontal and vertical scrollbar visibility to the given value. Possible values are
    ...
    /**
     * Sets the vertical scrollbar visibility. Possible values are {@link #AUTOMATIC}, {@link #ALWAYS}, and
     * {@link #NEVER}.
     * 
     * @param v the new visibility
     */
