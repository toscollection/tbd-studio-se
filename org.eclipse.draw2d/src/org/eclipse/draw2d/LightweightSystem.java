...
/**
 * The LightweightSystem is the link between SWT and Draw2d. It is the component that provides the ability for
 * {@link Figure Figures} to be hosted on an SWT Canvas.
 * <p>
 ...
 * <li>Create a Draw2d Figure and call setContents(IFigure). This Figure will be the top-level Figure of the Draw2d
 * application.
 * </ol>
 */
public class LightweightSystem {
    ...
    /**
     * Adds SWT listeners to the LightWeightSystem's Canvas. This allows for SWT events to be dispatched and handled by
    ...
    /**
     * Invokes this LightweightSystem's {@link UpdateManager} to paint this LightweightSystem's Canvas and contents.
     * 
    ...
    /**
     * Sets the contents of the LightweightSystem to the passed figure. This figure should be the top-level Figure in a
     * Draw2d application.
     * 
    ...
    public void setIgnoreResize(boolean value) {
        if (value)
            ignoreResize++;
        else
            ignoreResize--;
    ...
    /**
     * The figure at the root of the LightweightSystem. If certain properties (i.e. font, background/foreground color)
     * are not set, the RootFigure will obtain these properties from LightweightSystem's Canvas.
     */
    ...
    /**
     * Listener used to get all necessary events from the Canvas and pass them on to the {@link EventDispatcher}.
     */
    protected class EventHandler implements MouseMoveListener, MouseListener, AccessibleControlListener, KeyListener,
        ...
        public void keyTraversed(TraverseEvent e) {
            /*
             * Doit is almost always false by default for Canvases with KeyListeners. Set to true to allow normal
             * behavior. For example, in Dialogs ESC should close.
             */
            e.doit = true;
