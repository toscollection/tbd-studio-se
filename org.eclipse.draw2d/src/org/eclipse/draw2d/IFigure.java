...
/**
 * A lightweight graphical object. Figures are rendered to a {@link Graphics} object. Figures can be composed to create
 * complex graphics.
 * 
 * <P>
...
public interface IFigure {
    ...
    /**
     * Adds the given IFigure as a child of this IFigure. The same as calling {@link #add(IFigure, Object, int)
     * add(figure, null, -1)}.
     * 
    ...
    /**
     * Adds the given IFigure as a child of this IFigure at the given index. The same as calling
     * {@link #add(IFigure, Object, int) add(figure, null, index)}.
     * 
     * @param figure The IFigure to add
    ...
    /**
     * Adds the given IFigure as a child of this IFigure with the given constraint. The same as calling
     * {@link #add(IFigure, Object, int) add(figure, constraint, -1)}.
     * 
     * @param figure The IFigure to add
    ...
    /**
     * Adds the child with the specified index and constraint. The child's parent is currently not null, it is removed
     * from that parent. If this figure has a LayoutManager, then {@link LayoutManager#setConstraint(IFigure, Object)}
    ...
    /**
     * Returns <code>true</code> if the point <code>(x, y)</code> is contained within this IFigure's bounds.
     * 
    ...
    /**
     * Returns the IFigure at the specified location. May return <code>this</code> or <code>null</code>.
     * 
     * @param x The X coordinate
     * @param y The Y coordinate
    ...
    /**
     * Returns the IFigure at the specified location based on the conditional TreeSearch. May return <code>this</code>
     * or <code>null</code>
     * 
     * @param x the X coordinate
     * @param y the Y coordinate
    ...
    /**
     * Returns the IFigure at the specified location, excluding any IFigures in <code>collection</code>. May return
    ...
    /**
     * Returns the smallest rectangle completely enclosing the IFigure. Implementation may return the Rectangle by
     * reference. For this reason, callers of this method must not modify the returned Rectangle. The Rectangle's values
     ...
     * {@link LayoutManager LayoutManagers}) and the painting of children will be clipped.
     * 
    ...
    /**
     * Returns a hint indicating the smallest desireable size for the IFigure. The returned dimension may be by
     * <i>reference</i>, and it must not be modified by the caller.
     * 
    ...
    /**
     * Returns the IFigure that is the current parent of this IFigure or <code>null</code> if there is no parent.
     * 
    ...
    /**
     * Returns the preferred size for this IFigure. The returned value must not be modified by the caller. If the figure
     * has no preference, it returns its current size. The same as calling {@link #getPreferredSize(int, int)
    ...
    /**
     * Returns the preferred size for this IFigure using the provided width and height hints. The returned dimension may
     * be by <i>reference</i>, and it must not be modified by the caller. A value of <code>-1</code> indicates that
     ...
     * <p>
     * <b>NOTE</b>: You should not override this method. If you are interested in receiving notification of this type of
     * event, you should register a {@link FocusListener} with this IFigure.
     * 
     ...
     * <p>
     * <b>NOTE</b>: You should not override this method. If you are interested in receiving notification of this type of
     * event, you should register a {@link KeyListener} with this IFigure.
     * 
     ...
     * <p>
     * <b>NOTE</b>: You should not override this method. If you are interested in receiving notification of this type of
     * event, you should register a {@link MouseListener} with this IFigure.
     * 
     ...
     * <p>
     * <b>NOTE</b>: You should not override this method. If you are interested in receiving notification of this type of
     * event, you should register a {@link MouseMotionListener} with this IFigure.
     * 
     * @param event The mouse event
     */
    ...
    /**
     * Returns <code>true</code> if this IFigure's bounds intersect with the given Rectangle. Figure is asked so that
     * non-rectangular IFigures can reduce the frequency of paints.
     * 
    ...
    /**
     * Invalidates this IFigure. If this figure has a LayoutManager, then {@link LayoutManager#invalidate()} should be
     * called on that layout.
     */
    void invalidate();
    ...
    /**
     * Returns <code>true</code> if this figure is capable of applying a local coordinate system which affects its
     * children.
     * 
     * @since 3.1
    ...
    /**
     * Returns <code>true</code> if this IFigure can gain focus on a {@link org.eclipse.swt.events.TraverseEvent}.
     * 
    ...
    /**
     * Returns <code>true</code> if this IFigure can receive focus on a call to {@link #requestFocus()}.
     * 
    ...
    /**
     * Returns <code>true</code> if this IFigure is showing. This figure is only showing if it is visible and its parent
     * is showing, or it has no parent.
     * 
    ...
    /**
     * returns <code>true</code> if this figure's visibility flag is set to true. Does not walk up the parent chain.
     * 
    ...
    /**
     * Removes the given child from this figure's children. If this figure has a LayoutManager, then
     * {@link LayoutManager#remove(IFigure)} shall be called on that layout with the child.
     * 
     ...
     * This will only unregister the listener for the given property. If the listener is registered to listen to other
     * properties, this will not affect the notification of the listener regarding those properties.
     * 
    ...
    /**
     * Repaints the rectangular area within this IFigure whose upper-left corner is located at the point
     * <code>(x,y)</code> and whose width and height are <code>w</code> and <code>h</code>, respectively.
     * 
    ...
    /**
     * Invalidates this figure and revalidates() its parent. If a figure does not have a parent, it will request a
     * validation from it UpdateManager. Calling this method does not guarantee that a repaint will occur.
     */
    void revalidate();
    ...
    /**
     * Sets the ability for this IFigure to gain focus on a {@link org.eclipse.swt.events.TraverseEvent}.
     * 
    ...
    /**
     * Sets this IFigure to be opaque if <i>isOpaque</i> is <code>true</code> and transparent if <i>isOpaque</i> is
     * <code>false</code>.
     * 
     ...
     * 
     * @param requestFocusEnabled <code>true</code> if this IFigure should gain focus on a call to requestFocus()
     */
    ...
    /**
     * Moves this IFigure <code>x</code> pixels horizontally and <code>y</code> pixels vertically.
     * 
    ...
    /**
     * Indicates that this figure should make itself valid. Validation includes invoking layout on a LayoutManager if
     * present, and then validating all children figures. Default validation uses pre-order, depth-first ordering.
     */
    void validate();
