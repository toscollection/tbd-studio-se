...
public class AboutDialog extends ProductInfoDialog {
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        // don't display these informations in this branding.
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        // hide this information in this branding.
    ...
    private void createTextMenu() {
        ...
        textManager.add(new CommandContributionItem(new CommandContributionItemParameter(PlatformUI.getWorkbench(), null,
    ...
    private Button createFeatureButton(Composite parent, final AboutBundleGroupData info) {
        ...
        button.setToolTipText(NLS.bind(WorkbenchMessages.AboutDialog_concatenationOfProviderNameAndFeatureName, new Object[] {
                info.getProviderName(), info.getName() }));
        ...
        button.getAccessible().addAccessibleListener(new AccessibleAdapter() {
             ...
             * 
             * @see
             * org.eclipse.swt.accessibility.AccessibleAdapter#getName(org.eclipse.swt.accessibility.AccessibleEvent)
             */
        ...
        button.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent event) {
                ...
                AboutFeaturesDialog d = new AboutFeaturesDialog(getShell(), productName, groupInfos);
